...
//         return await apiClient.authenticatedRequest<T>(endpoint, session.api.accessToken, requestOptions);
//       } catch (error) {
...
//   return {
//     makeRequest,
//     isAuthenticated: !!session?.api.accessToken && !(session as any)?.error,
