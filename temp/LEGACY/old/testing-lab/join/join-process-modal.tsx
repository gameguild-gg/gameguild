...
import { ArrowLeft, Briefcase, UserPlus, X } from 'lucide-react';

interface JoinProcessModalProps {
  onClose?: () => void;
}

export function JoinProcessModal({ onClose }: JoinProcessModalProps) {
  const [selectedRole, setSelectedRole] = useState<'tester' | 'developer' | null>(null);

  if (selectedRole) {
    return (
      <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 min-h-full p-6">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-bold text-white">Join as {selectedRole === 'tester' ? 'Tester' : 'Developer'}</h1>
            </div>
            {onClose && (
  ...
  return (
    <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 min-h-full p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Join Testing Session</h1>
          {onClose && (
            <Button variant="ghost" onClick={onClose} className="text-slate-400 hover:text-white">
              <X className="h-4 w-4" />
            </Button>
        ...
        <section className="space-y-8">
          <div className="text-center">
            ...
            <p className="text-lg text-slate-300 max-w-2xl mx-auto">Join our community of testers and developers to shape the future of gaming</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="bg-gradient-to-br from-blue-900/20 to-blue-800/20 border-blue-700/50 backdrop-blur-sm">
              <CardContent className="p-6 text-center space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Join as Tester</h3>
                  <p className="text-slate-300 mb-4">Test games, provide feedback, and earn rewards while having fun</p>
                  <ul className="text-left text-slate-400 space-y-1 mb-4 text-sm">
            ...
            <Card className="bg-gradient-to-br from-purple-900/20 to-purple-800/20 border-purple-700/50 backdrop-blur-sm">
              <CardContent className="p-6 text-center space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Submit Your Game</h3>
                  <p className="text-slate-300 mb-4">Get valuable feedback from real players to improve your game</p>
                  <ul className="text-left text-slate-400 space-y-1 mb-4 text-sm">
          ...
          {/* Additional Info */}
          <div className="bg-gradient-to-r from-slate-900/50 to-slate-800/50 border border-slate-700 rounded-lg p-6 backdrop-blur-sm">
