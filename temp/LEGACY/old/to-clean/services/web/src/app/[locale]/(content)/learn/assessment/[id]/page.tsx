...
import { CodeQuestionv1_0_0, QuestionBasev1_0_0 } from '@/lib/interface-base/question.base.v1.0.0';
  ...
  return (
    <div
      className={`min-h-screen p-8 ${
        mode === 'light' ? 'bg-gray-100 text-gray-900' : mode === 'dark' ? 'bg-gray-800 text-gray-100' : 'bg-black text-yellow-300'
      }`}
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-700 high-contrast:bg-black p-4 rounded-lg shadow-md mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300 high-contrast:text-yellow-300 mb-2">Questions: {totalQuestions}</p>
          ...
          {assessment.scoreTotal && (
            <div className="mt-4">
              <h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 high-contrast:text-yellow-300 mb-2">Score Deadlines:</h3>
                ...
                {assessment.scoreTotal.map((score, index) => {
                  ...
                  return (
                    <li key={index} className="text-gray-700 dark:text-gray-300 high-contrast:text-yellow-300 mb-2">
                      {new Date(score.maxDate).toLocaleDateString()}:<span className="font-semibold"> {discountedScore.toFixed(2)} </span>
            ...
            {selectedQuestion ? (
              ...
              <div
                className={`p-6 rounded-lg ${
                  mode === 'light' ? 'bg-gray-50 text-gray-600' : mode === 'dark' ? 'bg-gray-600 text-gray-200' : 'bg-gray-900 text-yellow-200'
                }`}
              >
