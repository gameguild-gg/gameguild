...
export function FloatingContentInsertPlugin() {
  ...
  if (!show && !showMenu && !showImageDialog && !showVideoDialog && !showAudioDialog && !showYouTubeDialog && !showSpotifyDialog) return null;
    ...
    <>
      ...
      >
        <Popover open={showMenu} onOpenChange={setShowMenu}>
          ...
          <PopoverContent side="left" className="w-80 p-0 max-h-[500px] overflow-y-auto shadow-lg border-0 bg-background/95 backdrop-blur-sm">
        ...
        <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-hidden">
          <DialogHeader className="space-y-3 pb-6 border-b">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-sm text-muted-foreground mt-1">Embed a YouTube video with customizable playback options</DialogDescription>
              </div>
            </div>
          </DialogHeader>
          ...
          <div className="py-6 space-y-6 max-h-[60vh] overflow-y-auto">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">Paste any YouTube video URL (youtube.com, youtu.be, or m.youtube.com)</p>
            </div>
              ...
              <div className="space-y-4 pl-8">
                <div className="flex items-start space-x-3 p-3 rounded-lg border bg-gray-50/50 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Display play/pause, volume, and timeline controls</p>
                  </div>
                </div>

                <div className="flex items-start space-x-3 p-3 rounded-lg border bg-gray-50/50 hover:bg-gray-50 transition-colors">
                  <Checkbox id="show-info" checked={youtubeShowInfo} onCheckedChange={(checked) => setYoutubeShowInfo(checked === true)} className="mt-0.5" />
                  <div className="flex-1">
          ...
          <DialogFooter className="pt-6 border-t bg-gray-50/50 -mx-6 -mb-6 px-6 py-4">
            <div className="flex items-center justify-between w-full">
              ...
              <Button onClick={handleYouTubeSubmit} disabled={!youtubeUrl.trim()} className="px-8 bg-red-600 hover:bg-red-700">
        ...
        <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-hidden">
          <DialogHeader className="space-y-3 pb-6 border-b">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <DialogDescription className="text-sm text-muted-foreground mt-1">Embed Spotify content with customizable display options</DialogDescription>
              </div>
            </div>
          </DialogHeader>
              ...
              <div className="space-y-4 pl-8">
                <div className="flex items-start space-x-3 p-3 rounded-lg border bg-gray-50/50 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Display the characteristic Spotify green theme in the embed</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <DialogFooter className="pt-6 border-t bg-gray-50/50 -mx-6 -mb-6 px-6 py-4">
            <div className="flex items-center justify-between w-full">
              ...
              <Button onClick={handleSpotifySubmit} disabled={!spotifyUrl.trim()} className="px-8 bg-green-600 hover:bg-green-700">
