...
import { BarChart3, Calendar, Download, MessageSquare, MoreHorizontal, Plus, TestTube, Upload, Users } from 'lucide-react';
import { useSession } from 'next-auth/react';
import Link from 'next/link';
import { useEffect, useState } from 'react';
// import { getTestingRequestsAction, getTestingSessionsAction, createTestingRequest, createTestingSession, joinTestingRequest, leaveTestingRequest } from '@/lib/admin/testing-lab';
    ...
    const loadStats = async () => {
      ...
      try {
        if (userRole.isStudent) {
          ...
          const { getTestingRequestsAction } = await import('@/lib/admin/testing-lab/requests/testing-requests.actions');
          const { getTestingSessionsAction } = await import('@/lib/admin/testing-lab/sessions/sessions.actions');
          const [requests, sessions] = await Promise.all([getTestingRequestsAction(), getTestingSessionsAction()]);
