...
ALTER TABLE "activity_grades"
  ADD FOREIGN KEY (content_interaction_id) REFERENCES content_interactions (id) ON DELETE CASCADE;
ALTER TABLE "activity_grades"
  ADD FOREIGN KEY (grader_program_user_id) REFERENCES program_users (id);
ALTER TABLE "activity_grades"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "IDX_5f550ee6239b8f4b0931ecc938" ON public.activity_grades USING btree (content_interaction_id);
...
ALTER TABLE "certificate_blockchain_anchors"
  ADD FOREIGN KEY (certificate_id) REFERENCES user_certificates (id);
ALTER TABLE "certificate_blockchain_anchors"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_0033f7bb83698a13a8914b9c66" ON public.certificate_blockchain_anchors USING btree (blockchain_network);
...
ALTER TABLE "certificate_tags"
  ADD FOREIGN KEY (tag_id) REFERENCES tag_proficiencies (id) ON DELETE CASCADE;
ALTER TABLE "certificate_tags"
  ADD FOREIGN KEY (certificate_id) REFERENCES certificates (id) ON DELETE CASCADE;
ALTER TABLE "certificate_tags"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_5d34b1014c933c6dc8da5764c08" ON public.certificate_tags USING btree (id);
...
ALTER TABLE "certificates"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_1eb0d8d2840d24d211ac1e29b7" ON public.certificates USING btree (program_id);
...
ALTER TABLE "competition_match_entity"
  ADD FOREIGN KEY (p1submission_id) REFERENCES competition_submission_entity (id);
ALTER TABLE "competition_match_entity"
  ADD FOREIGN KEY (run_id) REFERENCES competition_run_entity (id);
ALTER TABLE "competition_match_entity"
  ADD FOREIGN KEY (p2submission_id) REFERENCES competition_submission_entity (id);
ALTER TABLE "competition_match_entity"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_c82022b5f020870a48610ec2bce" ON public.competition_match_entity USING btree (id);
...
ALTER TABLE "competition_run_entity"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_c2c36337de9af6a41752324bc01" ON public.competition_run_entity USING btree (id);
...
ALTER TABLE "competition_run_submission_report_entity"
  ADD FOREIGN KEY (run_id) REFERENCES competition_run_entity (id);
ALTER TABLE "competition_run_submission_report_entity"
  ADD FOREIGN KEY (submission_id) REFERENCES competition_submission_entity (id);
ALTER TABLE "competition_run_submission_report_entity"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_efb4ef524197954e35f131fb9ee" ON public.competition_run_submission_report_entity USING btree (id);
...
ALTER TABLE "competition_submission_entity"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_6af6334fc1cff3b8b08d2b40cb0" ON public.competition_submission_entity USING btree (id);
...
ALTER TABLE "content_interactions"
  ADD FOREIGN KEY (content_id) REFERENCES program_contents (id) ON DELETE CASCADE;
ALTER TABLE "content_interactions"
  ADD FOREIGN KEY (program_user_id) REFERENCES program_users (id) ON DELETE CASCADE;
ALTER TABLE "content_interactions"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_39e13bc2b7fb5360fe2ecc30de" ON public.content_interactions USING btree (program_user_id, status);
...
ALTER TABLE "financial_transactions"
  ADD FOREIGN KEY (pricing_id) REFERENCES product_pricing (id);
ALTER TABLE "financial_transactions"
  ADD FOREIGN KEY (subscription_plan_id) REFERENCES product_subscription_plans (id);
ALTER TABLE "financial_transactions"
  ADD FOREIGN KEY (from_user_id) REFERENCES "user" (id);
ALTER TABLE "financial_transactions"
  ADD FOREIGN KEY (referrer_user_id) REFERENCES "user" (id);
ALTER TABLE "financial_transactions"
...
ALTER TABLE "financial_transactions"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_0714f08a777d81a139cf7bbf5e" ON public.financial_transactions USING btree (transaction_type);
...
ALTER TABLE "job_application"
  ADD FOREIGN KEY (job_id) REFERENCES job_post (id);
ALTER TABLE "job_application"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_896c8c02d7da2c0228d586e54b4" ON public.job_application USING btree (id);
...
ALTER TABLE "job_post_editors_user"
  ADD FOREIGN KEY (job_post_id) REFERENCES job_post (id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE "job_post_editors_user"
  ADD PRIMARY KEY (job_post_id, user_id);
...
ALTER TABLE "job_post_job_tags_job_tag"
  ADD FOREIGN KEY (job_tag_id) REFERENCES job_tag (id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE "job_post_job_tags_job_tag"
  ADD FOREIGN KEY (job_post_id) REFERENCES job_post (id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE "job_post_job_tags_job_tag"
  ADD PRIMARY KEY (job_post_id, job_tag_id);
...
ALTER TABLE "product_pricing"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_96a4a861354899893dcf7c8d313" ON public.product_pricing USING btree (id);
...
ALTER TABLE "product_programs"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_4f4bb57866a8128ded92fb01f90" ON public.product_programs USING btree (id);
...
ALTER TABLE "product_subscription_plans"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_bf93ad4daf677b4fec9a61633ad" ON public.product_subscription_plans USING btree (id);
...
ALTER TABLE "products"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_5b0f3fe151f941e51d4491cfa8" ON public.products USING btree (is_bundle);
...
ALTER TABLE "program_contents"
  ADD FOREIGN KEY (program_id) REFERENCES programs (id) ON DELETE CASCADE;
ALTER TABLE "program_contents"
  ADD FOREIGN KEY (parent_id) REFERENCES program_contents (id) ON DELETE CASCADE;
ALTER TABLE "program_contents"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_2a00830247b0e93cb6c9d6a168" ON public.program_contents USING btree (program_id);
...
ALTER TABLE "program_feedback_submissions"
  ADD FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE "program_feedback_submissions"
  ADD FOREIGN KEY (program_user_id) REFERENCES program_users (id);
ALTER TABLE "program_feedback_submissions"
  ADD FOREIGN KEY (user_id) REFERENCES "user" (id) ON DELETE CASCADE;
ALTER TABLE "program_feedback_submissions"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_a27f818de2c259092282649f215" ON public.program_feedback_submissions USING btree (id);
...
ALTER TABLE "program_ratings"
  ADD FOREIGN KEY (program_user_id) REFERENCES program_users (id);
ALTER TABLE "program_ratings"
  ADD FOREIGN KEY (moderated_by_id) REFERENCES "user" (id);
ALTER TABLE "program_ratings"
  ADD FOREIGN KEY (user_id) REFERENCES "user" (id);
ALTER TABLE "program_ratings"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_1d9dec735da6a8fa878376fa34" ON public.program_ratings USING btree (moderation_status, submitted_at);
...
ALTER TABLE "program_user_roles"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_7b4c06031cac4c8dc3598306c4d" ON public.program_user_roles USING btree (id);
...
ALTER TABLE "program_users"
  ADD FOREIGN KEY (program_id) REFERENCES programs (id) ON DELETE CASCADE;
ALTER TABLE "program_users"
  ADD FOREIGN KEY (user_product_id) REFERENCES user_products (id) ON DELETE CASCADE;
ALTER TABLE "program_users"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_1c5d533ae17f9d4db2d0185b80" ON public.program_users USING btree (user_product_id) WHERE (deleted_at IS NULL);
...
ALTER TABLE "programs"
  ADD UNIQUE (slug);
CREATE INDEX "IDX_3381fedfde637cded46e8b0a77" ON public.programs USING btree (cached_rating);
...
ALTER TABLE "promo_code_uses"
  ADD FOREIGN KEY (financial_transaction_id) REFERENCES financial_transactions (id);
ALTER TABLE "promo_code_uses"
  ADD FOREIGN KEY (user_id) REFERENCES "user" (id);
ALTER TABLE "promo_code_uses"
  ADD FOREIGN KEY (promo_code_id) REFERENCES promo_codes (id);
ALTER TABLE "promo_code_uses"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_3510b9afbd630080495fbcbd80" ON public.promo_code_uses USING btree (used_at);
...
ALTER TABLE "promo_codes"
  ADD FOREIGN KEY (affiliate_user_id) REFERENCES "user" (id);
ALTER TABLE "promo_codes"
  ADD FOREIGN KEY (product_id) REFERENCES products (id);
ALTER TABLE "promo_codes"
...
ALTER TABLE "promo_codes"
  ADD UNIQUE (code);
CREATE UNIQUE INDEX "PK_c7b4f01710fda5afa056a2b4a35" ON public.promo_codes USING btree (id);
...
ALTER TABLE "proposal_editors_user"
  ADD FOREIGN KEY (user_id) REFERENCES "user" (id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE "proposal_editors_user"
  ADD FOREIGN KEY (proposal_id) REFERENCES proposal (id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE "proposal_editors_user"
  ADD PRIMARY KEY (proposal_id, user_id);
...
ALTER TABLE "tag_proficiencies"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_13a27f06ef2e3f70d1bd88f1dd" ON public.tag_proficiencies USING btree (proficiency_level);
...
ALTER TABLE "tag_relationships"
  ADD FOREIGN KEY (source_id) REFERENCES tags (id) ON DELETE CASCADE;
ALTER TABLE "tag_relationships"
  ADD FOREIGN KEY (target_id) REFERENCES tags (id) ON DELETE CASCADE;
ALTER TABLE "tag_relationships"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_006f1c1f0cbca49effaf09799e9" ON public.tag_relationships USING btree (id);
...
ALTER TABLE "tags"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_bcffa2d68eb6e69d436f69b3f1" ON public.tags USING btree (type);
...
ALTER TABLE "user_certificates"
  ADD PRIMARY KEY (id);
ALTER TABLE "user_certificates"
  ADD UNIQUE (certificate_number);
CREATE INDEX "IDX_0fb66c2b2d4edbb223682730e8" ON public.user_certificates USING btree (user_id);
...
ALTER TABLE "user_financial_methods"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_bcc4dfbc00db2f49919b3399fd" ON public.user_financial_methods USING btree (user_id, status);
...
ALTER TABLE "user_kyc_verifications"
  ADD PRIMARY KEY (id);
ALTER TABLE "user_kyc_verifications"
  ADD UNIQUE (provider_applicant_id);
ALTER TABLE "user_kyc_verifications"
  ADD UNIQUE (provider_verification_id);
CREATE UNIQUE INDEX "PK_b2713fe3f62fa4a2731c72dac33" ON public.user_kyc_verifications USING btree (id);
...
ALTER TABLE "user_products"
  ADD FOREIGN KEY (user_id) REFERENCES "user" (id) ON DELETE CASCADE;
ALTER TABLE "user_products"
  ADD FOREIGN KEY (purchase_transaction_id) REFERENCES financial_transactions (id);
ALTER TABLE "user_products"
  ADD FOREIGN KEY (subscription_id) REFERENCES user_subscriptions (id);
ALTER TABLE "user_products"
  ADD PRIMARY KEY (id);
CREATE INDEX "IDX_2d4f33717491f83635416f67b3" ON public.user_products USING btree (access_expires_at);
...
ALTER TABLE "user_profile"
  ADD FOREIGN KEY (picture_id) REFERENCES images (id);
ALTER TABLE "user_profile"
  ADD PRIMARY KEY (id);
ALTER TABLE "user_profile"
  ADD UNIQUE (picture_id);
CREATE UNIQUE INDEX "PK_f44d0cd18cfd80b0fed7806c3b7" ON public.user_profile USING btree (id);
...
ALTER TABLE "user_subscriptions"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_9e928b0954e51705ab44988812c" ON public.user_subscriptions USING btree (id);
...
ALTER TABLE "vote"
  ADD PRIMARY KEY (id);
CREATE UNIQUE INDEX "PK_2d5932d46afe39c8176f9d4be72" ON public.vote USING btree (id);
