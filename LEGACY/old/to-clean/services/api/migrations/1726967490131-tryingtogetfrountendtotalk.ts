...
export class Tryingtogetfrountendtotalk1726967490131 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "ticket" ADD CONSTRAINT "PK_d4bc3a258983a70c9e508d45d00" PRIMARY KEY ("ticket_number", "id")`);
