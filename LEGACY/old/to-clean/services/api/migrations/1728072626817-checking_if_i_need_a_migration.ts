...
export class CheckingIfINeedAMigration1728072626817 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "job-tag" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(256) NOT NULL, "job_id" uuid, CONSTRAINT "PK_835586a09d10e323fdec92aaaa1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_12d56147187c085b6bea313618" ON "job-tag" ("name") `);
    await queryRunner.query(
      `CREATE TABLE "job-post_editors_user" ("job-post_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_b2de4693be0a04ac6bae0e82544" PRIMARY KEY ("job-post_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "job-post" ADD CONSTRAINT "FK_33aeb92a17d4888a8f62336bb8e" FOREIGN KEY ("owner_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "job-tag" ADD CONSTRAINT "FK_281854bc897857ec3fe3412bef8" FOREIGN KEY ("job_id") REFERENCES "job-post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "job-post_editors_user" ADD CONSTRAINT "FK_31aeb5812812256abf78ba261b5" FOREIGN KEY ("job-post_id") REFERENCES "job-post"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "job-post_editors_user" ADD CONSTRAINT "FK_612fe7371eb62167d48add018f4" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
