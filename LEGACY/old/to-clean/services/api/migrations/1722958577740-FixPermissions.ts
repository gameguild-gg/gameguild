...
export class FixPermissions1722958577740 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "post_editors_user" ("post_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_4399b494a9644933edf0e0d7fcb" PRIMARY KEY ("post_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "lecture_editors_user" ("lecture_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_6cd319be02ecdbfb6b78a3c646c" PRIMARY KEY ("lecture_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "chapter_editors_user" ("chapter_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_6b677152cc31755de3d795224f6" PRIMARY KEY ("chapter_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "course_editors_user" ("course_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_a863e83f726a4e6f0704fcd302d" PRIMARY KEY ("course_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "proposal_editors_user" ("proposal_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_3fead86d04749b09cebb8fd953d" PRIMARY KEY ("proposal_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "post_editors_user" ADD CONSTRAINT "FK_9fc34bb51d7a8a50a875dbeff29" FOREIGN KEY ("post_id") REFERENCES "post"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "post_editors_user" ADD CONSTRAINT "FK_4abfcfa0b8814c3522eb488636a" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "lecture_editors_user" ADD CONSTRAINT "FK_a11c650256fe110cdaa8be2579c" FOREIGN KEY ("lecture_id") REFERENCES "lecture"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "lecture_editors_user" ADD CONSTRAINT "FK_88ce9c7b7ef0b39989593ab1505" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "chapter_editors_user" ADD CONSTRAINT "FK_6bc76308984eee4bb9c49d9b2a7" FOREIGN KEY ("chapter_id") REFERENCES "chapter"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "chapter_editors_user" ADD CONSTRAINT "FK_22ec2de78ee0f0e2e7ee768a4c7" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "course_editors_user" ADD CONSTRAINT "FK_f0f27df7244631f69b3aa42a0dd" FOREIGN KEY ("course_id") REFERENCES "course"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "course_editors_user" ADD CONSTRAINT "FK_25fff6cb34e063caab1eb4c7c17" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "proposal_editors_user" ADD CONSTRAINT "FK_d5efb3b9d5fb4cd25e2f1eb8492" FOREIGN KEY ("proposal_id") REFERENCES "proposal"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "proposal_editors_user" ADD CONSTRAINT "FK_2469607eeb33fa61f32bda5326b" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
