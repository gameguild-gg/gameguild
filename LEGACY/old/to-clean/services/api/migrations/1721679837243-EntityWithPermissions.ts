...
export class EntityWithPermissions1721679837243 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "role" character varying NOT NULL DEFAULT 'CONTENT_OWNER', "resource_id" uuid NOT NULL, "user_id" uuid, CONSTRAINT "PK_8acd5cf26ebd158416f477de799" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "game_editors_user" ("game_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_214626b3d397af569e87a86a9d2" PRIMARY KEY ("game_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "game_editors_user" ADD CONSTRAINT "FK_6e34a3d0ce4c6be0f42c4ad3ef0" FOREIGN KEY ("game_id") REFERENCES "game"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "game_editors_user" ADD CONSTRAINT "FK_c502bad85d59f1c288baa97c4ff" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
