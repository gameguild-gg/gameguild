...
export class RenameGameToProject1726243379117 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "project_version" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "version" character varying(64) NOT NULL, "archive_url" character varying(1024) NOT NULL, "notes_url" character varying(1024) NOT NULL, "feedback_form" jsonb NOT NULL, "feedback_deadline" TIMESTAMP WITH TIME ZONE NOT NULL, "game_id" uuid, CONSTRAINT "UQ_4aa15ae20ae619ff1562db73861" UNIQUE ("version", "game_id"), CONSTRAINT "PK_249c24f66d8f7e8ea6f9ff462fb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_4b6747e098d96a0e805692810d" ON "project_version" ("feedback_deadline") `);
    await queryRunner.query(
      `CREATE TABLE "project_feedback_response" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "responses" jsonb NOT NULL, "version_id" uuid, "user_id" uuid, CONSTRAINT "PK_8ecbac3eb61113faffe1166e11e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "project_editors_user" ("project_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_efd60535d94affeccba7365e591" PRIMARY KEY ("project_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "project_version" ADD CONSTRAINT "FK_f5931748d5514ab10ade223d431" FOREIGN KEY ("game_id") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "project_feedback_response" ADD CONSTRAINT "FK_b321f272db3baa8decf94446c16" FOREIGN KEY ("version_id") REFERENCES "project_version"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "project_feedback_response" ADD CONSTRAINT "FK_d01ed37f3d5ac13bca59ba2956e" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "project_editors_user" ADD CONSTRAINT "FK_4efce1aaecf2b3d2523959a5019" FOREIGN KEY ("project_id") REFERENCES "project"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "project_editors_user" ADD CONSTRAINT "FK_8f5fba1aed12561d33ab675a24b" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
