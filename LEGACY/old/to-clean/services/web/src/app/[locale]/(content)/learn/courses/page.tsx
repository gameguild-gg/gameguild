  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
            ...
            <div key={course.id} className="bg-white p-6 rounded-lg shadow-md relative w-72" style={{ width: '384px', height: '384px' }}>
              ...
              <div className="mb-4 relative" style={{ height: '140px' }}>
                {course.thumbnail ? (
                  ...
                  <Image src="/placeholder.svg" alt="Placeholder Thumbnail" fill style={{ objectFit: 'cover' }} className="rounded-md bg-gray-200" />
                )}
              </div>
              <button
        ...
        <RoleSelectionModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onSelectRole={handleRoleSelection} />
      </div>
    </div>
  );
}
