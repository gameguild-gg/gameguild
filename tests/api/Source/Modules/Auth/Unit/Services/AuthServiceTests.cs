...
public class AuthServiceTests : IDisposable
{
    ...
    public async Task VerifyWeb3SignatureAsync_InvalidSignature_ThrowsUnauthorizedAccessException()
    {
        ...
        var request = new Web3VerifyRequestDto
        {
            WalletAddress = "0x742d35Cc6634C0532925a3b8D".ToLower(), Signature = "invalid-signature",
            Nonce = "mock-nonce", ChainId = "1"
        };
    ...
    public async Task Web3SignIn_WithInvalidTenant_FallsBackToDefaultTenant()
    {
        ...
        var enhancedResponse = new SignInResponseDto
        {
            ...
            AvailableTenants = new List<TenantInfoDto>
                { new TenantInfoDto { Id = defaultTenantId, Name = "Default Tenant", IsActive = true } },
        };

        _mockTenantAuthService
            .Setup(x => x.EnhanceWithTenantDataAsync(It.IsAny<SignInResponseDto>(), It.IsAny<UserModel>(),
                invalidTenantId))
            .ReturnsAsync(enhancedResponse);
    ...
    public async Task RefreshTokenAsync_WithTenantId_IncludesTenantClaims()
    {
        ...
        {
            new Claim("tenant_id", tenantId.ToString()), new Claim("tenant_permission_flags1", "1"),
        ...
        _mockJwtService
            .Setup(x => x.GenerateAccessToken(It.IsAny<UserDto>(), It.IsAny<string[]>(),
        ...
        var tenantPermissions = new List<TenantPermission>
        {
            new TenantPermission
            {
                ...
                ExpiresAt = null, // Not expired = IsValid will be true
            },
        };
