...
public class DatabaseInfrastructureTests
{
    ...
    public DatabaseInfrastructureTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    public void InMemory_Database_Should_Work_Correctly()
    {
        ...
        _output.WriteLine("✅ InMemory database works correctly");
    }
    ...
    public void SQLite_InMemory_Database_Should_Work_Correctly()
    {
        ...
        _output.WriteLine("✅ SQLite in-memory database works correctly");
    }
    ...
    public void SQLite_File_Database_Should_Work_Correctly()
    {
        ...
        try
        {
            ...
            _output.WriteLine("✅ SQLite file database works correctly");
        }
        finally
        {
            try
            ...
            catch (IOException)
            {
                ...
                _output.WriteLine("⚠️ Could not delete temp file (file in use)");
            }
        }
    }
    ...
    public void PostgreSQL_Configuration_Should_Be_Valid()
    {
        ...
        _output.WriteLine("✅ PostgreSQL configuration is valid (connection not tested)");
    }
    ...
    public async Task Database_Migrations_Should_Be_Queryable()
    {
        ...
        _output.WriteLine($"✅ Migrations queryable - Pending: {pendingMigrations.Count()}, Applied: {appliedMigrations.Count()}");
    }
    ...
    public void Database_Context_Should_Have_DbSets()
    {
        ...
        _output.WriteLine($"✅ Database context has {dbSetProperties.Count} DbSets:");
    ...
    public async Task Database_Should_Support_Basic_Operations()
    {
        ...
        catch (InvalidOperationException ex) when (ex.Message.Contains("Transactions are not supported"))
        {
            ...
            _output.WriteLine("Note: InMemory database transaction warning suppressed");
        }

        _output.WriteLine("✅ Database supports basic operations (connect, transactions)");
    }
    ...
    public void Multiple_Database_Contexts_Should_Be_Independent()
    {
        ...
        _output.WriteLine("✅ Multiple database contexts are independent");
    }
    ...
    public void Database_Provider_Should_Be_Configurable()
    {
        ...
        var providers = new[]
        {
            ("InMemory", (Action<DbContextOptionsBuilder>)(options => options.UseInMemoryDatabase("Test1"))),
            ("SQLite", (Action<DbContextOptionsBuilder>)(options => options.UseSqlite("Data Source=:memory:"))),
        };
        ...
        foreach (var (providerName, configureOptions) in providers)
        {
            ...
            Assert.NotNull(dbContext);
            _output.WriteLine($"✅ {providerName} provider configured successfully");
        }
    }
    ...
    public void Database_Connection_Pooling_Should_Work()
    {
        ...
        _output.WriteLine("✅ Database connection pooling works");
    }
