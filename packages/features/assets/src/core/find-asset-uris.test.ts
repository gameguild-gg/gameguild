...
import { createLocalAssetUri, createRemoteAssetUri } from "./asset-uri";
...
describe("findAssetUris", () => {
  it("finds unique structured references without scanning ordinary text", () => {
    const local = createLocalAssetUri("7776453f-1123-4f56-8abc-1234567890ab");
    const remote = createRemoteAssetUri("dashboard", "one/two");
