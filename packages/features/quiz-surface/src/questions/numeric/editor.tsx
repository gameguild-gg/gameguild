/**
 * Numeric Editor
 * Configure numeric quiz questions: define variables, a formula, and tolerance settings.
 * Student must compute the numeric result from the given formula and variable values.
 */
...
import type { NumericEntry } from "@game-guild/quiz"
import { validateFormula, evaluateFormula, generateVariableValue } from "@game-guild/quiz"
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <div className="text-xs text-gray-500 dark:text-gray-400 bg-blue-50 dark:bg-blue-950/30 p-2 rounded border border-blue-200 dark:border-blue-800">
          Use o editor visual de fórmula (LaTeX) para escrever a expressão. Suporta frações, raízes, potências,
          funções (sqrt, sin, cos, tan, log, ln, exp, ceil, floor, round, min, max, pow), parênteses e
          constantes (pi, e). Use os nomes das variáveis definidas acima.
        </div>
