              ...
              initialData: {
                appState: {
                  ...
                  theme: (initialAppState?.theme ??
                    excalidrawTheme) as AppState["theme"],
                  ...
                  currentItemStrokeWidth:
                    initialAppState?.currentItemStrokeWidth ?? 2,
                  currentItemStrokeStyle:
                    initialAppState?.currentItemStrokeStyle ?? "solid",
                  currentItemFillStyle:
                    initialAppState?.currentItemFillStyle ?? "solid",
                  currentItemRoughness:
                    initialAppState?.currentItemRoughness ?? 1,
                  currentItemRoundness:
                    initialAppState?.currentItemRoundness ?? "round",
                  currentItemFontSize:
                    initialAppState?.currentItemFontSize ?? 20,
                  currentItemStrokeColor:
                    initialAppState?.currentItemStrokeColor ?? "#1971c2",
