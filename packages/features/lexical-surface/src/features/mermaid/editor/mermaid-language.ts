...
export const mermaidTokensProvider: languages.IMonarchLanguage = {
  ...
  tokenizer: {
    root: [
      ...
      [
        /\b(has|belongs_to|contains|owns|manages|works_for)\b/,
      ...
      [/\[\*\]/, "keyword.state.start"],
      [
        /\bstate\s+[A-Za-z_][A-Za-z0-9_]*\s+as\s+[A-Za-z_][A-Za-z0-9_]*/,
        "keyword.state.definition",
      ],
      [
        /\b(fork|join|choice|start|end|composite|concurrent|history|deep|shallow)\b/,
        "keyword.state",
      ],
      ...
      // Git graph specific
      [
        /\b(commit|branch|checkout|merge|cherry-pick|reset|revert|tag)\b/,
        "keyword.git",
      ],
      [/\bid:\s*"[^"]*"/, "string.git.id"],
      ...
      [
        /\b(satisfies|derives|refines|traces|verifies|contains|copies)\b/,
        "keyword.requirement.relation",
      ],
      [/\b(risk|verifymethod|id|text|type)\b/, "keyword.requirement.property"],
      [
        /\b(high|medium|low|test|inspection|analysis|demonstration)\b/,
        "keyword.requirement.value",
      ],

      // Architecture diagram specific
      [/\b(group|service|junction)\b/, "keyword.architecture"],
      [
        /\b(cloud|server|database|browser|phone|disk|person|external|simulation)\b/,
        "keyword.architecture.type",
      ],
      ...
      [
        /\b(Rel|BiRel|Rel_Up|Rel_Down|Rel_Left|Rel_Right)\b/,
        "keyword.c4.relation",
      ],
      ...
      [
        /^\s*[A-Za-z\s]+:\s*\[\d*\.?\d+,\s*\d*\.?\d+\]/,
        "string.quadrant.point",
      ],
...
export const mermaidTheme = {
  ...
  rules: [
    ...
    {
      token: "keyword.timeline.section",
      foreground: "6f42c1",
      fontStyle: "bold",
    },
    ...
    {
      token: "keyword.quadrant.section",
      foreground: "6f42c1",
      fontStyle: "bold",
    },
