...
export class MermaidLexicalNode extends DecoratorNode<React.JSX.Element> {
  ...
  static importDOM(): DOMConversionMap | null {
    return {
      div: (domNode) => {
        if (!(domNode as HTMLElement).hasAttribute("data-lexical-mermaid"))
          return null;
  ...
  setCode(v: string): void {
    this.getWritable().__code = v;
  }
  getDiagramType(): MermaidDiagramType {
    return this.__diagramType;
  }
  setDiagramType(v: MermaidDiagramType): void {
    this.getWritable().__diagramType = v;
  }
  getTheme(): MermaidThemeName {
    return this.__theme;
  }
  setTheme(v: MermaidThemeName): void {
    this.getWritable().__theme = v;
  }
  getThemeMode(): MermaidThemeMode {
    return this.__themeMode;
  }
  setThemeMode(v: MermaidThemeMode): void {
...
export function $createMermaidLexicalNode(
  ...
  return $applyNodeReplacement(new MermaidLexicalNode(code, diagramType));
}
