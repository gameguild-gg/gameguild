 ...
 * page settings.
 */
export function pageSettingsToStyle(
  ...
  const widthIn =
    settings.orientation === "portrait" ? size.widthIn : size.heightIn;
  const heightIn =
    settings.orientation === "portrait" ? size.heightIn : size.widthIn;
