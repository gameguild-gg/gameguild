...
function $convertMediaElement(
  ...
  const type = (domNode.getAttribute("data-lexical-media-type") ||
    "image") as MediaType;
...
export class MediaLexicalNode extends DecoratorNode<React.JSX.Element> {
  ...
  static importDOM(): DOMConversionMap | null {
    return {
      div: (domNode) => {
        if (!(domNode as HTMLElement).hasAttribute("data-lexical-media"))
          return null;
  ...
  setMediaType(v: MediaType): void {
    this.getWritable().__mediaType = v;
  }
  getSrc(): string {
    return this.__src;
  }
  setSrc(v: string): void {
    this.getWritable().__src = v;
  }
  getAlt(): string {
    return this.__alt;
  }
  setAlt(v: string): void {
    this.getWritable().__alt = v;
  }
  getCaption(): string {
  ...
  setVideoType(v: string): void {
    this.getWritable().__videoType = v;
  }
  getEmbedType(): BaseMediaData["embedType"] {
    return this.__embedType;
  }
  setEmbedType(v: BaseMediaData["embedType"]): void {
    this.getWritable().__embedType = v;
  }
  getAudioType(): string {
    return this.__audioType;
  }
  setAudioType(v: string): void {
    this.getWritable().__audioType = v;
  }
  getEmbedAudioType(): BaseMediaData["embedAudioType"] {
    return this.__embedAudioType;
  }
  setEmbedAudioType(v: BaseMediaData["embedAudioType"]): void {
    this.getWritable().__embedAudioType = v;
  }
  getGalleryItems(): BaseMediaData[] {
    return this.__galleryItems;
  }
  setGalleryItems(v: BaseMediaData[]): void {
    this.getWritable().__galleryItems = v;
  }
  getGalleryColumns(): number {
    return this.__galleryColumns;
  }
  setGalleryColumns(v: number): void {
    this.getWritable().__galleryColumns = v;
  }
  getGalleryCaption(): string {
    return this.__galleryCaption;
  }
  setGalleryCaption(v: string): void {
    this.getWritable().__galleryCaption = v;
  }
  getGalleryAspect(): "square" | "landscape" | "classic" | "auto" {
    return this.__galleryAspect;
  }
  setGalleryAspect(v: "square" | "landscape" | "classic" | "auto"): void {
    this.getWritable().__galleryAspect = v;
  }
  getShowCellCaptions(): boolean {
    return this.__showCellCaptions;
  }
  setShowCellCaptions(v: boolean): void {
    this.getWritable().__showCellCaptions = v;
  }
  getShowGalleryCaption(): boolean {
    return this.__showGalleryCaption;
  }
  setShowGalleryCaption(v: boolean): void {
    this.getWritable().__showGalleryCaption = v;
  }
  getShowCaption(): boolean {
    return this.__showCaption;
  }
  setShowCaption(v: boolean): void {
    this.getWritable().__showCaption = v;
  }
...
export function $createMediaLexicalNode(
  ...
  return $applyNodeReplacement(new MediaLexicalNode(mediaType, src));
}
