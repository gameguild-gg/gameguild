...
function $convertButtonElement(
  ...
  const actionType = (domNode.getAttribute("data-lexical-button-action") ||
    "url") as ButtonActionType;
...
export class ButtonLexicalNode extends DecoratorNode<React.JSX.Element> {
  ...
  static importDOM(): DOMConversionMap | null {
    return {
      div: (domNode) => {
        if (!(domNode as HTMLElement).hasAttribute("data-lexical-button-text"))
          return null;
  ...
  setText(v: string): void {
    this.getWritable().__text = v;
  }
  getUrl(): string {
    return this.__url;
  }
  setUrl(v: string): void {
    this.getWritable().__url = v;
  }
  getActionType(): ButtonActionType {
    return this.__actionType;
  }
  setActionType(v: ButtonActionType): void {
    this.getWritable().__actionType = v;
  }
  getVariant(): ButtonVariant {
    return this.__variant;
  }
  setVariant(v: ButtonVariant): void {
    this.getWritable().__variant = v;
  }
  getBtnSize(): ButtonSize {
    return this.__btnSize;
  }
  setBtnSize(v: ButtonSize): void {
    this.getWritable().__btnSize = v;
  }
  getShowIcon(): boolean {
    return this.__showIcon;
  }
  setShowIcon(v: boolean): void {
    this.getWritable().__showIcon = v;
  }
  getIconVariant(): IconVariant {
    return this.__iconVariant;
  }
  setIconVariant(v: IconVariant): void {
    this.getWritable().__iconVariant = v;
  }
  getIconPosition(): IconPosition {
    return this.__iconPosition;
  }
  setIconPosition(v: IconPosition): void {
    this.getWritable().__iconPosition = v;
  }
  getIconSize(): IconSize {
    return this.__iconSize;
  }
  setIconSize(v: IconSize): void {
    this.getWritable().__iconSize = v;
  }
  ...
  getCustomColors(): ButtonCustomColors | null {
    return this.__customColors;
  }
  setCustomColors(v: ButtonCustomColors | null): void {
    this.getWritable().__customColors = v;
  }
  getFontFamily(): FontFamily {
    return this.__fontFamily;
  }
  setFontFamily(v: FontFamily): void {
    this.getWritable().__fontFamily = v;
  }
  getFontSize(): FontSize {
    return this.__fontSize;
  }
  setFontSize(v: FontSize): void {
    this.getWritable().__fontSize = v;
  }
