...
export type DividerColorPalette = "blue" | "green" | "orange" | "red" | "purple" | "custom"
...
function $convertDividerElement(_domNode: HTMLElement): null | DOMConversionOutput {
...
export class DividerLexicalNode extends DecoratorNode<React.JSX.Element> {
  ...
  static importJSON(s: SerializedDividerLexicalNode): DividerLexicalNode {
    return $applyNodeReplacement(new DividerLexicalNode(
      s.style, s.thickness, s.spacing, s.colorPalette, s.customColor,
    ))
  }
  ...
  static importDOM(): DOMConversionMap | null {
    return {
      hr: (domNode) => {
        if (!(domNode as HTMLElement).hasAttribute("data-lexical-divider")) return null
  ...
  // ── Getters / Setters ──
  getStyle(): DividerStyle { return this.__style }
  setStyle(v: DividerStyle): void { this.getWritable().__style = v }
  getThickness(): DividerThickness { return this.__thickness }
  setThickness(v: DividerThickness): void { this.getWritable().__thickness = v }
  getSpacing(): DividerSpacing { return this.__spacing }
  setSpacing(v: DividerSpacing): void { this.getWritable().__spacing = v }
  getColorPalette(): DividerColorPalette { return this.__colorPalette }
  setColorPalette(v: DividerColorPalette): void { this.getWritable().__colorPalette = v }
  getCustomColor(): string | null { return this.__customColor }
  setCustomColor(v: string | null): void { this.getWritable().__customColor = v }
