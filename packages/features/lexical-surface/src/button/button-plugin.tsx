...
export const INSERT_BUTTON_LEXICAL_COMMAND: LexicalCommand<ButtonPayload | undefined> = createCommand(
...
export function ButtonPlugin() {
  ...
  useEffect(() => {
    if (!editor.hasNodes([ButtonLexicalNode])) {
      throw new Error("ButtonPlugin: ButtonLexicalNode not registered on editor")
    }
