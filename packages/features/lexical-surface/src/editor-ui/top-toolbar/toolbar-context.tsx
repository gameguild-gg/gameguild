 ...
 *
 * Keeps formatting state and page settings shared by the editor toolbars.
 */
"use client";
...
import { DEFAULT_PAGE_SETTINGS, type PageSettings } from "../../features/page";
import {
  blockTypeToBlockName,
  DEFAULT_FONT_SIZE,
} from "../formatting/format-config";
...
export const useToolbarState = () => {
  ...
  if (context === undefined) {
    throw new Error(
      "useToolbarState must be used within a ToolbarContextProvider",
    );
  }
  return context;
};
