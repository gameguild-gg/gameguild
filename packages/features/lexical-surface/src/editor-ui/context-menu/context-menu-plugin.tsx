            ...
            try {
              if (navigator.clipboard?.write) {
                const items: Record<string, Blob> = {
                  "text/plain": new Blob([data["text/plain"] || ""], {
                    type: "text/plain",
                  }),
                };
                if (data["text/html"]) {
                  items["text/html"] = new Blob([data["text/html"]], {
                    type: "text/html",
                  });
                }
          ...
          const pasteFromCacheAsync = () => {
            setTimeout(() => {
              ...
              if (cache) {
                ...
                alert(
                  "Para colar do mundo externo neste navegador, utilize o atalho de teclado Ctrl+V.",
                );
              }
            }, 0);
          };
