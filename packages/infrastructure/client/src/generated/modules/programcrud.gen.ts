/**
 * @game-guild/client - Programcrud Module
 *
...
export class ProgramcrudModule {
...
export function createProgramcrudModule(client: ApiClient): ProgramcrudModule {
  return new ProgramcrudModule(client);
}
