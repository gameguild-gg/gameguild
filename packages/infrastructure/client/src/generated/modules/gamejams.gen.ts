...
export class GamejamsModule {
  ...
  async postApiGameJams(
    ...
    const validatedBody = safeParse(
      Types.GameJamsCreateJamInputSchema,
      body,
      "request",
    );
  ...
  /**
   */
  async getApiGameJamsSubmissions(
    id: string,
  ): Promise<Result<Array<Types.GameJamsJamSubmission>, ApiError>> {
  ...
  /**
   */
  async postApiGameJamsSubmissions(
    id: string,
    body: Types.GameJamsSubmitJamEntryInput,
  ): Promise<Result<Types.GameJamsJamSubmission, ApiError>> {
    const url = `/api/game-jams/${id}/submissions`;

    // Validate request body
    const validatedBody = safeParse(
      Types.GameJamsSubmitJamEntryInputSchema,
      body,
      "request",
    );
