/**
 * @game-guild/client - Activitygrade Module
 *
...
export class ActivitygradeModule {
...
export function createActivitygradeModule(client: ApiClient): ActivitygradeModule {
  return new ActivitygradeModule(client);
}
