/**
 * @game-guild/client - Subscriptionsplans Module
 *
...
export class SubscriptionsplansModule {
   ...
   */
  async postSubscriptionPlans(body: Types.CommerceSubscriptionsSubscriptionPlansControllerCreatePlanInput): Promise<Result<void, ApiError>> {
    const url = '/v1/subscription-plans';

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerCreatePlanInputSchema, body, 'request');
   ...
   */
  async postSubscriptionPlansCompare(body: Types.CommerceSubscriptionsSubscriptionPlansControllerComparePlansInput): Promise<Result<void, ApiError>> {
    const url = '/v1/subscription-plans:compare';

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerComparePlansInputSchema, body, 'request');
  ...
  async putSubscriptionPlans(
    ...
    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerPutSubscriptionPlanInputSchema, body, 'request');
  ...
  async getSubscriptionPlansUsage(planId: string): Promise<Result<void, ApiError>> {
    const url = `/v1/subscription-plans/${planId}/usage`;
  ...
  async getSubscriptionPlansSuggestUpgrades(
    ...
    const url = `/v1/subscription-plans/${planId}/suggest-upgrades`;
  ...
  async getSubscriptionPlansPricing(planId: string, query?: { tenantId?: string; discountCode?: string }): Promise<Result<void, ApiError>> {
    const url = `/v1/subscription-plans/${planId}/pricing`;
  ...
  async patchSubscriptionPlansPricing(
    ...
    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerUpdatePricingInputSchema, body, 'request');
  ...
  async postSubscriptionPlansValidateLimits(
    ...
    const url = `/v1/subscription-plans/${planId}:validate-limits`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerValidateLimitsInputSchema, body, 'request');
  ...
  async patchSubscriptionPlansDetails(
    ...
    const url = `/v1/subscription-plans/${planId}/details`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerUpdateDetailsInputSchema, body, 'request');
  ...
  async patchSubscriptionPlansLimits(
    ...
    const url = `/v1/subscription-plans/${planId}/limits`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerUpdateLimitsInputSchema, body, 'request');
  ...
  async patchSubscriptionPlansFeatures(
    ...
    const url = `/v1/subscription-plans/${planId}/features`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerUpdateFeaturesInputSchema, body, 'request');
  ...
  async postSubscriptionPlansActivate(planId: string): Promise<Result<void, ApiError>> {
    const url = `/v1/subscription-plans/${planId}:activate`;
  ...
  async postSubscriptionPlansDeactivate(planId: string): Promise<Result<void, ApiError>> {
    const url = `/v1/subscription-plans/${planId}:deactivate`;
  ...
  async postSubscriptionPlansArchive(planId: string): Promise<Result<void, ApiError>> {
    const url = `/v1/subscription-plans/${planId}:archive`;
  ...
  async postSubscriptionPlansClone(
    ...
    const url = `/v1/subscription-plans/${planId}:clone`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerCloneSubscriptionPlanInputSchema, body, 'request');
  ...
  async postSubscriptionPlansFeatured(
    ...
    const url = `/v1/subscription-plans/${planId}:featured`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerSetFeaturedInputSchema, body, 'request');
  ...
  async postSubscriptionPlansExternalId(
    ...
    const url = `/v1/subscription-plans/${planId}:external-id`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionPlansControllerSetExternalIdInputSchema, body, 'request');
...
export function createSubscriptionsplansModule(client: ApiClient): SubscriptionsplansModule {
  return new SubscriptionsplansModule(client);
}
