/**
 * @game-guild/client - Programcontent Module
 *
...
export function createProgramcontentModule(client: ApiClient): ProgramcontentModule {
  return new ProgramcontentModule(client);
}
