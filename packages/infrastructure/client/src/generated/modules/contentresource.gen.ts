/**
 * @game-guild/client - Contentresource Module
 *
...
export function createContentresourceModule(client: ApiClient): ContentresourceModule {
  return new ContentresourceModule(client);
}
