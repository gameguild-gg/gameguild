/**
 * @game-guild/client - Programlifecycle Module
 *
...
export function createProgramlifecycleModule(client: ApiClient): ProgramlifecycleModule {
  return new ProgramlifecycleModule(client);
}
