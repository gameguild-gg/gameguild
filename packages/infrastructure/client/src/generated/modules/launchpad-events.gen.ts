...
export class LaunchpadEventsModule {
  ...
  /**
   */
  async getLaunchPadEventsManagement(): Promise<Result<Array<Types.LaunchPadLaunchPadEventProjection>, ApiError>> {
  ...
  /**
   */
  async getLaunchPadEventsPublic(): Promise<Result<Array<Types.LaunchPadLaunchPadEventProjection>, ApiError>> {
  ...
  /**
   */
  async getLaunchPadEventsPublicById(id: string): Promise<Result<Types.LaunchPadLaunchPadEventDetailProjection, ApiError>> {
  ...
  /**
   */
  async getLaunchPadEventsByIdManagement(id: string): Promise<Result<Types.LaunchPadLaunchPadEventDetailProjection, ApiError>> {
