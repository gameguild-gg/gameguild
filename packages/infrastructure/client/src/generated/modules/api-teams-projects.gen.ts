...
export class ApiTeamsProjectsModule {
  ...
  /**
   */
  async getTeamsProjects(
    teamId: string,
  ): Promise<Result<Array<Types.APITeamsTeamProjectSummary>, ApiError>> {
...
export function createApiTeamsProjectsModule(
  client: ApiClient,
): ApiTeamsProjectsModule {
