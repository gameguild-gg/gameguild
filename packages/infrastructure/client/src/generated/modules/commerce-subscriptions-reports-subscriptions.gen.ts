...
export class CommerceSubscriptionsReportsSubscriptionsModule {
  ...
  async getReportsChurn(query?: {
    ...
    Result<Types.CommerceSubscriptionsSubscriptionChurnReport, ApiError>
  > {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.CommerceSubscriptionsSubscriptionChurnReportSchema,
        result.data,
        "response",
      );
...
export function createCommerceSubscriptionsReportsSubscriptionsModule(
  client: ApiClient,
): CommerceSubscriptionsReportsSubscriptionsModule {
