/**
 * @game-guild/client - Serviceaccounts Module
 *
...
export function createServiceaccountsModule(client: ApiClient): ServiceaccountsModule {
  return new ServiceaccountsModule(client);
}
