/**
 * @game-guild/client - Subscriptions Module
 *
...
export class SubscriptionsModule {
  ...
  async getSubscriptionsGetMetrics(): Promise<Result<void, ApiError>> {
    const url = '/v1/subscriptions:get-metrics';
  ...
  async getSubscriptionsInvoices(subscriptionId: string, query?: { page?: number; pageSize?: number }): Promise<Result<void, ApiError>> {
    const url = `/v1/subscriptions/${subscriptionId}/invoices`;
  ...
  async getSubscriptionsUsage(subscriptionId: string): Promise<Result<Types.CommerceSubscriptionsSubscriptionUsage, ApiError>> {
    const url = `/v1/subscriptions/${subscriptionId}/usage`;
  ...
  async getSubscriptionsBillingHistory(subscriptionId: string): Promise<Result<Array<Types.CommerceSubscriptionsBillingHistory>, ApiError>> {
    const url = `/v1/subscriptions/${subscriptionId}/billing-history`;
  ...
  async postSubscriptionsActivate(subscriptionId: string): Promise<Result<void, ApiError>> {
    const url = `/v1/subscriptions/${subscriptionId}:activate`;
  ...
  async postSubscriptionsStartTrial(
    ...
    const url = `/v1/subscriptions/${subscriptionId}:start-trial`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerStartTrialInputSchema, body, 'request');
  ...
  async postSubscriptionsEndTrial(
    ...
    const url = `/v1/subscriptions/${subscriptionId}:end-trial`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerEndTrialInputSchema, body, 'request');
   ...
   */
  async postSubscriptionsCancel(subscriptionId: string, body: Types.CommerceSubscriptionsSubscriptionsControllerCancelInput): Promise<Result<void, ApiError>> {
    const url = `/v1/subscriptions/${subscriptionId}:cancel`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerCancelInputSchema, body, 'request');
  ...
  async postSubscriptionsSuspend(
    ...
    const url = `/v1/subscriptions/${subscriptionId}:suspend`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerSuspendInputSchema, body, 'request');
  ...
  async postSubscriptionsPause(
    ...
    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerPauseSubscriptionInputSchema, body, 'request');
  ...
  async postSubscriptionsResume(subscriptionId: string): Promise<Result<void, ApiError>> {
    const url = `/v1/subscriptions/${subscriptionId}:resume`;
  ...
  async postSubscriptionsReactivate(subscriptionId: string): Promise<Result<void, ApiError>> {
    const url = `/v1/subscriptions/${subscriptionId}:reactivate`;
  ...
  async postSubscriptionsUpgrade(
    ...
    const url = `/v1/subscriptions/${subscriptionId}:upgrade`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerUpgradeInputSchema, body, 'request');
  ...
  async postSubscriptionsDowngrade(
    ...
    const url = `/v1/subscriptions/${subscriptionId}:downgrade`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerDowngradeInputSchema, body, 'request');
  ...
  async postSubscriptionsRenew(subscriptionId: string): Promise<Result<void, ApiError>> {
    const url = `/v1/subscriptions/${subscriptionId}:renew`;
  ...
  async postSubscriptionsAutoRenew(
    ...
    const url = `/v1/subscriptions/${subscriptionId}:auto-renew`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerAutoRenewInputSchema, body, 'request');
  ...
  async postSubscriptionsExternalIds(
    ...
    const url = `/v1/subscriptions/${subscriptionId}:external-ids`;

    // Validate request body
    const validatedBody = safeParse(Types.CommerceSubscriptionsSubscriptionsControllerExternalIdsInputSchema, body, 'request');
...
export function createSubscriptionsModule(client: ApiClient): SubscriptionsModule {
  return new SubscriptionsModule(client);
}
