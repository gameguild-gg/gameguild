...
export class TenantsModule {
   ...
   */
  async getTenants(query?: { page?: number; pageSize?: number; status?: string; searchTerm?: string }): Promise<Result<Types.CQRSPagedResult, ApiError>> {
    ...
    // Validate response
    if (result.ok) {
      const validatedData = safeParse(Types.CQRSPagedResultSchema, result.data, 'response');
   ...
   */
  async postTenantsCreate(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
   ...
   */
  async postTenantsUpdate(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
   ...
   */
  async postTenantsReplace(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
   ...
   */
  async postTenantsDelete(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
   ...
   */
  async postTenantsActivate(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
   ...
   */
  async postTenantsDeactivate(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
   ...
   */
  async postTenantsArchive(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
   ...
   */
  async postTenantsUndelete(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
   ...
   */
  async postTenantsPurge(body: Record<string, unknown>): Promise<Result<void, ApiError>> {
