/**
 * @game-guild/client - Authentication Module
 *
...
export function createAuthenticationModule(client: ApiClient): AuthenticationModule {
  return new AuthenticationModule(client);
}
