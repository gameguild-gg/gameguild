...
export class LearningCoursesProgramModule {
  ...
  async postCourses(
    ...
    const validatedBody = safeParse(
      Types.LearningCoursesCreateProgramSchema,
      body,
      "request",
    );
  ...
  /**
   */
  async getCoursesMe(): Promise<
    Result<Array<Types.LearningCoursesProgram>, ApiError>
  > {
  ...
  async putCourses(
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.LearningCoursesUpdateProgramSchema,
      body,
      "request",
    );
  ...
  async getCoursesAnalytics(
    id: string,
  ): Promise<Result<Types.LearningCoursesProgramAnalytics, ApiError>> {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.LearningCoursesProgramAnalyticsSchema,
        result.data,
        "response",
      );
      return { ok: true, data: validatedData };
  ...
  /**
   */
  async getCoursesAnalyticsCompletionRates(
    id: string,
  ): Promise<Result<Types.LearningCoursesCompletionRates, ApiError>> {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.LearningCoursesCompletionRatesSchema,
        result.data,
        "response",
      );
      return { ok: true, data: validatedData };
  ...
  /**
   */
  async getCoursesAnalyticsEngagement(
    id: string,
  ): Promise<Result<Types.LearningCoursesEngagementMetrics, ApiError>> {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.LearningCoursesEngagementMetricsSchema,
        result.data,
        "response",
      );
      return { ok: true, data: validatedData };
  ...
  /**
   */
  async getCoursesAnalyticsRevenue(
    id: string,
  ): Promise<Result<Types.LearningCoursesRevenueAnalytics, ApiError>> {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.LearningCoursesRevenueAnalyticsSchema,
        result.data,
        "response",
      );
      return { ok: true, data: validatedData };
  ...
  /**
   */
  async postCoursesContentReorder(
    id: string,
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.LearningCoursesReorderContentSchema,
      body,
      "request",
    );
  ...
  /**
   */
  async postCoursesMeContentComplete(
    id: string,
    contentId: string,
  ): Promise<Result<void, ApiError>> {
  ...
  async getCoursesMeProgress(
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.LearningCoursesUserProgressSchema,
        result.data,
        "response",
      );
      return { ok: true, data: validatedData };
  ...
  async putCoursesMeProgress(
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.LearningCoursesUpdateProgressSchema,
      body,
      "request",
    );
  ...
  /**
   */
  async getCoursesPricing(
    id: string,
  ): Promise<Result<Types.LearningCoursesPricing, ApiError>> {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.LearningCoursesPricingSchema,
        result.data,
        "response",
      );
      return { ok: true, data: validatedData };
  ...
  async putCoursesPricing(
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.LearningCoursesUpdatePricingSchema,
      body,
      "request",
    );
  ...
  /**
   */
  async getCoursesUsers(
    id: string,
    query?: { skip?: number; take?: number },
  ): Promise<Result<Array<Types.LearningCoursesUserProgress>, ApiError>> {
  ...
  /**
   */
  async postCoursesUsersContentComplete(
    id: string,
    userId: string,
    contentId: string,
  ): Promise<Result<void, ApiError>> {
  ...
  async postCoursesClone(
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.LearningCoursesCloneProgramSchema,
      body,
      "request",
    );
  ...
  /**
   */
  async postCoursesCreateProduct(
    id: string,
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.LearningCoursesCreateProductFromProgramSchema,
      body,
      "request",
    );
  ...
  /**
   */
  async postCoursesDisableMonetization(
    id: string,
  ): Promise<Result<Types.LearningCoursesProgram, ApiError>> {
  ...
  async postCoursesMonetize(
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.LearningCoursesMonetizationSchema,
      body,
      "request",
    );
  ...
  /**
   */
  async deleteCoursesUnlinkProduct(
    id: string,
    productId: string,
  ): Promise<Result<void, ApiError>> {
...
export function createLearningCoursesProgramModule(
  client: ApiClient,
): LearningCoursesProgramModule {
