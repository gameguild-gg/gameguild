/**
 * @game-guild/client - ContentPagesContentresource Module
 *
...
export class ContentPagesContentresourceModule {
  constructor(private readonly client: ApiClient) {}

  /**
   */
  async getContentResources(query?: {
...
export function createContentPagesContentresourceModule(client: ApiClient): ContentPagesContentresourceModule {
  return new ContentPagesContentresourceModule(client);
}
