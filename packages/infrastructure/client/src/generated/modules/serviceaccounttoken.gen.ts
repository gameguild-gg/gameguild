/**
 * @game-guild/client - Serviceaccounttoken Module
 *
...
export class ServiceaccounttokenModule {
...
export function createServiceaccounttokenModule(client: ApiClient): ServiceaccounttokenModule {
  return new ServiceaccounttokenModule(client);
}
