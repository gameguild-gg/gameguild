...
export class UsersNotificationsModule {
  ...
  > {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.PagedResultOfGameGuildIdentityUsersUserNotificationDtoSchema,
        result.data,
        "response",
      );
   ...
   */
  async postUsersNotificationsArchive(
    userId: string,
    notificationId: string,
  ): Promise<Result<void, ApiError>> {
   ...
   */
  async postUsersNotificationsMarkAsRead(
    userId: string,
    notificationId: string,
  ): Promise<Result<void, ApiError>> {
   ...
   */
  async postUsersNotificationsMarkAsUnread(
    userId: string,
    notificationId: string,
  ): Promise<Result<void, ApiError>> {
   ...
   */
  async postUsersNotificationsUnarchive(
    userId: string,
    notificationId: string,
  ): Promise<Result<void, ApiError>> {
   ...
   */
  async postUsersNotificationsArchive1(
    userId: string,
   ...
   */
  async postUsersNotificationsMarkAsRead1(
    userId: string,
    body: Types.IdentityUsersBulkNotificationInput,
  ): Promise<Result<void, ApiError>> {
   ...
   */
  async postUsersNotificationsMarkAsUnread1(
    userId: string,
    body: Types.IdentityUsersBulkNotificationInput,
  ): Promise<Result<void, ApiError>> {
   ...
   */
  async postUsersNotificationsUnarchive1(
    userId: string,
    body: Types.IdentityUsersBulkNotificationInput,
  ): Promise<Result<void, ApiError>> {
