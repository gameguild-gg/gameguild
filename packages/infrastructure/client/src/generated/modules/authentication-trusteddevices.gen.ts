/**
 * @game-guild/client - AuthenticationTrusteddevices Module
 *
...
export class AuthenticationTrusteddevicesModule {
...
export function createAuthenticationTrusteddevicesModule(client: ApiClient): AuthenticationTrusteddevicesModule {
  return new AuthenticationTrusteddevicesModule(client);
}
