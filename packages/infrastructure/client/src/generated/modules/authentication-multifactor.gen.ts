/**
 * @game-guild/client - AuthenticationMultifactor Module
 *
...
export class AuthenticationMultifactorModule {
...
export function createAuthenticationMultifactorModule(client: ApiClient): AuthenticationMultifactorModule {
  return new AuthenticationMultifactorModule(client);
}
