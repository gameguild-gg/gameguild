/**
 * @game-guild/client - Taxrules Module
 *
...
export function createTaxrulesModule(client: ApiClient): TaxrulesModule {
  return new TaxrulesModule(client);
}
