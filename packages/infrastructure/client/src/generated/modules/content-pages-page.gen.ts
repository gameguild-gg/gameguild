/**
 * @game-guild/client - ContentPagesPage Module
 *
...
export class ContentPagesPageModule {
...
export function createContentPagesPageModule(client: ApiClient): ContentPagesPageModule {
  return new ContentPagesPageModule(client);
}
