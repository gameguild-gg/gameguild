...
export class AssetsModule {
  ...
  /**
   */
  async getAssets(query?: { owner?: string; parentType?: string; parentId?: string; skip?: number; take?: number }): Promise<Result<void, ApiError>> {
    const url = '/v1/assets';
  ...
  /**
   */
  async getAssetsById(id: string, query?: { includeContent?: boolean }): Promise<Result<void, ApiError>> {
