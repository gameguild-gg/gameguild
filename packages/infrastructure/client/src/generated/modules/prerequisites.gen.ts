/**
 * @game-guild/client - Prerequisites Module
 *
...
export function createPrerequisitesModule(client: ApiClient): PrerequisitesModule {
  return new PrerequisitesModule(client);
}
