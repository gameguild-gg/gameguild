...
export class CommerceBillingWebhooksModule {
   ...
   */
  async getBillingWebhooksWebhookEvents(
    eventId: string,
   ...
   */
  async postBillingWebhooksWebhookEventsRetry(
    eventId: string,
  ): Promise<Result<Record<string, unknown>, ApiError>> {
...
export function createCommerceBillingWebhooksModule(
  client: ApiClient,
): CommerceBillingWebhooksModule {
