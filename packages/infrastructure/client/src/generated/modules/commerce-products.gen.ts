...
export class CommerceProductsModule {
  ...
  async getProducts(query?: {
    ...
    Result<Types.PagedResultOfGameGuildCommerceProductsProductDto, ApiError>
  > {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.PagedResultOfGameGuildCommerceProductsProductDtoSchema,
        result.data,
        "response",
      );
  ...
  async putProducts(
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.CommerceProductsUpdateProductInputSchema,
      body,
      "request",
    );
  ...
  async patchProducts(
    ...
    // Validate request body
    const validatedBody = safeParse(
      Types.CommerceProductsPatchProductInputSchema,
      body,
      "request",
    );
...
export function createCommerceProductsModule(
  client: ApiClient,
): CommerceProductsModule {
