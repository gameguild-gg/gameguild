...
export class LearningExperienceSocialLikesModule {
  ...
  /**
   */
  async postApiSocialCoursesLike(
    courseId: string,
  ): Promise<
    Result<Types.LearningExperienceSocialServicesCourseLike, ApiError>
  > {
    ...
    if (result.ok) {
      const validatedData = safeParse(
        Types.LearningExperienceSocialServicesCourseLikeSchema,
        result.data,
        "response",
      );
  ...
  /**
   */
  async deleteApiSocialCoursesLike(
    courseId: string,
  ...
  /**
   */
  async getApiSocialCoursesLikeCheck(
    courseId: string,
  ...
  /**
   */
  async getApiSocialCoursesLikeCount(
    courseId: string,
  ...
  /**
   */
  async getApiSocialLikesMe(query?: {
    skip?: number;
    take?: number;
  }): Promise<
    Result<Array<Types.LearningExperienceSocialServicesCourseLike>, ApiError>
  > {
...
export function createLearningExperienceSocialLikesModule(
  client: ApiClient,
): LearningExperienceSocialLikesModule {
