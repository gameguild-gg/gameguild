...
export type LearningAssessmentsAssessmentType =
  "Quiz" | "Exam" | "Assignment" | "Project" | "PeerReview" | "SelfAssessment";
...
export type LearningAssessmentsSubmissionModality =
  | "None"
  | "Text"
  | "File"
  | "Url"
...
export type LearningCoursesGradingMethod =
  "None" | "Instructor" | "Peer" | "Ai" | "AutomatedTests";

export type LearningCoursesLessonContentFormat =
  "Markdown" | "Lexical" | "RevealJs" | "Video";
...
export type TestingLabTestingLearningCompletionRequirement =
  "None" | "Attendance" | "FeedbackSubmitted" | "ProjectPresented";
...
CommerceSubscriptionsClientModulesOutputSchema = z.object({
  ...
  subscriptions: z
    .lazy(() => PagedResultOfGameGuildCommerceSubscriptionsSubscriptionSchema)
    .optional(),
});
...
LearningAssessmentsSubmissionModalitySchema = z.enum([
  "None",
  "Text",
  "File",
  "Url",
...
LearningCoursesGradingMethodSchema = z.enum([
  "None",
  "Instructor",
  "Peer",
  "Ai",
...
PagedResultOfGameGuildCommerceSubscriptionsSubscriptionNotificationDtoSchema =
  z.object({
    hasNextPage: z.boolean().optional(),
    hasPreviousPage: z.boolean().optional(),
    items: z
...
TestingLabTestingLearningCompletionRequirementSchema = z.enum([
  "None",
  "Attendance",
  "FeedbackSubmitted",
  "ProjectPresented",
