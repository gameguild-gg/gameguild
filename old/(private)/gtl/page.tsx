  ...
  return (
    <div className="w-full min-h-screen bg-black">
      <div className="max-w-[1440px] mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-8 text-center text-white">Game Testing Lab</h1>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:space-x-12 space-y-8 md:space-y-0 mt-16">
          ...
          >
            ...
            />
            <p className="mt-4 text-2xl font-semibold text-center text-white group-hover:text-green-600 transition-all duration-300">Build a Game</p>
          </a>
          <a
            href="/gtl/tester"
            className="group flex flex-col items-center justify-center w-full md:w-1/2 transition-all duration-300 ease-in-out transform hover:-translate-y-2 hover:scale-105"
          >
            ...
            />
            <p className="mt-4 text-2xl font-semibold text-center text-white group-hover:text-green-600 transition-all duration-300">Test a Game</p>
          </a>
        </div>
      </div>
    </div>
