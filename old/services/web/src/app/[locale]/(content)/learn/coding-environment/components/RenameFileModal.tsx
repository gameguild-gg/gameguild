      ...
      <DialogContent className={getDialogStyles()} aria-describedby="rename-file-description">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="rename" value={newFileName} onChange={(e) => setNewFileName(e.target.value)} className={`col-span-3 ${getInputStyles()}`} />
          </div>
        </div>
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
        ...
        <DialogFooter>
          <Button className={getButtonStyles('primary')} onClick={handleConfirmRename}>
            Confirm
          </Button>
        </DialogFooter>
      </DialogContent>
