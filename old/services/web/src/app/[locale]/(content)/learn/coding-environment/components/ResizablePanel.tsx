...
const ResizablePanel: React.FC<ResizablePanelProps> = ({ leftPanel, rightPanel, top, bottom, direction, initialSize = 50, minSize = 10, maxSize = 90 }) => {
  ...
  if (direction === 'horizontal') {
    return (
      <div ref={panelRef} className="flex h-full bg-[#1E1E1E] text-[#D4D4D4]">
        ...
        <div className="w-2 bg-[#3C3C3C] cursor-col-resize flex items-center justify-center" onMouseDown={handleMouseDown}>
    ...
    return (
      <div ref={panelRef} className="flex flex-col h-full bg-[#1E1E1E] text-[#D4D4D4]">
        ...
        <div className="h-2 bg-[#3C3C3C] cursor-row-resize flex items-center justify-center" onMouseDown={handleMouseDown}>
