...
export class AddGameTypeToSubmissionEntity1706634442251 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "competition_run_submission_report_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "wins_as_p1" integer NOT NULL, "wins_as_p2" integer NOT NULL, "p1_points" double precision NOT NULL, "p2_points" double precision NOT NULL, "total_points" double precision NOT NULL, "run_id" uuid, "submission_id" uuid, CONSTRAINT "PK_efb4ef524197954e35f131fb9ee" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "competition_run_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "state" character varying NOT NULL DEFAULT 'NOT_STARTED', CONSTRAINT "PK_c2c36337de9af6a41752324bc01" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "competition_run_submission_report_entity" ADD CONSTRAINT "FK_892a61c7a3d1d8915643c6cfcad" FOREIGN KEY ("run_id") REFERENCES "competition_run_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "competition_run_submission_report_entity" ADD CONSTRAINT "FK_9db155cb3344dfc07c41aa97356" FOREIGN KEY ("submission_id") REFERENCES "competition_submission_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "competition_match_entity" ADD CONSTRAINT "FK_368ba6d197680cb80f377cac145" FOREIGN KEY ("run_id") REFERENCES "competition_run_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "competition_match_entity" ADD CONSTRAINT "FK_2c8dcf31a9b059b257e995ca9a0" FOREIGN KEY ("p1submission_id") REFERENCES "competition_submission_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "competition_match_entity" ADD CONSTRAINT "FK_7e2cf74f3f70459c2de10374739" FOREIGN KEY ("p2submission_id") REFERENCES "competition_submission_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
