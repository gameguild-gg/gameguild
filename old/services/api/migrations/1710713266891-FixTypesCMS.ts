...
export class FixTypesCMS1710713266891 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user_posts_post" ("user_id" uuid NOT NULL, "post_id" uuid NOT NULL, CONSTRAINT "PK_c46184b54cfec2342e1c575b00b" PRIMARY KEY ("user_id", "post_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "lecture" ADD CONSTRAINT "FK_8617e94525034849ee1b9b2e2f1" FOREIGN KEY ("course_id") REFERENCES "course"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "lecture" ADD CONSTRAINT "FK_f3dd4ae5b548ce2d8dfc2f887ab" FOREIGN KEY ("chapter_id") REFERENCES "course"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "chapter" ADD CONSTRAINT "FK_be4eebd798cc26bd6bded42f8c0" FOREIGN KEY ("course_id") REFERENCES "course"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "course" ADD CONSTRAINT "FK_907888662706db7def5705ef5d3" FOREIGN KEY ("author_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_posts_post" ADD CONSTRAINT "FK_42791e638b2f587a61232e64081" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_posts_post" ADD CONSTRAINT "FK_557997292328c6f127dbee211b0" FOREIGN KEY ("post_id") REFERENCES "post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
