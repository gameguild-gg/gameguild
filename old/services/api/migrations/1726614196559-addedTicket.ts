...
export class AddedTicket1726614196559 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ticket_editors_user" ("ticket_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_cbe7f143227c03a658062234a49" PRIMARY KEY ("ticket_id", "user_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket" ADD CONSTRAINT "FK_17cc52872004472c7a8125fd789" FOREIGN KEY ("project_id") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket_editors_user" ADD CONSTRAINT "FK_68a614c8fd4410c06e03e0fa844" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
