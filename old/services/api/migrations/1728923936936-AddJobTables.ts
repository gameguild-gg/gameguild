...
export class AddJobTables1728923936936 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "job-application" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "progress" integer NOT NULL DEFAULT '0', "applicant_id" uuid NOT NULL, "job_id" uuid, CONSTRAINT "PK_896c8c02d7da2c0228d586e54b4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "job-post_job_tags_job-tag" ("job-post_id" uuid NOT NULL, "job-tag_id" uuid NOT NULL, CONSTRAINT "PK_7a49c7ad19ebb3e814e2918012f" PRIMARY KEY ("job-post_id", "job-tag_id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "job-application" ADD CONSTRAINT "FK_ca676357efe051c6135232d3ffc" FOREIGN KEY ("applicant_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "job-application" ADD CONSTRAINT "FK_d88c856eb48cbc63bde511c6cad" FOREIGN KEY ("job_id") REFERENCES "job-post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "job-post_job_tags_job-tag" ADD CONSTRAINT "FK_251949f6aae5f190956d20ed635" FOREIGN KEY ("job-post_id") REFERENCES "job-post"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "job-post_job_tags_job-tag" ADD CONSTRAINT "FK_044f1ccbefb86ed608a0a17c3bd" FOREIGN KEY ("job-tag_id") REFERENCES "job-tag"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
