...
export class AddThumbnailToImageEntity1733879445555 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "post" ADD CONSTRAINT "FK_f1326fde621b704a33759e54fe5" FOREIGN KEY ("thumbnail_id") REFERENCES "images"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "lecture" ADD CONSTRAINT "FK_08bec6f2e24762d264e0a1e29d8" FOREIGN KEY ("thumbnail_id") REFERENCES "images"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "chapter" ADD CONSTRAINT "FK_d25efc1a13c3a927f5846d0a149" FOREIGN KEY ("thumbnail_id") REFERENCES "images"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "course" ADD CONSTRAINT "FK_39231fcb10d7a7ff129ce7e51fc" FOREIGN KEY ("thumbnail_id") REFERENCES "images"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "proposal" ADD CONSTRAINT "FK_d94403fe0897f63261fe88b9afe" FOREIGN KEY ("thumbnail_id") REFERENCES "images"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "job-post" ADD CONSTRAINT "FK_af3a1de2186046eb06e9aeb5809" FOREIGN KEY ("thumbnail_id") REFERENCES "images"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "project" ADD CONSTRAINT "FK_a9fe4081c01805449159cbf96a1" FOREIGN KEY ("thumbnail_id") REFERENCES "images"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
