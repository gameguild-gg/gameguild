...
| **Resource-based authorization** | ✅ Yes | AccessControlListEntry, IOwnedResource, OwnerOrAclRuleEvaluator | **Ownership checking implemented** (owner bypass in auth). **No auto-grant on creation** - OwnerId must be set manually. | Low - explicit grants provide audit trail |
