...
/**
 * Playwright config targeting demos/emception-ide-react (Vite).
 *
...
export default defineConfig({
    ...
    webServer: {
        ...
        // or `node ../../scripts/sync-emception-cdn.mjs demos/emception-ide-react`).
        command: `npx vite --strictPort --port ${PORT}`,
        cwd: '../../demos/emception-ide-react',
