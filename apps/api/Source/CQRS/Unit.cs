...
public struct Unit : IEquatable<Unit>, IComparable<Unit>, IComparable {
  /// <summary> Default and only value of the Unit type. </summary>
  public static readonly Unit Value = new Unit();

  /// <summary> Task from a Unit type. </summary>
  public static readonly Task<Unit> Task = System.Threading.Tasks.Task.FromResult(Value);

  /// <summary> Compares the current Unit to the provided Unit. </summary>
  /// <param name="other"> The Unit to compare </param>
  /// <returns> 0 </returns>
  public int CompareTo(Unit other) { return 0; }

  /// <summary> Compares the current Unit to the provided object. </summary>
  ...
  /// <summary> Compares two Unit values. </summary>
