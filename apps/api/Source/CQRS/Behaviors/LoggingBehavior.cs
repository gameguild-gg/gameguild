...
/// <summary> Pipeline behavior for logging requests and responses </summary>
...
public class LoggingBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest : IBaseRequest {
  ...
  /// <summary> Initializes a new instance of the LoggingBehavior class </summary>
  /// <param name="logger"> Logger </param>
  public LoggingBehavior(ILogger<LoggingBehavior<TRequest, TResponse>> logger) { _logger = logger; }

  /// <summary> Handles the request pipeline </summary>
