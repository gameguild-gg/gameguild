...
/// <summary> Pipeline behavior for caching responses </summary>
/// <typeparam name="TRequest"> Request type </typeparam>
/// <typeparam name="TResponse"> Response type </typeparam>
public class CachingBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest : IBaseRequest, ICacheableRequest {
  private readonly ICacheService _cacheService;

  private readonly ILogger<CachingBehavior<TRequest, TResponse>> _logger;

  /// <summary> Initializes a new instance of the CachingBehavior class </summary>
  ...
  public async Task<TResponse> Handle(TRequest request, RequestHandlerDelegateBase<TResponse> next, CancellationToken cancellationToken) {
    ...
    if (cachedResponse is not null && !EqualityComparer<TResponse>.Default.Equals(cachedResponse, default(TResponse?))) {
