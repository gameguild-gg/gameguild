...
/// <summary> Pipeline behavior for validating requests </summary>
...
public class ValidationBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest : IBaseRequest {
  ...
  /// <summary> Initializes a new instance of the ValidationBehavior class </summary>
  /// <param name="validators"> Collection of validators </param>
  public ValidationBehavior(IEnumerable<IValidator<TRequest>> validators) { _validators = validators; }

  /// <summary> Handles the request pipeline with validation </summary>
