...
/// <summary>
/// Publisher that executes handlers in parallel using Task.WhenAll with optimized O(n) enumeration
/// </summary>
public class TaskWhenAllPublisher : INotificationPublisher
{
    ...
    public async Task Publish(IEnumerable<NotificationHandlerExecutorBase> handlerExecutors, INotification notification, CancellationToken cancellationToken)
    {
        ...
        {
            tasks[i] = executors[i].ExecuteHandler(notification, cancellationToken);
        }
