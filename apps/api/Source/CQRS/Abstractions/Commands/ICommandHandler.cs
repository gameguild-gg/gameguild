...
/// <summary> Defines a handler for a command without a response. Commands represent write operations that modify system state. </summary>
/// <typeparam name="TCommand"> The type of command being handled </typeparam>
...
/// <summary> Defines a handler for a command that returns a Result. Commands represent write operations that modify system state with enhanced error handling. </summary>
/// <typeparam name="TCommand"> The type of command being handled </typeparam>
public interface IResultCommandHandler<in TCommand> : IRequestHandler<TCommand, Result> where TCommand : IResultCommand { }
