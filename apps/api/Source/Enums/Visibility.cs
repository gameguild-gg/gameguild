...
public enum Visibility {
  ...
  [Description("Content is live and available to all users with access")] Published,

  [Description("Content no longer actively shown but preserved for reference")] Archived,
}
