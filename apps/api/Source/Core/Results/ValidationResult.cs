...
public class ValidationResult {
  ...
  public List<ValidationError> Errors { get; init; } = new List<ValidationError>();
  ...
  public static ValidationResult Failure(string errorMessage, string? propertyName = null) { return new ValidationResult { IsValid = false, Errors = new List<ValidationError> { new ValidationError(errorMessage, propertyName) } }; }
