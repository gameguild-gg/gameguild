...
/// <summary> Provides utilities for converting strings and type names to snake_case format. Backward compatibility wrapper around SnakeCaseTransformer. </summary>
public static class SnakeCase {
  private static readonly SnakeCaseTransformer Transformer = new SnakeCaseTransformer();
  ...
  /// <summary> Converts a type name to snake_case. </summary>
  ...
  /// <summary> Converts a string to snake_case without caching (useful for one-time conversions). </summary>
  /// <param name="name"> The string to convert. </param>
  /// <returns> The converted string in snake_case. </returns>
  ...
  /// <summary> Converts multiple strings to snake_case. </summary>
  ...
  /// <summary> Converts multiple type names to snake_case. </summary>
  ...
  /// <summary> Clears the internal cache by disposing and recreating it. Useful for memory management in long-running applications. </summary>
  public static void ClearCache() { CachedCaseTransformer.ClearCache(); }

  /// <summary> Disposes the memory cache. Call this method when the application is shutting down. </summary>
