...
/// <summary> Extension methods for convenient case transformations. </summary>
public static class CaseTransformExtensions {
  ...
  /// <summary> Converts a string to slug format. </summary>
  /// <param name="input"> The string to convert. </param>
  /// <param name="options"> Optional transformation options. </param>
  ...
  /// <summary> Converts a string using the specified case type. </summary>
  /// <param name="input"> The string to convert. </param>
  ...
  /// <summary> Validates if a string is in the specified case format. </summary>
  ...
  /// <summary> Checks if a string is in kebab-case format. </summary>
  /// <param name="input"> The string to validate. </param>
  ...
  /// <summary> Checks if a string is in snake_case format. </summary>
  /// <param name="input"> The string to validate. </param>
  ...
  /// <summary> Checks if a string is in slug format. </summary>
  /// <param name="input"> The string to validate. </param>
  ...
  /// <summary> Converts a type name to the specified case format. </summary>
  ...
  /// <summary> Converts a type name to kebab-case. </summary>
  /// <param name="type"> The type whose name to convert. </param>
  /// <param name="options"> Optional transformation options. </param>
  ...
  /// <summary> Converts a type name to slug format. </summary>
  /// <param name="type"> The type whose name to convert. </param>
  /// <param name="options"> Optional transformation options. </param>
