...
public record Money
{
    ...
    public static Money operator /(Money money, decimal divisor) { return divisor == 0 ? throw new DivideByZeroException("Cannot divide money by zero.") : new Money(money.Amount / divisor, money.Currency); }
