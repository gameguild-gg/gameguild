...
public interface IModulePermissionService {
    ...
    /// </summary>
    Task<UserRoleAssignment> AssignRoleAsync(
        Guid userId,
        Guid? tenantId,
        ModuleType module,
        string roleName,
    ...
    /// </summary>
    Task<List<ModulePermissionDefinition>> GetUserModulePermissionsAsync(
        Guid userId,
        Guid? tenantId,
        ModuleType module);
    ...
    /// </summary>
    Task<List<Guid>> GetUsersWithPermissionAsync(
        Guid? tenantId,
        ModuleType module,
        ModuleAction action);
    ...
    /// </summary>
    Task<ModuleRole> CreateRoleDefinitionAsync(
        string roleName,
        ModuleType module,
        string description,
    ...
    /// </summary>
    Task<ModuleRole> UpdateRoleDefinitionAsync(
        string roleName,
        ModuleType module,
        List<ModulePermissionDefinition> permissions);
