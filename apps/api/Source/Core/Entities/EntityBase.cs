...
/// Implements separation of concerns through IAuditable and IConcurrencyControlled interfaces.
/// </summary>
...
public abstract class EntityBase<TKey> : IEntity<TKey>, IHasDomainEvents where TKey : IEquatable<TKey> {
  ...
  /// <summary>
  /// Whether the entity is global (not tenant-specific)
  /// </summary>
...
/// Uses Guid as the default identifier type.
/// </summary>
