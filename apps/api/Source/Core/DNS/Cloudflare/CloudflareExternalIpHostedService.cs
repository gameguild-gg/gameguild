...
public class CloudflareExternalIpHostedService : BackgroundService {
  ...
  public CloudflareExternalIpHostedService(ILogger<CloudflareExternalIpHostedService> logger, ICloudflareExternalIpService cloudflareService) {
    _logger = logger;
  ...
  protected override async Task ExecuteAsync(CancellationToken stoppingToken) {
    ...
    catch (OperationCanceledException) { _logger.LogInformation("Cloudflare Dynamic DNS hosted service is stopping"); }
    catch (Exception ex) {
