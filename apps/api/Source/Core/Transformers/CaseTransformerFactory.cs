...
/// <summary> Factory for creating case transformer instances. </summary>
public static class CaseTransformerFactory {
  private static readonly Lazy<KebabCaseTransformer> LazyKebabTransformer = new Lazy<KebabCaseTransformer>(() => new KebabCaseTransformer());

  private static readonly Lazy<SnakeCaseTransformer> LazySnakeTransformer = new Lazy<SnakeCaseTransformer>(() => new SnakeCaseTransformer());

  private static readonly Lazy<SlugCaseTransformer> LazySlugTransformer = new Lazy<SlugCaseTransformer>(() => new SlugCaseTransformer());

  /// <summary> Gets a kebab-case transformer instance. </summary>
  public static KebabCaseTransformer Kebab { get => LazyKebabTransformer.Value; }

  /// <summary> Gets a snake_case transformer instance. </summary>
  public static SnakeCaseTransformer Snake { get => LazySnakeTransformer.Value; }

  /// <summary> Gets a slug-case transformer instance. </summary>
  public static SlugCaseTransformer Slug { get => LazySlugTransformer.Value; }

  /// <summary> Gets a transformer instance by type. </summary>
  ...
  /// <summary> Gets a transformer instance by case type enum. </summary>
  ...
  /// <summary> Transforms a string using the specified case type. </summary>
  ...
  /// <summary> Validates if a string is in the correct format for the specified case type. </summary>
