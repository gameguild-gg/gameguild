...
public static class ModuleExtensions
{
    ...
    public static IServiceCollection AddModule<TModule>(this IServiceCollection services, IConfiguration configuration) where TModule : class, IModule, new()
    {
    ...
    public static WebApplication UseModule<TModule>(this WebApplication app) where TModule : class, IModule, new()
    {
        var module = new TModule();
    ...
    {
        foreach (var module in modules) { module.ConfigureServices(services, configuration); }
