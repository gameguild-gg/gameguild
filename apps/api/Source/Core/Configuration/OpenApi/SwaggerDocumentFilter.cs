...
public class SwaggerDocumentFilter : IDocumentFilter
{
    public void Apply(OpenApiDocument swaggerDoc, DocumentFilterContext context)
    {
        ...
        swaggerDoc.Servers = new List<OpenApiServer>
        {
            new OpenApiServer
            {
                Url = "https://api.GameGuild.com", Description = "Production API Server"
            },
            new OpenApiServer
            {
                Url = "https://staging-api.GameGuild.com", Description = "Staging API Server"
            },
            new OpenApiServer
            {
                Url = "http://localhost:5000", Description = "Development API Server"
            }
        };
        ...
        swaggerDoc.Tags = new List<OpenApiTag>
        {
            ...
            new OpenApiTag
            {
                Name = "Features", Description = "Feature flag operations"
            },
            new OpenApiTag
            {
        ...
        var pathsToRemove = swaggerDoc.Paths
            .Where(path => !path.Value.Operations.Any())
