...
{
    /// <summary>
    /// The default API version to use when no version is specified.
    /// </summary>
    ...
    /// <summary>
    /// The API version reading strategy.
    /// </summary>
    ...
    /// <summary>
    ///    Media type parameter name for version (default: "ver").
    /// </summary>
    public string MediaTypeParameterName { get; set; } = "ver";

    /// <summary>
    ///    Format for API explorer group names (default: "'v'VVV").
    /// </summary>
    public string GroupNameFormat { get; set; } = "'v'VVV";

    /// <summary>
    ///    Whether to substitute API version in URL for API explorer.
    /// </summary>
    public bool SubstituteApiVersionInUrl { get; set; } = true;

    /// <summary>
    ///    Validates the API versioning options.
    /// </summary>
    ...
    public void Validate()
    {
        ...
        {
            throw new ArgumentNullException(nameof(DefaultApiVersion), "Default API version cannot be null.");
        }
        ...
        if (string.IsNullOrWhiteSpace(MediaTypeParameterName))
        {
            throw new ArgumentException("Media type parameter name cannot be null or empty.", nameof(MediaTypeParameterName));
        }
