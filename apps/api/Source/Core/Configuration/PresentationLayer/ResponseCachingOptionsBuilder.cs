...
/// <summary> Builder for response caching options. </summary>
public static class ResponseCachingOptionsBuilder {
  /// <summary> Creates response caching options with default values. </summary>
  ...
  /// <summary> Creates response caching options from a specific configuration section. </summary>
  ...
  /// <summary> Validates the provided response caching options. </summary>
  ...
  /// <summary> Creates and validates response caching options with default values. </summary>
  ...
  /// <summary> Creates and validates response caching options from configuration. </summary>
  /// <param name="configuration"> The configuration to bind from </param>
  /// <param name="sectionName"> The configuration section name </param>
