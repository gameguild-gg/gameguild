...
/// <summary> Builder for health checks options. </summary>
public static class HealthChecksOptionsBuilder {
  /// <summary> Creates health checks options with default values. </summary>
  ...
  /// <summary> Creates health checks options from a specific configuration section. </summary>
  ...
  /// <summary> Validates the provided health checks options. </summary>
  ...
  /// <summary> Creates and validates health checks options with default values. </summary>
  ...
  /// <summary> Creates and validates health checks options from configuration. </summary>
  /// <param name="configuration"> The configuration to bind from </param>
  /// <param name="sectionName"> The configuration section name </param>
