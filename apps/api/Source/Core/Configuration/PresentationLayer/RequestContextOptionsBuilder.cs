...
public static class RequestContextOptionsBuilder
{
    ...
    public static RequestContextOptions Create()
    {
        return new RequestContextOptions
        {
            EnableUserContext = true, EnableTenantContext = true, EnableLocationContext = true, EnableFeatureFlags = true
        };
    }
