...
/// <summary> Builder for request context options. </summary>
public static class RequestContextOptionsBuilder {
  /// <summary> Creates request context options with default values. </summary>
  /// <returns> Default request context options </returns>
  public static RequestContextOptions Create() { return new RequestContextOptions { EnableUserContext = true, EnableTenantContext = true, EnableLocationContext = true, EnableFeatureFlags = true }; }

  /// <summary> Creates request context options from a specific configuration section. </summary>
  ...
  /// <summary> Validates the provided request context options. </summary>
  ...
  /// <summary> Creates and validates request context options with default values. </summary>
  ...
  /// <summary> Creates and validates request context options from configuration. </summary>
  /// <param name="configuration"> The configuration to bind from </param>
  /// <param name="sectionName"> The configuration section name </param>
