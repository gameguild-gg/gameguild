...
/// <summary> Builder for API explorer options. </summary>
public static class ApiExplorerOptionsBuilder {
  /// <summary> Creates API explorer options with default values. </summary>
  /// <returns> Default API explorer options </returns>
  public static ApiExplorerOptions Create() { return new ApiExplorerOptions { GroupNameFormat = true, DefaultGroupName = "v1" }; }

  /// <summary> Creates API explorer options from a specific configuration section. </summary>
  ...
  /// <summary> Validates the provided API explorer options. </summary>
  ...
  /// <summary> Creates and validates API explorer options with default values. </summary>
  ...
  /// <summary> Creates and validates API explorer options from configuration. </summary>
  /// <param name="configuration"> The configuration to bind from </param>
  /// <param name="sectionName"> The configuration section name </param>
