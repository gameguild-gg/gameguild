...
public static class HealthCheckOptionsBuilder
{
    ...
    /// </summary>
    public static HealthCheckOptions CreateAllEnabled()
    {
        return new HealthCheckOptions
        {
            EnableDatabaseCheck = true, EnableApiHealthCheck = true, Timeout = TimeSpan.FromSeconds(30)
        };
    }
    ...
    /// </summary>
    public static HealthCheckOptions CreateDisabled()
    {
        return new HealthCheckOptions
        {
            EnableDatabaseCheck = false, EnableApiHealthCheck = false, Timeout = TimeSpan.FromSeconds(5)
        };
    }
    ...
    public class HealthCheckOptionsBuilderInstance
    {
        ...
        public HealthCheckOptionsBuilderInstance AddTags(Dictionary<string, string> tags)
        {
            ...
            {
                _options.Tags[tag.Key] = tag.Value;
            }
