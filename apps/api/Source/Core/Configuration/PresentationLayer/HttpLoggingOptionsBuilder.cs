...
public static class HttpLoggingOptionsBuilder
{
    ...
    public static HttpLoggingOptions Create()
    {
        return new HttpLoggingOptions
        {
            LogRequestHeaders = true, LogResponseHeaders = true, LogRequestBody = false, LogResponseBody = false
        };
    }
    ...
    /// <summary>
    /// Builds and validates HTTP logging options.
    /// </summary>
