...
public class RateLimitingOptions
{
    ...
    public Dictionary<string, EndpointRateLimitConfig> EndpointSpecificLimits { get; set; } = [];
    ...
    public void Validate()
    {
        ...
        if (UseDistributedRateLimiting && string.IsNullOrWhiteSpace(RedisConnectionString)) { throw new InvalidOperationException("Redis connection string is required when distributed rate limiting is enabled."); }
    }
}