...
/// <summary> Builder for authorization options. </summary>
public static class AuthorizationOptionsBuilder {
  /// <summary> Creates authorization options with default values. </summary>
  ...
  /// <summary> Creates authorization options from a specific configuration section. </summary>
  ...
  /// <summary> Validates the provided authorization options. </summary>
  ...
  /// <summary> Creates and validates authorization options with default values. </summary>
  ...
  /// <summary> Creates and validates authorization options from configuration. </summary>
  /// <param name="configuration"> The configuration to bind from </param>
  /// <param name="sectionName"> The configuration section name </param>
