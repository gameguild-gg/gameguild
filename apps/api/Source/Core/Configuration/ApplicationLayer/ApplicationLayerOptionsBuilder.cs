...
/// <summary> Builder for creating ApplicationLayerOptions from configuration. </summary>
public static class ApplicationLayerOptionsBuilder {
  /// <summary> Creates ApplicationLayerOptions with default values. </summary>
  /// <returns> ApplicationLayerOptions with default configuration </returns>
  public static ApplicationLayerOptions Create() {
    return new ApplicationLayerOptions { EnableMediatR = true, EnableAutoMapper = true, EnableFluentValidation = true, Caching = new CachingOptions(), BackgroundServices = new BackgroundServiceOptions() };
  }

  /// <summary> Creates ApplicationLayerOptions from a specific configuration section. </summary>
  ...
  /// <summary> Validates the provided application layer options. </summary>
  ...
  public static void Validate(ApplicationLayerOptions options) {
    ...
    if (options.Caching != null) { options.Caching.Validate(); }

    if (options.BackgroundServices != null) { options.BackgroundServices.Validate(); }
  }

  /// <summary> Creates and validates ApplicationLayerOptions with default values. </summary>
  ...
  /// <summary> Creates and validates ApplicationLayerOptions from configuration. </summary>
  /// <param name="configuration"> The configuration to bind from </param>
  /// <param name="sectionName"> The configuration section name </param>
