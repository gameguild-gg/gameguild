...
/// <summary> Utility class providing common functionality for option builders. This class contains shared logic to ensure consistency across all option builders. </summary>
internal static class OptionBuilderUtilities {
  /// <summary> Creates and binds an options object from configuration using a default factory. </summary>
  ...
  /// <summary> Creates and binds an options object from configuration with validation. </summary>
  /// <typeparam name="T"> The type of options to create </typeparam>
  /// <param name="configuration"> The configuration to bind from </param>
  /// <param name="sectionName"> The configuration section name </param>
  /// <param name="defaultFactory"> Factory function to create default instance </param>
