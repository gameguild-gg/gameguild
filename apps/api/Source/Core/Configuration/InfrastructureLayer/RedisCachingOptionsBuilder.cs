...
/// <summary>
/// Builder for creating and configuring Redis caching options
/// </summary>
public static class RedisCachingOptionsBuilder
{
    /// <summary>
    /// Creates default Redis caching options
    /// </summary>
    ...
    /// <summary>
    /// Creates Redis caching options from configuration
    /// </summary>
    ...
    /// <summary>
    /// Validates Redis caching options
    /// </summary>
    ...
    /// <summary>
    /// Builds and validates default Redis caching options
    /// </summary>
    ...
    /// <summary>
    /// Builds and validates Redis caching options from configuration
    /// </summary>
    /// <param name="configuration">Configuration instance</param>
    /// <param name="sectionName">Configuration section name</param>
    /// <returns>Built and validated Redis caching options</returns>
