...
public class RedisCachingOptions {
  ...
  /// <summary> Redis instance name for key prefixing </summary>
  public string InstanceName { get; set; } = "GameGuild";

  /// <summary> Default cache expiration time in minutes </summary>
  public int DefaultExpirationMinutes { get; set; } = 60;

  /// <summary> Feature flag cache expiration time in minutes </summary>
  public int FeatureFlagExpirationMinutes { get; set; } = 15;

  /// <summary> User session cache expiration time in minutes </summary>
  public int UserSessionExpirationMinutes { get; set; } = 120;

  /// <summary> Enable Redis health checks </summary>
  ...
  /// <summary> Validates the Redis caching options </summary>
