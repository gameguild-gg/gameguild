...
public static class InfrastructureConfiguration {
  ...
  public static DatabaseOptions CreateDatabaseOptions(IConfiguration configuration) {
    var options = new DatabaseOptions { ConnectionString = GetDatabaseConnectionString(configuration), EnableSensitiveDataLogging = IsEnvironment("Development"), EnableDetailedErrors = IsEnvironment("Development"), };
