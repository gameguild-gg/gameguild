...
public abstract class BaseSpecification<T> : ISpecification<T>
{
    ...
    /// <inheritdoc />
    public ReadOnlyCollection<Expression<Func<T, object>>> Includes => _includes.AsReadOnly();

    /// <inheritdoc />
    public ReadOnlyCollection<string> IncludeStrings => _includeStrings.AsReadOnly();
    ...
    /// <summary>
    ///     Enables including deleted entities
    /// </summary>
    protected virtual void IncludeDeletedEntities()
    {
        IncludeDeleted = true;
    }
    ...
    /// </summary>
    protected virtual void EnableAsNoTracking()
    {
        AsNoTracking = true;
    }

    /// <summary>
    ///     Disables identity resolution
    /// </summary>
    protected virtual void EnableAsNoTrackingWithIdentityResolution()
    {
