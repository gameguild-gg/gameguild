...
/// <summary>
///     Abstract base class for resources that can have permissions and be localized. Provides common functionality
///     for content resources like articles, courses, media, etc.
/// </summary>
public abstract class Resource : EntityBase, ILocalizable, ITenantable
{
    ...
    /// <summary>
    ///     Navigation property to the tenant this resource belongs to (implements ITenantable) EntityBase Framework will
    ///     automatically create the TenantId foreign key Null means the resource is global and accessible across all tenants
    /// </summary>
    public override Tenant? Tenant { get; set; }

    /// <summary>
    ///     Indicates whether this resource is accessible across all tenants (when Tenant is null) or only within a
    ///     specific tenant (implements ITenantable)
    /// </summary>
