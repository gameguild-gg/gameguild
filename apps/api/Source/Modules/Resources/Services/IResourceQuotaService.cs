...
public interface IResourceQuotaService
{
    ...
    /// </summary>
    Task<ResourceQuota> SetQuotaAsync(
        Guid tenantId,
    ...
    /// </summary>
    Task<ResourceQuota?> GetQuotaAsync(
        Guid tenantId,
        ResourceUsageType type,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IEnumerable<ResourceQuota>> GetTenantQuotasAsync(
        Guid tenantId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<IEnumerable<ResourceUsageRecord>> GetUsageHistoryAsync(
        Guid tenantId,
        ResourceUsageType type,
    ...
    /// </summary>
    Task<ResourceLimitCheckResponse> CheckLimitsAsync(
        Guid tenantId,
        ResourceUsageType type,
    ...
    /// </summary>
    Task<Dictionary<ResourceUsageType, ResourceLimitCheckResponse>> CheckMultipleLimitsAsync(
        Guid tenantId,
    ...
    /// </summary>
    Task<ResourceLimitCheckResponse> TryConsumeResourceAsync(
        Guid tenantId,
        ResourceUsageType type,
        long amount = 1,
        Guid? userId = null,
    ...
    /// </summary>
    Task<MultiResourceUsageResponse> GetTenantUsageOverviewAsync(
        Guid tenantId,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<ResourceUsageResponse> GetResourceUsageDetailsAsync(
        Guid tenantId,
        ResourceUsageType type,
        int historyDays = 30,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<int> CleanupOldUsageRecordsAsync(
        DateTime olderThan,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<bool> RecalculateUsageAsync(
        Guid tenantId,
        ResourceUsageType type,
        CancellationToken cancellationToken = default);
}
