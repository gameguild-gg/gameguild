...
public class RecordUsageWithBillingHandler : IRequestHandler<RecordUsageCommand, Result<ResourceUsageRecordDto>>
{
    ...
    public async Task<Result<ResourceUsageRecordDto>> Handle(RecordUsageCommand request, CancellationToken cancellationToken)
    {
        // Get current quota
        ...
        if (quota == null)
        {
            ...
            return Result<ResourceUsageRecordDto>.Failure("Quota not found");
        }
        ...
        if (wouldExceed && !request.AllowOverage)
        {
            ...
            return Result<ResourceUsageRecordDto>.Failure("Hard limit exceeded");
        }
        ...
        return Result<ResourceUsageRecordDto>.Success(dto);
    }
}
