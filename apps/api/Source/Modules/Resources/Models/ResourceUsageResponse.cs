...
/// <summary> Response containing multiple resource usage information </summary>
public class MultiResourceUsageResponse {
  /// <summary> Tenant ID </summary>
  public Guid TenantId { get; set; }

  /// <summary> Usage information for each resource type </summary>
  ...
  /// <summary> Overall quota status </summary>
  public bool HasExceededLimits { get; set; }

  /// <summary> Resources that have exceeded soft limits </summary>
  public List<ResourceUsageType> SoftLimitExceeded { get; set; } = new List<ResourceUsageType>();

  /// <summary> Resources that have exceeded hard limits </summary>
