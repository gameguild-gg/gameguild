...
/// <summary> Period types for resource quota resets </summary>
public enum ResourceQuotaPeriod {
  ...
  /// <summary> Quota resets quarterly </summary>
  Quarterly = 90,

  /// <summary> Quota resets yearly </summary>
  Yearly = 365,

  /// <summary> Quota never resets (lifetime limit) </summary>
  Never = 0,
}
