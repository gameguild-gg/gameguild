...
public class ProjectPermission : ResourcePermission<Project> {
  ...
  public bool CanEdit { get => HasPermission(PermissionType.Edit) && IsValid; }
  ...
  public bool CanManageCollaborators { get => HasPermission(PermissionType.Share) && IsValid; }

  /// <summary> Check if a user can create releases for this specific project </summary>
  public bool CanCreateReleases { get => HasPermission(PermissionType.Create) && IsValid; }
  ...
  /// <summary> Check if user can moderate this project (e.g., handle reports, moderate comments) </summary>
  public bool CanModerate { get => HasPermission(PermissionType.Review) && IsValid; }

  /// <summary> Check if user can archive/restore this specific project </summary>
  public bool CanArchive { get => HasPermission(PermissionType.Archive) && IsValid; }

  /// <summary> Check if user can transfer ownership of this specific project </summary>
  public bool CanTransferOwnership { get => HasPermission(PermissionType.License) && IsValid; }

  /// <summary> Check if a user can download releases from this specific project </summary>
  public bool CanDownload { get => HasPermission(PermissionType.Read) && IsValid; }

  /// <summary> Check if the user can fork this specific project </summary>
  public bool CanFork { get => HasPermission(PermissionType.Clone) && IsValid; }
}
