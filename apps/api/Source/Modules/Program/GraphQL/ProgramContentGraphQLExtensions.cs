...
public static class ProgramContentGraphQLExtensions {
  ...
  /// </summary>
  public static IRequestExecutorBuilder AddProgramContentGraphQL(this IRequestExecutorBuilder builder) { return builder.AddType<ProgramContentType>().AddTypeExtension<ProgramContentQueries>().AddTypeExtension<ProgramContentMutations>(); }
}
