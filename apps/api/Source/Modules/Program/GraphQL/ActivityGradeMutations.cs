...
public class ActivityGradeMutations
{
        ...
        [Service] IContentInteractionService contentInteractionService)
    {
        try
        {
            ...
            {
                return new ActivityGradeResult
                {
                    Success = false,
                    ErrorMessage = "Content interaction does not belong to the specified program.",
                    Grade = null
                };
            }
        ...
        [Service] IActivityGradeService activityGradeService)
    {
        try
        {
            ...
            if (existingGrade?.ContentInteraction?.Content?.ProgramId != programId)
            {
                return new ActivityGradeResult
                {
                    Success = false,
                    ErrorMessage = "Grade does not belong to the specified program.",
                    Grade = null
                };
            }
        ...
        [Service] IActivityGradeService activityGradeService)
    {
        try
        {
            ...
            if (!deleted)
            {
                ...
                {
                    Success = false,
                    ErrorMessage = "Grade not found or could not be deleted.",
                    Grade = null
                };
            }
