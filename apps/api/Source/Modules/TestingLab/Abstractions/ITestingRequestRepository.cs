...
/// <summary>
/// Repository abstraction for Testing Request operations
/// </summary>
public interface ITestingRequestRepository : IRepository<TestingRequest>
{
    /// <summary>
