...
/// <summary> Repository abstraction for Testing Session operations </summary>
public interface ITestingSessionRepository {
  ...
  /// <summary> Get testing sessions by testing request </summary>
