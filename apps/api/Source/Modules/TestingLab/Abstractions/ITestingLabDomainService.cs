...
/// <summary>
/// Domain service for coordinating complex Testing Lab operations
/// </summary>
public interface ITestingLabDomainService
{
    /// <summary>
    /// Orchestrates the complete process of creating a testing session with participants
    /// </summary>
    ...
    /// <summary>
    /// Processes bulk feedback submission for a testing request
    /// </summary>
    ...
    /// <summary>
    /// Automatically closes expired testing requests and creates summary reports
    /// </summary>
    Task<IEnumerable<TestingRequest>> ProcessExpiredTestingRequestsAsync(
        CancellationToken cancellationToken = default);

    /// <summary>
    /// Validates if a user can participate in a specific testing request
    /// </summary>
    ...
    /// <summary>
    /// Generates comprehensive testing statistics and analytics
    /// </summary>
