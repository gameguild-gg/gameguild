...
public interface ITestService
{
  ...
  /// <summary> Get a testing request by ID </summary>
  ...
  /// <summary> Soft delete a testing request </summary>
  Task<bool> DeleteTestingRequestAsync(Guid id);

  /// <summary> Restore a soft-deleted testing request </summary>
  ...
  /// <summary> Get all testing sessions (non-deleted only) </summary>
  Task<IEnumerable<TestingSession>> GetAllTestingSessionsAsync();

  /// <summary> Get testing sessions with pagination </summary>
  Task<IEnumerable<TestingSession>> GetTestingSessionsAsync(int skip = 0, int take = 50);

  /// <summary> Get a testing session by ID </summary>
  Task<TestingSession?> GetTestingSessionByIdAsync(Guid id);

  /// <summary> Get a testing session by ID with all related details </summary>
  ...
  /// <summary> Soft delete a testing session </summary>
  Task<bool> DeleteTestingSessionAsync(Guid id);

  /// <summary> Restore a soft-deleted testing session </summary>
  ...
  /// <summary> Get testing requests by creator </summary>
  ...
  /// <summary> Get registrations for a testing session </summary>
  ...
  /// <summary> Get waitlist for a testing session </summary>
  ...
  /// <summary> Get feedback by user </summary>
  ...
  /// <summary> Get testing request statistics </summary>
  Task<object> GetTestingRequestStatisticsAsync(Guid testingRequestId);

  /// <summary> Get testing session statistics </summary>
  Task<object> GetTestingSessionStatisticsAsync(Guid testingSessionId);

  /// <summary> Get user testing activity </summary>
  ...
  /// <summary> Create a simple testing request without requiring existing ProjectVersion </summary>
  Task<TestingRequest> CreateSimpleTestingRequestAsync(CreateSimpleTestingRequestDto requestDto, Guid userId);

  /// <summary> Submit simple feedback for a testing request </summary>
  Task SubmitFeedbackAsync(SubmitFeedbackDto feedbackDto, Guid userId);

  /// <summary> Get active testing requests available for testing </summary>
  ...
  /// <summary> Get student attendance report for professors </summary>
  Task<object> GetStudentAttendanceReportAsync();

  /// <summary> Get session attendance report for professors </summary>
  Task<object> GetSessionAttendanceReportAsync();

  /// <summary> Update session attendance for a user </summary>
  ...
  /// <summary> Get testing locations with pagination </summary>
  Task<IEnumerable<TestingLocation>> GetTestingLocationsAsync(int skip = 0, int take = 50);

  /// <summary> Get a testing location by ID </summary>
  ...
  /// <summary> Soft delete a testing location </summary>
  Task<bool> DeleteTestingLocationAsync(Guid id);

  /// <summary> Restore a soft-deleted testing location </summary>
  ...
  /// <summary> Report feedback as inappropriate </summary>
  Task ReportFeedbackAsync(Guid feedbackId, string reason, Guid reportedByUserId);

  /// <summary> Rate feedback quality for tracking purposes </summary>
