...
/// Can be global (TenantId = null) or tenant-specific (TenantId = specific value)
/// </summary>
public class TestingLabSettings : Entity, ITenantable {
  ...
  /// <summary>
  /// Navigation property to the tenant this settings belongs to (implements ITenantable)
  /// If null, these are global settings that apply to all tenants
  /// If set, these are tenant-specific settings that override global ones
  /// </summary>
  public override Tenant? Tenant { get; set; }

  /// <summary>
  /// Indicates whether this settings is global (TenantId is null) or tenant-specific
  /// </summary>
