...
public class SessionProject : Entity {
  ...
  /// <summary> Navigation property to the user who registered this project </summary>
  public virtual User RegisteredBy { get; set; } = null!;

  /// <summary> Whether this project is still active in this session </summary>
