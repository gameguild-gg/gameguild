...
/// <summary>
/// Represents comprehensive analytics data for testing lab operations
/// </summary>
public class TestingAnalytics
{
    ...
    public Dictionary<FeedbackQualityRating, int> FeedbackQualityDistribution { get; set; } = new();
    ...
    public Dictionary<Guid, int> LocationUsageStatistics { get; set; } = new();

    // Trend Data
    public List<DailyTestingMetrics> DailyMetrics { get; set; } = new();
}
