...
public class TestingLocationRepository : ITestingLocationRepository {
  ...
  public async Task<IEnumerable<TestingLocation>> GetAllAsync(CancellationToken cancellationToken = default) { return await _context.TestingLocations.Where(tl => tl.DeletedAt == null).OrderBy(tl => tl.Name).ToListAsync(cancellationToken); }
  ...
  public async Task<IEnumerable<TestingLocation>> GetByStatusAsync(LocationStatus status, CancellationToken cancellationToken = default) {
    return await _context.TestingLocations.Where(tl => tl.Status == status && tl.DeletedAt == null).OrderBy(tl => tl.Name).ToListAsync(cancellationToken);
  }
  ...
  public async Task<TestingLocation> UpdateAsync(TestingLocation location, CancellationToken cancellationToken = default) {
    var existingLocation = await _context.TestingLocations.FirstOrDefaultAsync(tl => tl.Id == location.Id && tl.DeletedAt == null, cancellationToken);
  ...
  public async Task<bool> DeleteAsync(Guid id, CancellationToken cancellationToken = default) {
    var location = await _context.TestingLocations.FirstOrDefaultAsync(tl => tl.Id == id && tl.DeletedAt == null, cancellationToken);
  ...
  public async Task<bool> ExistsAsync(Guid id, CancellationToken cancellationToken = default) { return await _context.TestingLocations.AnyAsync(tl => tl.Id == id && tl.DeletedAt == null, cancellationToken); }
}
