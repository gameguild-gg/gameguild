...
/// <summary> DTO for submitting simple feedback for a testing request </summary>
public class SubmitFeedbackDto {
  ...
  /// <summary> Additional notes from the tester </summary>
  public string? AdditionalNotes { get; set; }

  /// <summary> Optional session ID if this feedback was given during a testing session </summary>
