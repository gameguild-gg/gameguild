...
public class TestingLabQueries {
  ...
  public async Task<IEnumerable<TestingRequest>> GetTestingRequests([Service] ITestService testService, int skip = 0, int take = 50) { return await testService.GetTestingRequestsAsync(skip, take); }
  ...
  public async Task<IEnumerable<TestingSession>> GetTestingSessions([Service] ITestService testService, int skip = 0, int take = 50) { return await testService.GetTestingSessionsAsync(skip, take); }
  ...
  public async Task<IEnumerable<TestingLocation>> GetTestingLocations([Service] ITestService testService, int skip = 0, int take = 50) { return await testService.GetTestingLocationsAsync(skip, take); }
