...
public class PostQueries
{
        ...
        Guid? tenantId = null)
    {
        ...
        {
            query = query.Where(p => p.IsPinned == isPinned.Value);
        }
    ...
    [UseFiltering]
    [UseSorting]
    public IQueryable<Post> GetSystemPosts([Service] ApplicationDbContext context)
    {
        return context.Posts.Where(p => p.IsSystemGenerated);
    }
    ...
    [UseFiltering]
    [UseSorting]
    public IQueryable<Post> GetPinnedPosts([Service] ApplicationDbContext context)
    {
        return context.Posts.Where(p => p.IsPinned && p.Visibility == AccessLevel.Public);
    }
    ...
    [UseFiltering]
    [UseSorting]
    public IQueryable<PostTag> GetPostTags([Service] ApplicationDbContext context)
    {
        return context.PostTags.OrderBy(t => t.Name);
    }
