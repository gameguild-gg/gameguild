...
/// <summary> Represents a social media post within the community that follows the Content architecture </summary>
[Table("posts")]
...
public class Post : Content {
  ...
  /// <summary> Whether this post is system-generated (welcome posts, achievements) or user-created </summary>
  public bool IsSystemGenerated { get; set; } = false;

  /// <summary> Whether the post is pinned (appears at top of feeds) </summary>
  public bool IsPinned { get; set; } = false;

  /// <summary> Number of likes/reactions on this post </summary>
  public int LikesCount { get; set; } = 0;

  /// <summary> Number of comments on this post </summary>
  public int CommentsCount { get; set; } = 0;

  /// <summary> Number of shares/reposts </summary>
  public int SharesCount { get; set; } = 0;

  /// <summary> Rich content stored as JSON (images, links, embeds, etc.) </summary>
  ...
  /// <summary> Likes/reactions on this post </summary>
  ...
  /// <summary> Views/visits to this post </summary>
  public virtual ICollection<PostView> Views { get; set; } = new List<PostView>();

  /// <summary> Statistics for this post </summary>
  public virtual PostStatistics? Statistics { get; set; }

  /// <summary> Slug for URL-friendly identification (inherited from Content base class) Auto-generated from title if not provided </summary>
  public static string GenerateSlug(string title) {
    if (string.IsNullOrWhiteSpace(title)) return Guid.NewGuid().ToString("N")[..8];

    return title.ToLowerInvariant().Replace(" ", "-").Replace("_", "-").Where(c => char.IsLetterOrDigit(c) || c == '-').Aggregate("", (current, c) => current + c).Trim('-');
  }
}
