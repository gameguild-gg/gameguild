...
public sealed record BulkPurgeUsersRequest(IEnumerable<Guid> UserIds, PurgeStrategy Strategy = PurgeStrategy.GracePeriod);
...
/// <param name="Strategy">The purge strategy to use</param>
public sealed record BulkPurgeUsersCommand(IEnumerable<Guid> UserIds, PurgeStrategy Strategy) : ICommand;
