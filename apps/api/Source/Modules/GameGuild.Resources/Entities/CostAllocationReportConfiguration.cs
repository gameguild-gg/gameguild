...
public class CostAllocationReportConfiguration : IEntityTypeConfiguration<CostAllocationReport>
{
    public void Configure(EntityTypeBuilder<CostAllocationReport> builder)
    {
        ...
        builder.ToTable("costallocationreport", "gameguild.resources");
        ...
        // TODO: Add specific property configurations for CostAllocationReport
        // Example:
        ...
        // Configure indexes
        // builder.HasIndex(x => x.TenantId).HasDatabaseName("idx_costallocationreport_tenant_id");
