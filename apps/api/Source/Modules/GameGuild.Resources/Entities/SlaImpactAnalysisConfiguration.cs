...
public class SlaImpactAnalysisConfiguration : IEntityTypeConfiguration<SlaImpactAnalysis>
{
    public void Configure(EntityTypeBuilder<SlaImpactAnalysis> builder)
    {
        ...
        builder.ToTable("slaimpactanalysis", "gameguild.resources");
        ...
        // TODO: Add specific property configurations for SlaImpactAnalysis
        // Example:
        ...
        // Configure indexes
        // builder.HasIndex(x => x.TenantId).HasDatabaseName("idx_slaimpactanalysis_tenant_id");
