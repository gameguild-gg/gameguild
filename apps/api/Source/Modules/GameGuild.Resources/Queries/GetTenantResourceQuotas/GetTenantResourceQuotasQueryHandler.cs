...
/// </summary>
public sealed class GetTenantResourceQuotasQueryHandler(IResourceQuotaRepository resourceQuotaRepository) : IQueryHandler<GetTenantResourceQuotasQuery, IEnumerable<ResourceQuotaResponse>>
{
