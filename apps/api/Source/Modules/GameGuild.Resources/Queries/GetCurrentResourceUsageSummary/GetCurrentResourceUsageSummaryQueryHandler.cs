...
/// </summary>
public sealed class GetCurrentResourceUsageSummaryQueryHandler(IUsageRecordRepository usageRecordRepository) : IQueryHandler<GetCurrentResourceUsageSummaryQuery, Dictionary<ResourceUsageType, int>>
{
