...
public interface ISlaImpactAnalysisService
{
    ...
    /// <summary>
    ///     Get critical ongoing violations for a tenant.
    /// </summary>
    /// <param name="tenantId">The tenant ID (required)</param>
    /// <param name="cancellationToken">Cancellation token</param>
    Task<IEnumerable<SlaImpactAnalysis>> GetCriticalOngoingViolationsAsync(Guid? tenantId = null, CancellationToken cancellationToken = default);
}
