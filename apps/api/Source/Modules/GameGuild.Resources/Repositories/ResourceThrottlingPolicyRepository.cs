...
public class ResourceThrottlingPolicyRepository(IApplicationDbContext context) : IResourceThrottlingPolicyRepository
{
    ...
    public async Task<ResourceThrottlingPolicy> AddAsync(ResourceThrottlingPolicy policy, CancellationToken cancellationToken = default) { return await CreateAsync(policy, cancellationToken); }
}
