...
public class SlaImpactAnalysisRepository(IApplicationDbContext context) : ISlaImpactAnalysisRepository
{
    ...
    public async Task<SlaImpactAnalysis> AddAsync(SlaImpactAnalysis analysis, CancellationToken cancellationToken = default) { return await CreateAsync(analysis, cancellationToken); }
