...
public interface ITestingLabSettingsService {
  /// <summary> Get testing lab settings for a specific tenant or global settings Creates default settings if none exist </summary>
  ...
  /// <summary> Get testing lab settings as DTO for a specific tenant or global settings Creates default settings if none exist </summary>
  /// <param name="tenantId"> Tenant ID for tenant-specific settings, or null for global settings </param>
  Task<TestingLabSettingsDto> GetTestingLabSettingsDtoAsync(Guid? tenantId = null);

  /// <summary> Create or update testing lab settings for a specific tenant or global settings </summary>
  /// <param name="tenantId"> Tenant ID for tenant-specific settings, or null for global settings </param>
  /// <param name="dto"> Settings values to create or replace </param>
  Task<TestingLabSettings> CreateOrUpdateTestingLabSettingsAsync(Guid? tenantId, CreateTestingLabSettingsDto dto);

  /// <summary> Update testing lab settings (partial update) for a specific tenant or global settings </summary>
  /// <param name="tenantId"> Tenant ID for tenant-specific settings, or null for global settings </param>
  /// <param name="dto"> Partial settings values to update </param>
  Task<TestingLabSettings> UpdateTestingLabSettingsAsync(Guid? tenantId, UpdateTestingLabSettingsDto dto);

  /// <summary> Reset testing lab settings to default values for a specific tenant or global settings </summary>
  /// <param name="tenantId"> Tenant ID for tenant-specific settings, or null for global settings </param>
  Task<TestingLabSettings> ResetTestingLabSettingsAsync(Guid? tenantId = null);

  /// <summary> Check if testing lab settings exist for a specific tenant or global settings </summary>
  /// <param name="tenantId"> Tenant ID for tenant-specific settings, or null for global settings </param>
