...
public class TestingController(ITestService testService) : ControllerBase {
  ...
  [HttpGet("requests")]
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingRequestPermission, TestingRequest>(PermissionType.Read)]
  ...
  [HttpPost("requests")]
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingRequestPermission, TestingRequest>(PermissionType.Create)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingRequestPermission, TestingRequest>(PermissionType.Delete)]
  ...
  [HttpGet("sessions")]
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingSessionPermission, TestingSession>(PermissionType.Read)]
  ...
  [HttpPost("sessions")]
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingSessionPermission, TestingSession>(PermissionType.Create)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingSessionPermission, TestingSession>(PermissionType.Delete)]
  ...
  /// <summary> Public endpoint returning "published" testing sessions (Scheduled or Active). No authentication required. </summary>
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingParticipantPermission, TestingParticipant>(PermissionType.Create)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingParticipantPermission, TestingParticipant>(PermissionType.Delete)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingParticipantPermission, TestingParticipant>(PermissionType.Read)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<SessionRegistrationPermission, SessionRegistration>(PermissionType.Create, "sessionId")]
  public async Task<ActionResult<SessionRegistration>> RegisterForSession(Guid sessionId, [FromBody] SessionRegistrationRequest request) {
    try {
      ...
      var registration = await testService.RegisterForSessionAsync(sessionId, userId, request.RegistrationType, request.Notes);
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<SessionRegistrationPermission, SessionRegistration>(PermissionType.Delete, "sessionId")]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<SessionRegistrationPermission, SessionRegistration>(PermissionType.Read, "sessionId")]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<SessionWaitlistPermission, SessionWaitlist>(PermissionType.Create, "sessionId")]
  public async Task<ActionResult<SessionWaitlist>> AddToWaitlist(Guid sessionId, [FromBody] SessionRegistrationRequest request) {
    try {
      ...
      var waitlistEntry = await testService.AddToWaitlistAsync(sessionId, userId, request.RegistrationType, request.Notes);
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<SessionWaitlistPermission, SessionWaitlist>(PermissionType.Delete, "sessionId")]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<SessionWaitlistPermission, SessionWaitlist>(PermissionType.Read, "sessionId")]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingFeedbackPermission, TestingFeedback>(PermissionType.Create)]
  public async Task<ActionResult<TestingFeedback>> AddFeedback(Guid requestId, [FromBody] FeedbackRequest request) {
    try {
      ...
      var feedback = await testService.AddFeedbackAsync(requestId, userId, request.FeedbackFormId, request.FeedbackData, request.TestingContext, request.SessionId, request.AdditionalNotes);
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingFeedbackPermission, TestingFeedback>(PermissionType.Read)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingSessionPermission, TestingSession>(PermissionType.Read, "sessionId")]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingParticipantPermission, TestingParticipant>(PermissionType.Read, "userId")]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<SessionRegistrationPermission, SessionRegistration>(PermissionType.Read)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<SessionRegistrationPermission, SessionRegistration>(PermissionType.Edit, "sessionId")]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingFeedbackPermission, TestingFeedback>(PermissionType.Report, "feedbackId")]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingFeedbackPermission, TestingFeedback>(PermissionType.Edit, "feedbackId")]
  ...
  [HttpGet("locations")]
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingLocationPermission, TestingLocation>(PermissionType.Read)]
  ...
  [HttpPost("locations")]
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingLocationPermission, TestingLocation>(PermissionType.Create)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingLocationPermission, TestingLocation>(PermissionType.Edit)]
  ...
  [GameGuild.Identity.Authorization.RequireResourcePermission<TestingLocationPermission, TestingLocation>(PermissionType.Delete)]
...
public class CreateTestingLocationDto {
  ...
  public TestingLocation ToTestingLocation() {
    return new TestingLocation { Name = Name, Description = Description, Address = Address, MaxTestersCapacity = MaxTestersCapacity, MaxProjectsCapacity = MaxProjectsCapacity, EquipmentAvailable = EquipmentAvailable, Status = Status };
  }
}
