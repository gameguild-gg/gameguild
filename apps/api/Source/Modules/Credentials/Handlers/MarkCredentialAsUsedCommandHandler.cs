...
public class MarkCredentialAsUsedCommandHandler : IRequestHandler<MarkCredentialAsUsedCommand, bool> {
  ...
  public async Task<bool> Handle(MarkCredentialAsUsedCommand request, CancellationToken cancellationToken) { return await _credentialService.MarkCredentialAsUsedAsync(request.Id); }
}
