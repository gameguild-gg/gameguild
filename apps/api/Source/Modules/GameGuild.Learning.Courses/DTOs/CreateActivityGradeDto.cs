...
public sealed record CreateActivityGradeDto([Required] Guid ContentInteractionId, [Required] Guid GraderProgramUserId, [Required] [Range(0, 100)] decimal Grade, string? Feedback = null, string? GradingDetails = null) {
