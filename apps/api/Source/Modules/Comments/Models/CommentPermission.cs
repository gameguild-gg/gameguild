...
public class CommentPermission : ResourcePermission<Comment> {
  ...
  public bool CanReply { get => HasPermission(PermissionType.Reply) && IsValid; }
  ...
  public bool CanFlag { get => HasPermission(PermissionType.Flag) && IsValid; }

  /// <summary> Check if user can vote on this comment </summary>
  public bool CanVote { get => HasPermission(PermissionType.Vote) && IsValid; }
}
