...
public interface IPostCommentService
{
    ...
    Task<Result<IEnumerable<PostComment>>> GetPostCommentsAsync(Guid postId, int skip = 0, int take = 50, Guid? parentCommentId = null, CancellationToken cancellationToken = default);
