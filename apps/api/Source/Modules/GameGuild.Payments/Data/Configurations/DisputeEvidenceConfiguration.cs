...
public class DisputeEvidenceConfiguration : IEntityTypeConfiguration<DisputeEvidence>
{
    public void Configure(EntityTypeBuilder<DisputeEvidence> builder)
    {
        ...
        builder.ToTable("disputeevidence", "gameguild.payments");
        ...
        // TODO: Add specific property configurations for DisputeEvidence
        // Example:
        ...
        // Configure indexes
        // builder.HasIndex(x => x.TenantId).HasDatabaseName("idx_disputeevidence_tenant_id");
