...
public class ProductQueries {
  ...
  /// </summary>
  public async Task<IEnumerable<ProductEntity>> GetProducts([Service] IProductService productService, int skip = 0, int take = 50) { return await productService.GetProductsAsync(skip, take); }
  ...
  /// </summary>
  public async Task<IEnumerable<Models.ProductPricing>> GetPricingHistory(Guid productId, [Service] IProductService productService) { return await productService.GetPricingHistoryAsync(productId); }

  /// <summary>
  /// Gets user's products
  /// </summary>
  public async Task<IEnumerable<Models.UserProduct>> GetUserProducts(Guid userId, [Service] IProductService productService) { return await productService.GetUserProductsAsync(userId); }
  ...
  /// </summary>
  public async Task<int> GetProductCount([Service] IProductService productService, ProductTypeEnum? type = null, Common.Entities.AccessLevel? visibility = null) { return await productService.GetProductCountAsync(type, visibility); }
