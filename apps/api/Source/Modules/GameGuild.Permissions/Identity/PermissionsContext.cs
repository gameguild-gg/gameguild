...
public class PermissionsContext(IUserContext userContext, ITenantContext tenantContext, IPermissionService permissionService) : IPermissionsContext
{
    ...
    public Guid? TenantId { get => tenantContext.TenantId; }

    public bool IsAuthenticated { get => userContext.IsAuthenticated; }

    public bool IsSystemAdmin { get => userContext.IsInRole("SystemAdmin") || userContext.IsInRole("Admin"); }

    public bool IsTenantAdmin { get => userContext.IsInRole("TenantAdmin") || IsSystemAdmin; }
