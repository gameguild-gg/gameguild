...
public class TenantPermission : EntityBase
{
    ...
    /// </summary>
    public void RemovePermissions(params string[ ] permissions) { Permissions = Permissions.Where(p => !permissions.Contains(p, StringComparer.OrdinalIgnoreCase)).ToArray(); }
