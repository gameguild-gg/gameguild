...
public class ProductPermission : ResourcePermission<Product> {
  ...
  public bool CanManagePricing { get => HasPermission(PermissionType.Pricing) && IsValid; }

  /// <summary> Check if user can manage subscriptions for this specific product </summary>
  public bool CanManageSubscriptions { get => HasPermission(PermissionType.Subscription) && IsValid; }
  ...
  public bool CanManagePromoCodes { get => HasPermission(PermissionType.Monetize) && IsValid; }

  /// <summary> Check if user can grant access to other users for this specific product </summary>
  public bool CanGrantAccess { get => HasPermission(PermissionType.Share) && IsValid; }

  /// <summary> Check if user can moderate this product (e.g., handle reports, moderate reviews) </summary>
