...
public class ProductMutations {
  /// <summary> Creates a new product using CQRS pattern </summary>
  ...
  /// <summary> Unpublishes a product </summary>
  ...
  /// <summary> Sets product visibility </summary>
  public async Task<ProductEntity?> SetProductVisibility(Guid id, AccessLevel visibility, [Service] IMediator mediator) {
  ...
  /// <summary> Adds a product to a bundle </summary>
  ...
  /// <summary> Removes a product from a bundle </summary>
  public async Task<ProductEntity?> RemoveFromBundle(BundleManagementInput input, [Service] IMediator mediator) {
  ...
  /// <summary> Sets product pricing </summary>
  public async Task<ProductPricing> SetProductPricing(SetProductPricingInput input, [Service] IMediator mediator) {
  ...
  /// <summary> Updates product pricing </summary>
  public async Task<ProductPricing?> UpdateProductPricing(UpdateProductPricingInput input, [Service] IMediator mediator) {
  ...
  /// <summary> Revokes user access to a product </summary>
  ...
  /// <summary> Creates a promotional code </summary>
  public async Task<PromoCode> CreatePromoCode(CreatePromoCodeInput input, [Service] IMediator mediator) {
  ...
  /// <summary> Updates a promotional code </summary>
  public async Task<PromoCode?> UpdatePromoCode(UpdatePromoCodeInput input, [Service] IMediator mediator) {
  ...
  /// <summary> Deletes a promotional code </summary>
  ...
  /// <summary> Uses a promotional code </summary>
  public async Task<PromoCodeUse> UsePromoCode(Guid userId, string code, decimal discountAmount, [Service] IMediator mediator) {
