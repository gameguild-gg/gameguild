...
/// <summary> DTO for Achievement entity </summary>
...
/// <summary> DTO for UserAchievement entity </summary>
...
/// <summary> DTO for Achievement Level </summary>
...
/// <summary> DTO for Achievement Progress </summary>
public class AchievementProgressDto {
  ...
  public double ProgressPercentage { get => TargetProgress > 0 ? (double) CurrentProgress / TargetProgress * 100 : 0; }
...
/// <summary> Paginated response for achievements </summary>
...
/// <summary> Paginated response for user achievements </summary>
...
/// <summary> User achievement summary </summary>
public class UserAchievementSummaryDto {
  ...
  public List<UserAchievementDto> RecentAchievements { get; set; } = new List<UserAchievementDto>();

  public List<AchievementProgressDto> NearCompletion { get; set; } = new List<AchievementProgressDto>();

  public Dictionary<string, int> AchievementsByCategory { get; set; } = new Dictionary<string, int>();
}

/// <summary> User achievement leaderboard entry </summary>
...
/// <summary> Achievement statistics </summary>
public class AchievementStatisticsDto {
  ...
  public List<AchievementPopularityDto> MostEarnedAchievements { get; set; } = new List<AchievementPopularityDto>();

  public List<AchievementPopularityDto> RarestAchievements { get; set; } = new List<AchievementPopularityDto>();
}

/// <summary> DTO for prerequisite check result </summary>
public class AchievementPrerequisiteCheckDto {
  public Guid AchievementId { get; set; }

  public bool CanEarn { get; set; }

  public List<PrerequisiteStatusDto> Prerequisites { get; set; } = new List<PrerequisiteStatusDto>();
}

/// <summary> DTO for prerequisite status </summary>
...
/// <summary> DTO for achievement popularity information </summary>
