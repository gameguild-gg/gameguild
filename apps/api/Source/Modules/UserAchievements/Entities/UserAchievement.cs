...
/// <summary> Represents a user's earned achievement </summary>
...
public class UserAchievement : EntityBase {
  ...
  /// <summary> Current progress towards this achievement (for partial completion tracking) </summary>
  ...
  /// <summary> Additional context about how the achievement was earned (stored as JSON) </summary>
  ...
  /// <summary> Times this achievement has been earned (for repeatable achievements) </summary>
