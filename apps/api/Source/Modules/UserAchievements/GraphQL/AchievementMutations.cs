...
public class AchievementMutations {
  ...
  public async Task<Achievement> CreateAchievement([Service] IMediator mediator, CreateAchievementInput input) {
    var command = new CreateAchievementCommand {
      ...
      Levels = input.Levels?.Select(l => new CreateAchievementLevelCommand { Level = l.Level, Name = l.Name, Description = l.Description, RequiredProgress = l.RequiredProgress, Points = l.Points, IconUrl = l.IconUrl, Color = l.Color })
                    .ToList(),
