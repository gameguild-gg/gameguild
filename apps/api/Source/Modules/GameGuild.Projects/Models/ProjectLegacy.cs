...
/// <summary> LEGACY: Represents a project (game, tool, art, etc.) - Use GameGuild.Projects.Project instead </summary>
[Table("Projects")]
[Index(nameof(Title))]
[Index(nameof(Status))]
...
public sealed class ProjectLegacy : EntityBase {
  ...
  [GraphQLIgnore]
  [NotMapped]
  public bool IsActive { get => Status == ContentStatus.Published && DeletedAt == null; }

  /// <summary> Computed property: Latest version </summary>
  [GraphQLIgnore]
  [NotMapped]
  public ProjectVersion? LatestVersion { get => Versions.OrderByDescending(v => v.CreatedAt).FirstOrDefault(); }
  ...
  [GraphQLIgnore]
  [NotMapped]
  public int FeedbackCount { get => Feedbacks.Count(f => f.Status == ContentStatus.Published); }

  /// <summary> Computed property: Whether the project is part of active jams </summary>
  [GraphQLIgnore]
  [NotMapped]
  public bool IsInJam { get => JamSubmissions.Count != 0; }

  /// <summary> Computed property: Number of teams working on this project </summary>
  [GraphQLIgnore]
  [NotMapped]
  public int TeamCount { get => Teams.Count(team => team.IsActive); }
