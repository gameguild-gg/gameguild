...
using ProjectJamSubmissionEntity = GameGuild.Projects.ProjectJamSubmission;

namespace GameGuild.Projects;

internal sealed class ProjectJamSubmissionConfiguration : IEntityTypeConfiguration<ProjectJamSubmissionEntity> {
  public void Configure(EntityTypeBuilder<ProjectJamSubmissionEntity> builder) {
