...
/// <summary> EntityBase configuration for Project </summary>
public class ProjectConfiguration : IEntityTypeConfiguration<Project> {
  public void Configure(EntityTypeBuilder<Project> builder) {
    ...
    // Note: Tenant relationship is handled via TenantId property on EntityBase, no navigation property on Project
