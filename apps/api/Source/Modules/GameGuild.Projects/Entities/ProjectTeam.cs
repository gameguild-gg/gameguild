...
public sealed class ProjectTeam : EntityBase
{
    ...
    public ProjectTeamRole Role { get; set; } = ProjectTeamRole.Contributor;

    public ProjectTeamParticipationMode ParticipationMode { get; set; } = ProjectTeamParticipationMode.SelectedMembers;
