...
/// <summary> Represents a user following a project </summary>
...
public class ProjectFollower : EntityBase<Guid>
{
    /// <summary> Project being followed </summary>
    ...
    /// <summary> Whether the follower wants email notifications </summary>
    public bool EmailNotifications { get; set; } = true;

    /// <summary> Whether the follower wants push notifications </summary>
