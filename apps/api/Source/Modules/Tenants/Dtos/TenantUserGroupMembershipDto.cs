...
/// <summary> DTO for tenant user group membership information </summary>
public class TenantUserGroupMembershipDto {
  /// <summary> Unique identifier for the membership </summary>
  ...
  /// <summary> ID of the user group (alias for UserGroupId) </summary>
  public Guid GroupId { get; set; }

  /// <summary> When the user joined this group </summary>
  public DateTime JoinedAt { get; set; }

  /// <summary> Whether this membership was automatically assigned </summary>
  ...
  /// <summary> Creates a DTO from a TenantUserGroupMembership entity </summary>
