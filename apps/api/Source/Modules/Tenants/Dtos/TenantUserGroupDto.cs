...
/// <summary> DTO for tenant user group information </summary>
public class TenantUserGroupDto {
  /// <summary> Unique identifier for the user group </summary>
  ...
  /// <summary> ID of the parent group (for nested hierarchy) </summary>
  public Guid? ParentGroupId { get; set; }

  /// <summary> Whether this group is currently active </summary>
  public bool IsActive { get; set; }

  /// <summary> Whether this is the default group for auto-assignment </summary>
  ...
  /// <summary> Creates a DTO from a TenantUserGroup entity </summary>
