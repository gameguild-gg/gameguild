...
/// <summary> Extension methods for mapping between DTOs and entities in the Tenant module </summary>
public static class TenantDomainMappingExtensions {
  /// <summary> Maps CreateTenantDomainDto to TenantDomain entity </summary>
  public static TenantDomain ToTenantDomain(this CreateTenantDomainDto dto) {
    return new TenantDomain { TenantId = dto.TenantId, TopLevelDomain = dto.TopLevelDomain, Subdomain = dto.Subdomain, IsMainDomain = dto.IsMainDomain, IsSecondaryDomain = dto.IsSecondaryDomain, UserGroupId = dto.UserGroupId };
  }

  /// <summary> Updates TenantDomain entity with values from UpdateTenantDomainDto </summary>
  ...
  /// <summary> Maps CreateTenantUserGroupDto to TenantUserGroup entity </summary>
  public static TenantUserGroup ToTenantUserGroup(this CreateTenantUserGroupDto dto) {
    return new TenantUserGroup { Name = dto.Name, Description = dto.Description, TenantId = dto.TenantId, ParentGroupId = dto.ParentGroupId, IsActive = dto.IsActive, IsDefault = dto.IsDefault };
  }

  /// <summary> Updates TenantUserGroup entity with values from UpdateTenantUserGroupDto </summary>
