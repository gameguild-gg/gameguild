...
public class TenantConfiguration : IEntityTypeConfiguration<Tenant>
{
    public void Configure(EntityTypeBuilder<Tenant> builder)
    {
        ...
        builder.Property(t => t.IsDefault).HasDefaultValue(false); // Indexes
        builder.HasIndex(t => t.Slug).IsUnique().HasDatabaseName("ix_tenants_slug");

        builder.HasIndex(t => t.Name).IsUnique().HasDatabaseName("ix_tenants_name");

        builder.HasIndex(t => t.IsActive).HasDatabaseName("ix_tenants_is_active");

        builder.HasIndex(t => t.IsDefault).IsUnique().HasFilter("is_default = true").HasDatabaseName("ix_tenant_unique_default");
    }
}
