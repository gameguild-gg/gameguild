...
/// <summary> Represents a tenant in a multi-tenant system Inherits from Resource to provide UUID IDs, version control, timestamps, and soft delete functionality Enhanced with external-product patterns for comprehensive tenant management </summary>
[Table("Tenants")]
...
public class Tenant : Resource {
  ...
  /// <summary> Whether this is the default tenant (for null tenant scenarios) </summary>
