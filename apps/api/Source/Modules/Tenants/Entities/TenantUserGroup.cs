...
public class TenantUserGroup : EntityBase {
  ...
  /// <summary> Name of the user group (e.g., "Students", "Professors", "Administrators") </summary>
  [Required]
  [MaxLength(100)]
  ...
  /// <summary> ID of the tenant this group belongs to </summary>
  [Required]
  public Guid TenantId { get; set; }

  /// <summary> ID of the parent group (for nested group hierarchy) </summary>
  public Guid? ParentGroupId { get; set; }

  /// <summary> Whether this group is currently active </summary>
  public bool IsActive { get; set; } = true;

  /// <summary> Whether this is the default group for auto-assignment in this tenant </summary>
  ...
  /// <summary> Get all descendant groups (sub-groups and their sub-groups recursively) </summary>
