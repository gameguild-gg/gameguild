...
/// <summary> Represents a user's membership in a tenant user group </summary>
...
public class TenantUserGroupMembership : EntityBase {
  ...
  /// <summary> Constructor to create a new membership </summary>
  ...
  /// <summary> Whether this membership was automatically assigned based on domain matching </summary>
