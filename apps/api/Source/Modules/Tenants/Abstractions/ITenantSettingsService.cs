...
/// Provides CRUD operations and helper methods for tenant-specific configuration
/// </summary>
public interface ITenantSettingsService
{
    ...
    /// <summary>
    /// Get tenant settings by tenant ID (creates default if none exist)
    /// </summary>
    ...
    /// <summary>
    /// Update specific tenant settings fields
    /// </summary>
    /// <param name="tenantId">Tenant ID (null for global default settings)</param>
    ...
    /// <summary>
    /// Delete tenant settings (will fall back to defaults)
    /// </summary>
    ...
    /// <summary>
    /// Get module setting value for tenant
    /// </summary>
    /// <param name="tenantId">Tenant ID (null for global default)</param>
    ...
    /// <summary>
    /// Set module setting value for tenant
    /// </summary>
    /// <param name="tenantId">Tenant ID (null for global default)</param>
    /// <param name="module">Module name</param>
    /// <param name="key">Setting key</param>
    ...
    /// <summary>
    /// Get effective settings for tenant (with fallback to global defaults)
    /// </summary>
    /// <param name="tenantId">Tenant ID</param>
    /// <param name="cancellationToken">Cancellation token</param>
    ...
    /// <summary>
    /// Clone settings from one tenant to another
    /// </summary>
