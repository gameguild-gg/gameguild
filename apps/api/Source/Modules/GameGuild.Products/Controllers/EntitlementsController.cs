...
public class EntitlementsController(IEntitlementService entitlementService) : ControllerBase
{
    ...
    [RequirePermission(AuthPermissions.EntitlementsReadSelf)]
    ...
    [RequirePermission(AuthPermissions.EntitlementsReadAll)]
    ...
    /// </summary>
    [HttpPost("grant")]
    [RequirePermission(AuthPermissions.EntitlementsGrant)]
    ...
    /// </summary>
    [HttpPost("revoke")]
    [RequirePermission(AuthPermissions.EntitlementsRevoke)]
