...
/// <summary>
///     Strongly-typed permissions for achievement management operations.
///     Provides compile-time safety for gamification administration checks.
/// </summary>
public sealed class AchievementsPermission : Permission
{
    private AchievementsPermission(string key, string description)
        : base(
            resource: key.Split(':')[0],
            action: key.Split(':')[1],
            scope: key.Split(':').Length > 2 ? key.Split(':')[2] : null,
    ...
    public static class Keys
    {
        ...
        public const string Create = "achievements:create";

        /// <summary>Update achievements</summary>
        public const string Update = "achievements:update";

        /// <summary>Delete achievements</summary>
        public const string Delete = "achievements:delete";

        /// <summary>Manually award achievements</summary>
        public const string Award = "achievements:award";

        /// <summary>Full management access to achievements</summary>
        public const string Manage = "achievements:manage";
    }

    /// <summary>Create achievements</summary>
    public static readonly AchievementsPermission Create = new(Keys.Create, "Create achievements");

    /// <summary>Update achievements</summary>
    public static readonly AchievementsPermission Update = new(Keys.Update, "Update achievements");

    /// <summary>Delete achievements</summary>
    public static readonly AchievementsPermission Delete = new(Keys.Delete, "Delete achievements");

    /// <summary>Manually award achievements</summary>
    public static readonly AchievementsPermission Award = new(Keys.Award, "Manually award achievements");

    /// <summary>Full management access to achievements</summary>
    public static readonly AchievementsPermission Manage = new(Keys.Manage, "Full management access to achievements");
}
