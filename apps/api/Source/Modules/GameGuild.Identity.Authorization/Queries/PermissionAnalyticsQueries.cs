...
/// </summary>
public record GetPermissionUsageQuery(
    Guid? TenantId,
    DateTime? FromDate = null,
    DateTime? ToDate = null
) : IQuery<List<PermissionUsageMetrics>>;

public class GetPermissionUsageHandler(IPermissionAnalyticsService service)
...
public class GetUserActivityHandler(IPermissionAnalyticsService service)
...
/// </summary>
public record GetResourceAccessPatternsQuery(
    Guid? TenantId,
    int Top = 10,
    DateTime? FromDate = null,
    DateTime? ToDate = null
...
public class GetResourceAccessPatternsHandler(IPermissionAnalyticsService service)
...
/// </summary>
public record GetPermissionTrendsQuery(
    Guid? TenantId,
    DateTime FromDate,
    DateTime ToDate
) : IQuery<List<PermissionTrend>>;

public class GetPermissionTrendsHandler(IPermissionAnalyticsService service)
...
/// </summary>
public record DetectPermissionAnomaliesQuery(
    Guid? TenantId,
    DateTime? FromDate = null
) : IQuery<List<PermissionAnomaly>>;

public class DetectPermissionAnomaliesHandler(IPermissionAnalyticsService service)
...
/// </summary>
public record GeneratePermissionReportQuery(
    Guid? TenantId,
    DateTime PeriodStart,
    DateTime PeriodEnd
) : IQuery<PermissionAnalyticsReport>;

public class GeneratePermissionReportHandler(IPermissionAnalyticsService service)
