...
/// <summary> Enhanced Permission Resolver implementing three-layer permission system Follows Clean Architecture with proper separation of concerns </summary>
public class PermissionResolver(IPermissionService permissionService, ILogger<PermissionResolver> logger) : IPermissionResolver
{
  private readonly ILogger<PermissionResolver> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
