...
/// <summary> Controller for managing module-based permissions Provides granular permission management for different modules like TestingLab, Projects, etc. </summary>
[ApiController]
...
public class ModulePermissionController : ControllerBase {
  ...
  public ModulePermissionController(IModulePermissionService modulePermissionService, ILogger<ModulePermissionController> logger) {
  ...
  /// <summary> Check if the current user has a specific permission in a module </summary>
  [HttpGet("check")]
  public async Task<ActionResult<bool>> HasModulePermission([FromQuery] ModuleType module, [FromQuery] ModuleAction action, [FromQuery] Guid? tenantId = null, [FromQuery] Guid? resourceId = null) {
  ...
  /// <summary> Get all effective permissions for the current user in a module </summary>
  [HttpGet("my-permissions")]
  public async Task<ActionResult<List<ModulePermissionDefinition>>> GetMyModulePermissions([FromQuery] ModuleType module, [FromQuery] Guid? tenantId = null) {
    var userId = GetCurrentUserId();
  ...
  /// <summary> Get all effective permissions for a specific user in a module (admin only) </summary>
  [HttpGet("users/{userId}/permissions")]
  public async Task<ActionResult<List<ModulePermissionDefinition>>> GetUserModulePermissions(Guid userId, [FromQuery] ModuleType module, [FromQuery] Guid? tenantId = null) {
  ...
  /// <summary> Get users who have a specific permission in a module </summary>
  [HttpGet("users-with-permission")]
  public async Task<ActionResult<List<Guid>>> GetUsersWithPermission([FromQuery] ModuleType module, [FromQuery] ModuleAction action, [FromQuery] Guid? tenantId = null) {
    // TODO: Add admin permission check
  ...
  /// <summary> Assign a role to a user for a specific module </summary>
  [HttpPost("assign-role")]
  public async Task<ActionResult<UserRoleAssignment>> AssignRole([FromBody] AssignRoleRequest request) {
    // TODO: Add admin permission check
    var assignment = await _modulePermissionService.AssignRoleAsync(request.UserId, request.TenantId, request.Module, request.RoleName, request.Constraints, request.ExpiresAt);
  ...
  /// <summary> Revoke a role from a user for a specific module </summary>
  ...
  public async Task<ActionResult> RevokeRole([FromBody] RevokeRoleRequest request) {
    ...
    if (!result) { return NotFound("Role assignment not found"); }

    return NoContent();
  }

  /// <summary> Get all roles assigned to a user for a specific module </summary>
  [HttpGet("users/{userId}/roles")]
  public async Task<ActionResult<List<UserRoleAssignment>>> GetUserRoles(Guid userId, [FromQuery] ModuleType module, [FromQuery] Guid? tenantId = null) {
    var roles = await _modulePermissionService.GetUserRolesAsync(userId, tenantId, module);

    return Ok(roles);
  }

  /// <summary> Get all users with a specific role in a module </summary>
  [HttpGet("roles/{roleName}/users")]
  public async Task<ActionResult<List<UserRoleAssignment>>> GetUsersWithRole(string roleName, [FromQuery] ModuleType module, [FromQuery] Guid? tenantId = null) {
    // TODO: Add admin permission check
  ...
  /// <summary> Get all Testing Lab permissions for the current user </summary>
  ...
  /// <summary> Get all Testing Lab permissions for a specific user </summary>
  ...
  /// <summary> Check if the current user can create testing sessions </summary>
  ...
  /// <summary> Check if the current user can delete testing sessions </summary>
  ...
  /// <summary> Check if the current user can manage testers </summary>
  ...
  /// <summary> Check if the current user can view testing reports </summary>
  ...
  /// <summary> Check if the current user can export testing data </summary>
  ...
  /// <summary> Get all role definitions for a module </summary>
  ...
  /// <summary> Create a new role definition for a module </summary>
  ...
  public async Task<ActionResult<ModuleRole>> CreateRoleDefinition(ModuleType module, [FromBody] CreateRoleRequest request) {
    // TODO: Add admin permission check
    try {
      var role = await _modulePermissionService.CreateRoleDefinitionAsync(request.RoleName, module, request.Description, request.Permissions, request.Priority);
  ...
  /// <summary> Update an existing role definition </summary>
  ...
  /// <summary> Delete a role definition </summary>
  ...
  public async Task<ActionResult> DeleteRoleDefinition(ModuleType module, string roleName) {
    ...
    try {
      ...
      if (!result) { return NotFound("Role definition not found"); }
...
public class CreateRoleRequest {
  ...
  public List<ModulePermissionDefinition> Permissions { get; set; } = new List<ModulePermissionDefinition>();
