...
/// <summary> Content-type-wide permissions (Layer 3 of a DAC permission system) Allows setting permissions for specific content types within a tenant </summary>
...
public class ContentTypePermission : WithPermissions {
  /// <summary> The content type this permission applies to (e.g., "Article", "Video", "Discussion") </summary>
