...
/// <summary> Service interface for Program business logic Provides operations for managing programs, content, user participation, and analytics </summary>
public interface IProgramService {
  // Basic CRUD Operations
  /// <summary> Get a program by ID with basic details </summary>
  Task<ProgramEntity?> GetProgramByIdAsync(Guid id);

  /// <summary> Get a program by slug with basic details </summary>
  Task<ProgramEntity?> GetProgramBySlugAsync(string slug);

  /// <summary> Get a published program by slug (publicly accessible) </summary>
  Task<ProgramEntity?> GetPublishedProgramBySlugAsync(string slug);

  /// <summary> Get a program by ID with all content included </summary>
  Task<ProgramEntity?> GetProgramWithContentAsync(Guid id);

  /// <summary> Get paginated list of programs </summary>
