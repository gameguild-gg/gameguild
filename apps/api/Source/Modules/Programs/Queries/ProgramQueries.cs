...
/// All queries implement IQuery pattern for GameGuild.CQRS handling
/// </summary>
...
public record GetUserProgramProgressQuery(Guid ProgramId, string UserId) : IQuery<ProgramUserProgress?>;
...
public record GetCreatorProgramStatisticsQuery(string CreatorId, DateTime? FromDate = null, DateTime? ToDate = null) : IQuery<CreatorProgramStatistics>;
