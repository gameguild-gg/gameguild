...
public class ProgramEnrollment : EntityBase {
  ...
  /// <summary> How the user was enrolled (manual, auto from product purchase, etc.) </summary>
  public EnrollmentSource EnrollmentSource { get; set; } = EnrollmentSource.Manual;

  /// <summary> When the user was enrolled </summary>
  public DateTime EnrolledAt { get; set; } = DateTime.UtcNow;

  /// <summary> When enrollment started (for scheduled programs) </summary>
  public DateTime? StartDate { get; set; }

  /// <summary> When enrollment expires (if applicable) </summary>
  ...
  /// <summary> When the program was completed </summary>
  public DateTime? CompletedAt { get; set; }

  /// <summary> Final grade/score (if applicable) </summary>
  public decimal? FinalGrade { get; set; }

  /// <summary> Whether a certificate was issued </summary>
  public bool CertificateIssued { get; set; } = false;

  /// <summary> When the certificate was issued </summary>
  public DateTime? CertificateIssuedAt { get; set; }

  /// <summary> ID of the issued certificate </summary>
  ...
  /// <summary> Calculate and update progress based on content completion </summary>
  public void UpdateProgress() {
    // This will be implemented in the service layer
    Touch();
  }

  /// <summary> Mark as completed and issue certificate if eligible </summary>
