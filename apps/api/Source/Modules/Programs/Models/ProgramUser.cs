...
/// <summary> Junction entity representing the relationship between a User and a Program Inherits from BaseEntity to provide UUID IDs, version control, timestamps, and soft delete functionality </summary>
[Table("program_users")]
[Index(nameof(UserId))]
...
public class ProgramUser : EntityBase {
  ...
  /// <summary> Foreign key to the Program entity </summary>
  [Required]
  ...
  /// <summary> Whether this user-program relationship is currently active </summary>
  public bool IsActive { get; set; } = true;

  /// <summary> When the user joined this program </summary>
  public DateTime JoinedAt { get; set; } = DateTime.UtcNow;

  /// <summary> Overall completion percentage for the program (0-100) </summary>
  [Column(TypeName = "decimal(5,2)")]
  public decimal CompletionPercentage { get; set; }

  /// <summary> Overall grade for the program (0-100) </summary>
  [Column(TypeName = "decimal(5,2)")]
  public decimal? FinalGrade { get; set; }

  /// <summary> Date when user started this program </summary>
  public DateTime? StartedAt { get; set; }

  /// <summary> Date when user completed this program </summary>
  public DateTime? CompletedAt { get; set; }

  /// <summary> Last date user accessed any content in this program </summary>
  ...
  /// <summary> Activate the user-program relationship </summary>
  public void Activate() {
    IsActive = true;
    Touch();
  }

  /// <summary> Deactivate the user-program relationship </summary>
  public void Deactivate() {
    IsActive = false;
    Touch();
  }

  /// <summary> Mark content as accessed and update the last accessed timestamp </summary>
  public void MarkAccessed() {
    LastAccessedAt = DateTime.UtcNow;
    Touch();
  }

  /// <summary> Start the program by setting the started timestamp </summary>
  ...
  /// <summary> Complete the program by setting completion timestamp and percentage </summary>
