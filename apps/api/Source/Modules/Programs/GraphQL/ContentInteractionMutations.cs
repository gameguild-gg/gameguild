...
public class ContentInteractionMutations
{
        ...
        [Service] IProgramContentService programContentService)
    {
        try
        {
            ...
            if (content == null || content.ProgramId != programId)
            {
                ...
                {
                    Success = false,
                    ErrorMessage = "Content does not belong to the specified program.",
                    Interaction = null
                };
            }
        ...
        [Service] IContentInteractionService contentInteractionService)
    {
        try
        {
            ...
            if (interaction.Content.ProgramId != programId)
            {
                return new ContentInteractionResult
                {
                    Success = false,
                    ErrorMessage = "Interaction does not belong to the specified program.",
                    Interaction = null
                };
            }
        ...
        catch (Exception ex)
        {
            ...
            {
                Success = false,
                ErrorMessage = "An unexpected error occurred while updating progress.",
                Interaction = null
            };
        }
    }
        ...
        [Service] IContentInteractionService contentInteractionService)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                Success = false,
                ErrorMessage = "An unexpected error occurred while submitting the interaction.",
                Interaction = null
            };
        }
    }
        ...
        [Service] IContentInteractionService contentInteractionService)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                Success = false,
                ErrorMessage = "An unexpected error occurred while completing the interaction.",
                Interaction = null
            };
        }
    }
        ...
        [Service] IContentInteractionService contentInteractionService)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                Success = false,
                ErrorMessage = "An unexpected error occurred while updating time spent.",
                Interaction = null
            };
        }
    }
