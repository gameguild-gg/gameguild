...
/// <summary> GraphQL queries for ActivityGrade operations using CQRS pattern Following permission inheritance: ActivityGrade permissions come from parent Program </summary>
...
public class ActivityGradeQueries {
  ...
  public async Task<ActivityGradeStatistics> GetGradeStatistics(Guid programId, [Service] IActivityGradeService activityGradeService) {
    ...
    return new ActivityGradeStatistics { TotalGrades = statistics.TotalGrades, AverageGrade = statistics.AverageGrade, MinGrade = statistics.MinGrade, MaxGrade = statistics.MaxGrade, PassingRate = statistics.PassingRate };
  }
}
