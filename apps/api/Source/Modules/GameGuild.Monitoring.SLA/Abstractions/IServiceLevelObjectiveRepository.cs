...
public interface IServiceLevelObjectiveRepository
{
    ...
    /// <summary>
    ///     Gets all SLOs across all tenants (for cross-tenant reporting)
    /// </summary>
    Task<List<ServiceLevelObjective>> GetAllSlosAsync(CancellationToken cancellationToken = default);
