...
[Tags("Authentication")]
[Authorize]
public class SessionController(ISessionManagementService sessionService, ILogger<SessionController> logger) : AuthControllerBase
{
    /// <summary>
    ...
    private DeviceInfo? ParseDeviceInfo(string? deviceInfoJson)
    {
        ...
        try { return JsonSerializer.Deserialize<DeviceInfo>(deviceInfoJson); }
        catch { return null; }
    }
    ...
    private LocationInfo? ParseLocation(string? locationJson)
    {
        ...
        try { return JsonSerializer.Deserialize<LocationInfo>(locationJson); }
        catch { return null; }
    }
