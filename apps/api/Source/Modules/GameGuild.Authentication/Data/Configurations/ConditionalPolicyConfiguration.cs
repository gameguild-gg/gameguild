...
/// <summary>
///     Entity Type Configuration for ConditionalPolicy
/// </summary>
public class ConditionalPolicyConfiguration : IEntityTypeConfiguration<ConditionalPolicy>
{
    public void Configure(EntityTypeBuilder<ConditionalPolicy> builder)
    {
        ...
        builder.ToTable("conditionalpolicy", "gameguild.authentication");
        ...
        // TODO: Add specific property configurations for ConditionalPolicy
        // Example:
        ...
        // Configure indexes
        // builder.HasIndex(x => x.TenantId).HasDatabaseName("idx_conditionalpolicy_tenant_id");
