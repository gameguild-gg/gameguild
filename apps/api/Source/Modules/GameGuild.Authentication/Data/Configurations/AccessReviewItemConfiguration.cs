...
/// <summary>
///     Entity Type Configuration for AccessReviewItem
/// </summary>
public class AccessReviewItemConfiguration : IEntityTypeConfiguration<AccessReviewItem>
{
    public void Configure(EntityTypeBuilder<AccessReviewItem> builder)
    {
        ...
        builder.ToTable("accessreviewitem", "gameguild.authentication");
        ...
        // TODO: Add specific property configurations for AccessReviewItem
        // Example:
        ...
        // Configure indexes
        // builder.HasIndex(x => x.TenantId).HasDatabaseName("idx_accessreviewitem_tenant_id");
