...
/// <summary>
///     Entity Type Configuration for AuthUser
/// </summary>
public class AuthUserConfiguration : IEntityTypeConfiguration<AuthUser>
{
    public void Configure(EntityTypeBuilder<AuthUser> builder)
    {
        ...
        builder.ToTable("authuser", "gameguild.authentication");
        ...
        // TODO: Add specific property configurations for AuthUser
        // Example:
        ...
        // Configure indexes
        // builder.HasIndex(x => x.TenantId).HasDatabaseName("idx_authuser_tenant_id");
