...
// ABAC Policy Response DTOs
public abstract class AbacPolicyStatisticsDto
{
    ...
    public Dictionary<string, int> PoliciesByCategory { get; set; } = new Dictionary<string, int>();

    public List<PolicyUsageMetric> UsageMetrics { get; set; } = new List<PolicyUsageMetric>();
}

// Conditional Policy Response DTOs
