...
public interface IReputationService {
  /// <summary> Get a user's reputation in a specific tenant (or global if tenantId is null) </summary>
  /// <param name="userId"> The user ID </param>
  /// <param name="tenantId"> The tenant ID (null for a global reputation) </param>
  ...
  /// <summary> Update a user's reputation score </summary>
  /// <param name="userId"> The user ID </param>
  ...
  /// <summary> Get all users with a specific reputation tier or higher </summary>
