...
public class NotificationPreferences : EntityBase {
  /// <summary> User these preferences belong to </summary>
  [Required]
  ...
  /// <summary> Enable comment notifications </summary>
  public bool CommentNotifications { get; set; } = true;

  /// <summary> Enable follow notifications </summary>
  public bool FollowNotifications { get; set; } = true;

  /// <summary> Enable invite notifications </summary>
  public bool InviteNotifications { get; set; } = true;

  /// <summary> Enable reminder notifications </summary>
  public bool ReminderNotifications { get; set; } = true;

  /// <summary> Enable task notifications </summary>
  public bool TaskNotifications { get; set; } = true;

  /// <summary> Enable mention notifications </summary>
  public bool MentionNotifications { get; set; } = true;

  /// <summary> Enable system notifications </summary>
  public bool SystemNotifications { get; set; } = true;

  /// <summary> Enable course notifications </summary>
  public bool CourseNotifications { get; set; } = true;

  /// <summary> Enable achievement notifications </summary>
  public bool AchievementNotifications { get; set; } = true;

  /// <summary> Enable social notifications </summary>
  public bool SocialNotifications { get; set; } = true;

  /// <summary> Enable promotion notifications </summary>
  public bool PromotionNotifications { get; set; } = true;

  /// <summary> Check if a notification type is enabled </summary>
