...
public sealed class PrivacyEvent : EntityBase
{
    ...
    // Data subject rights
    public DataSubjectRight? DataSubjectRight { get; private set; }
    ...
    public long? ExportSizeBytes { get; private set; }
    public string? ExportLocation { get; private set; }
    public DateTime? ExportExpiresAt { get; private set; }

    // Right to be forgotten (RTBF)
    public string? DeletionScope { get; private set; }
    public bool? IsAnonymized { get; private set; }
    public DateTime? AnonymizedAt { get; private set; }
    public string? RetentionRequirement { get; private set; }
    public string? DeletionMethod { get; private set; }
