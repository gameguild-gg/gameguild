...
public class EncryptionService : IEncryptionService
{
    ...
    public EncryptionService(IOptions<EncryptionOptions> options, ILogger<EncryptionService> logger)
    {
        ...
        if (string.IsNullOrEmpty(_options.EncryptionKey)) { throw new InvalidOperationException("Encryption key is not configured"); }
    }
    ...
    {
        try { return BCrypt.Net.BCrypt.HashPassword(password, _options.BcryptWorkFactor); }
        catch (Exception ex)
        {
