...
/// </summary>
public class GenerateWeb3ChallengeHandler(IAuthService authService) : GameGuild.CQRS.IRequestHandler<GenerateWeb3ChallengeCommand, Web3ChallengeResponseDto> {
