...
public class AuthenticationAttemptRepository(ApplicationDbContext context) : IAuthenticationAttemptRepository
{
    ...
    public async Task<AuthenticationAttempt?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
    {
        return await _context.AuthenticationAttempts.FirstOrDefaultAsync(a => a.Id == id, cancellationToken);
    }
    ...
    {
        return await _context.AuthenticationAttempts
    ...
    {
        IQueryable<AuthenticationAttempt> query = _context.AuthenticationAttempts
    ...
    {
        IQueryable<AuthenticationAttempt> query = _context.AuthenticationAttempts
            .Where(a => a.IsSuspicious || a.RiskScore > 70);
    ...
    {
        List<AuthenticationAttempt> oldAttempts = await _context.AuthenticationAttempts
