...
/// <summary> GraphQL queries for Authentication module using CQRS pattern. Provides clean separation between GraphQL layer and business logic. </summary>
[ExtendObjectType<Query>]
public class AuthQueries {
  /// <summary> Gets user by email using CQRS pattern. </summary>
  ...
  public async Task<User?> GetUserByEmail([GraphQLDescription("The email address to search for")] string email, [Service] IMediator mediator) {
  ...
  public async Task<User?> GetCurrentUser([Service] IMediator mediator, [Service] IHttpContextAccessor contextAccessor) {
  ...
  /// <summary> Gets the current authenticated user's complete profile information. </summary>
  /// <param name="mediator"> GameGuild.CQRS mediator for CQRS </param>
  /// <param name="contextAccessor"> HTTP context accessor for user claims </param>
  ...
  public async Task<UserProfileDto> GetCurrentUserProfile([Service] IMediator mediator, [Service] IHttpContextAccessor contextAccessor) {
  ...
  /// <summary> Validates if an email is available for registration. </summary>
  ...
  public async Task<bool> IsEmailAvailable([GraphQLDescription("The email address to check")] string email, [Service] IMediator mediator) {
