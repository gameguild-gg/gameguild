...
public class AuthMutations
{
    ...
    public async Task<SignInResponseDto> LocalSignUp(
        [GraphQLDescription("User registration details")] LocalSignUpRequestDto input, 
    ...
    public async Task<SignInResponseDto> LocalSignIn(
        [GraphQLDescription("User login credentials")] LocalSignInRequestDto input, 
        [Service] IMediator mediator)
    {
    ...
    public async Task<bool> RevokeToken(
        [GraphQLDescription("The refresh token to revoke")] string refreshToken,
        [Service] IMediator mediator,
    ...
    public async Task<SignInResponseDto> RefreshToken(
        [GraphQLDescription("Refresh token to use")] string refreshToken,
        [GraphQLDescription("Optional tenant ID")] Guid? tenantId,
        [Service] IMediator mediator)
    {
    ...
    public async Task<Web3ChallengeResponseDto> GenerateWeb3Challenge(
        [GraphQLDescription("Web3 challenge request data")] Web3ChallengeRequestDto input,
        [Service] IMediator mediator)
    {
    ...
    public async Task<SignInResponseDto> VerifyWeb3Signature(
        [GraphQLDescription("Web3 signature verification data")] Web3VerifyRequestDto input, 
        [Service] IMediator mediator)
    {
