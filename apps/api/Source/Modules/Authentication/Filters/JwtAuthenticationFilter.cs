...
/// <summary> JWT Authentication filter that validates tokens and sets user context </summary>
public class JwtAuthenticationFilter(IConfiguration configuration) : IAuthorizationFilter {
  public virtual void OnAuthorization(AuthorizationFilterContext context) {
    ...
    var publicAttribute = context.ActionDescriptor.EndpointMetadata.OfType<PublicAttribute>().FirstOrDefault();
