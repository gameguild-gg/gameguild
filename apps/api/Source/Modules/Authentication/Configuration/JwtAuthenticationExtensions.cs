...
public static class JwtAuthenticationExtensions {
  ...
  private static JwtBearerEvents CreateJwtBearerEvents() {
    return new JwtBearerEvents { OnMessageReceived = OnMessageReceived, OnAuthenticationFailed = OnAuthenticationFailed, OnTokenValidated = OnTokenValidated, OnChallenge = OnChallenge };
  }
