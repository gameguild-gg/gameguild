...
/// <summary>
/// Controller for managing user subscriptions with enhanced domain patterns
/// </summary>
[ApiController]
...
public class SubscriptionsController : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<SubscriptionResponse>>> GetUserSubscriptions(
        Guid userId,
        CancellationToken cancellationToken)
    {
    ...
    /// <summary>
    /// Activate a subscription (transition from trial or pending)
    /// </summary>
