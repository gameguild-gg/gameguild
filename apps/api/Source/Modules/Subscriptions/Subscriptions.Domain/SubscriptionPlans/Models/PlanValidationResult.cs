...
public class PlanValidationResult
{
    ...
    /// </summary>
    public static PlanValidationResult Failure(params string[] errors)
    {
        return new PlanValidationResult
        {
            IsValid = false, Errors = errors.ToList()
        };
    }
    ...
    public static PlanValidationResult FailureWithSuggestions(List<string> errors, List<Guid> suggestedUpgrades)
    {
        return new PlanValidationResult
        {
            IsValid = false, Errors = errors, SuggestedUpgrades = suggestedUpgrades
        };
    }
}
