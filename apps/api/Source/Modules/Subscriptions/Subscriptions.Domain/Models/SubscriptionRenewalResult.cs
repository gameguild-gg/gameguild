...
public class SubscriptionRenewalResult
{
    ...
    public static SubscriptionRenewalResult CreateSuccess(Guid subscriptionId, int billingCycleCount, Money chargedAmount)
    {
        ...
        {
            Success = true, SubscriptionId = subscriptionId, BillingCycleCount = billingCycleCount, ChargedAmount = chargedAmount
        };
    }
    ...
    /// </summary>
    public static SubscriptionRenewalResult Failed(Guid subscriptionId, string failureReason)
    {
        return new SubscriptionRenewalResult
        {
            Success = false, SubscriptionId = subscriptionId, FailureReason = failureReason
        };
    }
}
