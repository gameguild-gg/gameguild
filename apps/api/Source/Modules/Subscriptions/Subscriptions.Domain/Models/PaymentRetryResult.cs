...
public class PaymentRetryResult
{
    ...
    {
        get => AttemptsCount >= MaxAttempts;
    }

    /// <summary>
    ///     Creates a successful retry result
    /// </summary>
    public static PaymentRetryResult CreateSuccess(int attemptsCount, PaymentResult paymentResult)
    {
        return new PaymentRetryResult
        {
            Success = true, AttemptsCount = attemptsCount, PaymentResult = paymentResult
        };
    }
    ...
    public static PaymentRetryResult FailedExhausted(int attemptsCount, int maxAttempts, string? errorMessage = null)
    {
        return new PaymentRetryResult
        {
            Success = false, AttemptsCount = attemptsCount, MaxAttempts = maxAttempts, ErrorMessage = errorMessage
        };
    }
}
