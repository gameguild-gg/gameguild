...
public class SubscriptionDowngradeResult
{
    ...
    {
        return new SubscriptionDowngradeResult
        {
            Success = true, UpdatedSubscription = updatedSubscription, EffectiveDate = effectiveDate, CreditIssued = creditIssued
        };
    }
    ...
    /// </summary>
    public static SubscriptionDowngradeResult Failed(string failureReason)
    {
        return new SubscriptionDowngradeResult
        {
