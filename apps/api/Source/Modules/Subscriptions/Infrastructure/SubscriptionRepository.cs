...
public class SubscriptionRepository : ISubscriptionRepository {
    ...
    public async Task AddRangeAsync(IEnumerable<UserSubscription> entities, CancellationToken cancellationToken = default) {
        await _context.UserSubscriptions.AddRangeAsync(entities, cancellationToken);
    }
    ...
    public async Task RestoreAsync(Guid id, CancellationToken cancellationToken = default) {
        var entity = await _context.UserSubscriptions
            .IgnoreQueryFilters() // To include soft deleted items
