...
/// <summary> Extension methods for registering Subscriptions module services </summary>
public static class SubscriptionsModule {
  /// <summary> Registers all Subscriptions module services and repositories </summary>
