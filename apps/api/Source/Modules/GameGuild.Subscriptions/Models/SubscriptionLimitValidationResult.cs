...
public class SubscriptionLimitValidationResult
{
    ...
    /// </summary>
    public static SubscriptionLimitValidationResult Valid(string? message = null) { return new SubscriptionLimitValidationResult { IsWithinLimits = true, Message = message ?? "All limits are within allowed ranges" }; }
