...
public abstract class DACAuthorizationAttribute(PermissionType requiredPermission, Type entityType) : Attribute {
  ...
  /// <summary> The permission type (for resource-level permissions) </summary>
  public virtual Type? PermissionType { get; }

  /// <summary> The parameter name containing the resource ID (for resource-level permissions) </summary>
