...
public class ConditionalPolicyController(IMediator mediator, ILogger<ConditionalPolicyController> logger) : ControllerBase
{
    ...
    public async Task<ActionResult<ConditionalPolicy>> GetConditionalPolicy(Guid policyId)
    {
        ...
        {
            _logger.LogError(ex, "Failed to get conditional policy {PolicyId}", policyId);
    ...
    public async Task<ActionResult<ConditionalPolicy>> UpdateConditionalPolicy(Guid policyId, [FromBody] UpdateConditionalPolicyCommand command)
    {
        ...
        {
            _logger.LogError(ex, "Failed to update conditional policy {PolicyId}", policyId);
    ...
    public async Task<ActionResult> DeleteConditionalPolicy(Guid policyId)
    {
        ...
        {
            _logger.LogError(ex, "Failed to delete conditional policy {PolicyId}", policyId);
    ...
    public async Task<ActionResult> ActivateConditionalPolicy(Guid policyId)
    {
        ...
        {
            _logger.LogError(ex, "Failed to activate conditional policy {PolicyId}", policyId);
    ...
    public async Task<ActionResult> DeactivateConditionalPolicy(Guid policyId)
    {
        ...
        {
            _logger.LogError(ex, "Failed to deactivate conditional policy {PolicyId}", policyId);
    ...
    public async Task<ActionResult<ConditionalPolicy>> CloneConditionalPolicy(Guid policyId, [FromBody] CloneConditionalPolicyCommand command)
    {
        ...
        {
            _logger.LogError(ex, "Failed to clone conditional policy {PolicyId}", policyId);
    ...
    public async Task<ActionResult> UpdateConditionalPolicyPriority(Guid policyId, [FromBody] UpdateConditionalPolicyPriorityCommand command)
    {
        ...
        {
            _logger.LogError(ex, "Failed to update conditional policy priority {PolicyId}", policyId);
    ...
    public async Task<ActionResult<ConditionalPolicyUsageDto>> GetConditionalPolicyUsage(Guid policyId, [FromQuery] DateTime? fromDate = null, [FromQuery] DateTime? toDate = null)
    {
        ...
        {
            _logger.LogError(ex, "Failed to get conditional policy usage for policy {PolicyId}", policyId);
    ...
    public async Task<ActionResult<ConditionalPolicyEvaluationHistoryDto>> GetConditionalPolicyEvaluationHistory(Guid policyId, [FromQuery] int page = 1, [FromQuery] int pageSize = 50)
    {
        ...
        {
            _logger.LogError(ex, "Failed to get conditional policy evaluation history for policy {PolicyId}", policyId);
