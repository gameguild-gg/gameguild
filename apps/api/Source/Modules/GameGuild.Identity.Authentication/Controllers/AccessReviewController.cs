...
// TODO: Reactivate this controller when access review and compliance features are ready for production
/// <summary>
...
public class AccessReviewController(IMediator mediator, ILogger<AccessReviewController> logger) : ControllerBase
{
    ...
    /// </summary>
    [HttpGet("campaigns")]
    public async Task<ActionResult<Models.PagedResult<AccessReviewCampaign>>> GetAccessReviewCampaigns(
    ...
    public async Task<ActionResult<Models.PagedResult<AccessReviewItem>>> GetAccessReviewItems(
        Guid campaignId,
        [FromQuery] string? status = null,
    ...
    public async Task<ActionResult<BulkAccessReviewResult>> BulkReviewAccessItems([FromBody] BulkReviewAccessItemsCommand command)
    {
        ...
        {
            _logger.LogError(ex, "Failed to bulk review {ItemCount} access items", command.ItemIds.Count);
    ...
    /// </summary>
    [HttpGet("periodic")]
    public async Task<ActionResult<Models.PagedResult<PeriodicAccessReview>>> GetPeriodicAccessReviews(
        [FromQuery] Guid? tenantId = null,
    ...
    public async Task<ActionResult<BulkAccessRevocationResult>> BulkRevokeAccess([FromBody] BulkRevokeAccessCommand command)
    {
        ...
        {
            _logger.LogError(ex, "Failed to bulk revoke access for {RevocationCount} revocations", command.Revocations.Count);
    ...
    public async Task<ActionResult<Models.PagedResult<AccessRevocationRecord>>> GetAccessRevocationHistory(
