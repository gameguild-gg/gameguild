...
public sealed class MfaService(ILogger<MfaService> logger, IUserMfaConfigurationRepository mfaConfigRepository, IMfaAttemptRepository mfaAttemptRepository, IEncryptionService encryptionService) : IMfaService
{
    ...
    // ReSharper disable once UnusedMember.Local - Reserved for future lockout implementation
    ...
    /// </summary>
    // ReSharper disable once UnusedMember.Local - Reserved for future internal MFA configuration needs
    ...
    /// </summary>
    private static Task<string> HashBackupCodeAsync(string code, CancellationToken _)
    {
