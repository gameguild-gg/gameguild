...
public class ProcessPaymentCommandValidator : AbstractValidator<ProcessPaymentCommand>
{
    public ProcessPaymentCommandValidator()
    {
        ...
        RuleFor(x => x.PaymentMethodId).NotEmpty().WithMessage("Payment method ID is required").MaximumLength(100).WithMessage("Payment method ID cannot exceed 100 characters");
    }
}
