...
public class FeatureContextFactory
{
    ...
    public static EvaluationContext ToOpenFeatureContext(FeatureContext context)
    {
    ...
    {
        // TODO: Implement based on your multi-tenancy system
        // Example: return httpContext.GetTenantId();
