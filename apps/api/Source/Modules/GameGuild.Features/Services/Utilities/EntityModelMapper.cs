...
using FeatureFlagType = GameGuild.Features.Models.FeatureFlagType;
...
public static class EntityModelMapper
{
    ...
    /// </summary>
    public static FeatureFlagType ToModel(Entities.FeatureFlagType entityType) { return (FeatureFlagType) (int) entityType; }

    /// <summary>
    ///     Converts Model FeatureFlagType to Entity FeatureFlagType
    /// </summary>
    public static Entities.FeatureFlagType ToEntity(FeatureFlagType modelType) { return (Entities.FeatureFlagType) (int) modelType; }
    ...
    public static void UpdateTargetEntity(FeatureFlagTarget target, FeatureFlagTargetingRequest request)
    {
        ...
        target.TargetIdentifier = request.TargetIdentifier;
