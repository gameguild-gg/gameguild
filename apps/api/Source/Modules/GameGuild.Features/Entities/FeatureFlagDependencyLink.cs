...
/// </summary>
public sealed class FeatureFlagDependencyLink : EntityBase
{
    ...
    public FeatureFlag FeatureFlag { get; private set; } = null!;

    public FeatureFlag DependsOnFeatureFlag { get; private set; } = null!;

    public static FeatureFlagDependencyLink Create(
        Guid featureFlagId,
        Guid dependsOnFeatureFlagId,
