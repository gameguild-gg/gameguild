...
namespace GameGuild.Features.Controllers;
    ...
    public async Task<IActionResult> EvaluateFeature([FromBody] FeatureEvaluationRequest request, CancellationToken cancellationToken)
    {
        try
        {
            var context = new FeatureContext
            {
                ...
                Permissions = request.Context.Permissions ?? GetCurrentUserPermissions(),
                CustomAttributes = request.Context.CustomAttributes ?? new Dictionary<string, object>(),
