...
public class UserProfileQueries {
  ...
  /// </summary>
  public async Task<IEnumerable<UserProfile>> GetUserProfiles([Service] GameGuild.CQRS.IMediator mediator, bool includeDeleted = false, int skip = 0, int take = 50, string? searchTerm = null, Guid? tenantId = null) {
  ...
  /// </summary>
  public async Task<UserProfile?> GetUserProfileById([Service] GameGuild.CQRS.IMediator mediator, Guid id, bool includeDeleted = false) {
  ...
  /// </summary>
  public async Task<UserProfile?> GetUserProfileByUserId([Service] GameGuild.CQRS.IMediator mediator, Guid userId, bool includeDeleted = false) {
