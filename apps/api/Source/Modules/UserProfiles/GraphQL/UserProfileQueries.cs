...
/// <summary> GraphQL queries for UserProfile module using CQRS pattern </summary>
[ExtendObjectType<Query>]
public class UserProfileQueries {
  /// <summary> Get all user profiles with optional filtering using CQRS pattern </summary>
  ...
  /// <summary> Get a user profile by ID using CQRS pattern </summary>
  ...
  /// <summary> Get a user profile by user ID using CQRS pattern </summary>
