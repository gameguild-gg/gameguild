...
/// <summary> Handler for restoring user </summary>
public class RestoreUserHandler(ApplicationDbContext context, ILogger<RestoreUserHandler> logger, IMediator mediator) : IRequestHandler<RestoreUserCommand, bool> {
