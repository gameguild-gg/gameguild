...
public class Mutation {
  ...
  /// </summary>
  public async Task<bool> DeleteUser(Guid id, [Service] IUserService userService) { return await userService.DeleteUserAsync(id); }

  /// <summary>
  /// Soft deletes a user (marks as deleted but keeps in database).
  /// </summary>
  public async Task<bool> SoftDeleteUser(Guid id, [Service] IUserService userService) { return await userService.SoftDeleteUserAsync(id); }

  /// <summary>
  /// Restores a soft-deleted user.
  /// </summary>
  public async Task<bool> RestoreUser(Guid id, [Service] IUserService userService) { return await userService.RestoreUserAsync(id); }
}
