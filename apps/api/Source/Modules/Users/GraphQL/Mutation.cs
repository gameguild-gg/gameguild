...
public class UserMutations {
  /// <summary> Creates a new user using CQRS pattern </summary>
  ...
  /// <summary> Updates an existing user using CQRS pattern </summary>
  ...
  /// <summary> Updates user balance using CQRS pattern </summary>
  public async Task<User> UpdateUserBalance(UpdateUserBalanceInput input, [Service] IMediator mediator) {
    var command = new UpdateUserBalanceCommand { UserId = input.UserId, Balance = input.Balance, AvailableBalance = input.AvailableBalance, Reason = input.Reason, ExpectedVersion = input.ExpectedVersion };

    return await mediator.Send(command);
  }

  /// <summary> Deletes a user using CQRS pattern </summary>
  ...
  /// <summary> Restores a soft-deleted user using CQRS pattern </summary>
  ...
  /// <summary> Activates a user using CQRS pattern </summary>
  ...
  /// <summary> Deactivates a user using CQRS pattern </summary>
  ...
  /// <summary> Bulk delete users using CQRS pattern </summary>
  ...
  /// <summary> Bulk restore users using CQRS pattern </summary>
  ...
  /// <summary> Bulk create users using CQRS pattern </summary>
  ...
  /// <summary> Bulk activate users using CQRS pattern </summary>
  ...
  /// <summary> Bulk deactivate users using CQRS pattern </summary>
  ...
  /// <summary> Legacy method - Creates a new user using traditional service pattern (deprecated) </summary>
  ...
  /// <summary> Legacy method - Updates an existing user using traditional service pattern (deprecated) </summary>
  ...
  /// <summary> Legacy method - Hard deletes a user using traditional service pattern (deprecated) </summary>
  ...
  /// <summary> Legacy method - Soft deletes a user using traditional service pattern (deprecated) </summary>
  [Obsolete("Use DeleteUser with GameGuild.CQRS.IMediator instead")]
  ...
  /// <summary> Legacy method - Restores a soft-deleted user using traditional service pattern (deprecated) </summary>
