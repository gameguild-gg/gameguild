...
/// <summary> Input for searching and filtering users </summary>
public class SearchUsersInput {
  /// <summary> Search term to match against user name or email </summary>
  [GraphQLDescription("Search term to match against user name or email")]
  public string? SearchTerm { get; set; }

  /// <summary> Filter by user active status </summary>
  [GraphQLDescription("Filter by user active status")]
  public bool? IsActive { get; set; }

  /// <summary> Minimum balance filter </summary>
  [GraphQLDescription("Minimum balance filter")]
  public decimal? MinBalance { get; set; }

  /// <summary> Maximum balance filter </summary>
  [GraphQLDescription("Maximum balance filter")]
  public decimal? MaxBalance { get; set; }

  /// <summary> Filter users created after this date </summary>
  [GraphQLDescription("Filter users created after this date")]
  public DateTime? CreatedAfter { get; set; }

  /// <summary> Filter users created before this date </summary>
  [GraphQLDescription("Filter users created before this date")]
  public DateTime? CreatedBefore { get; set; }

  /// <summary> Filter users updated after this date </summary>
  [GraphQLDescription("Filter users updated after this date")]
  public DateTime? UpdatedAfter { get; set; }

  /// <summary> Filter users updated before this date </summary>
  [GraphQLDescription("Filter users updated before this date")]
  public DateTime? UpdatedBefore { get; set; }

  /// <summary> Whether to include soft-deleted users in the results </summary>
