...
/// <summary> Input for creating multiple users in a single operation </summary>
public class BulkCreateUsersInput {
  /// <summary> List of users to create </summary>
  [Required]
  ...
  public List<CreateUserInput> Users { get; set; } = new List<CreateUserInput>();

  /// <summary> Optional reason for the bulk operation </summary>
