...
/// <summary> Input for updating a user's balance </summary>
public class UpdateUserBalanceInput {
  /// <summary> The unique identifier of the user whose balance to update </summary>
  [Required]
  [GraphQLNonNullType]
  public Guid UserId { get; set; }

  /// <summary> The new total balance for the user </summary>
  ...
  /// <summary> The new available balance for the user </summary>
  ...
  /// <summary> Optional reason for the balance update </summary>
