...
public class DeactivateUserCommandValidator : AbstractValidator<DeactivateUserCommand>
{
    ...
    public DeactivateUserCommandValidator(ApplicationDbContext context)
    {
        ...
        RuleFor(x => x.UserId).NotEmpty().WithMessage("User ID is required").MustAsync(UserExists).WithMessage("User not found").MustAsync(UserIsActive).WithMessage("User is already deactivated");
    }
