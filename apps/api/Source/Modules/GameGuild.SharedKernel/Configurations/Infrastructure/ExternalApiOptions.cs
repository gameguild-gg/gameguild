...
/// <summary>
///     Configuration options for external API integration.
/// </summary>
public class ExternalApiOptions : BaseOptions
{
    ...
    /// <summary>
    ///     Validates the external API options.
    /// </summary>
    ...
    /// <summary>
    ///     Creates default external API options.
    /// </summary>
    public static ExternalApiOptions CreateDefault() { return new ExternalApiOptions(); }
}
