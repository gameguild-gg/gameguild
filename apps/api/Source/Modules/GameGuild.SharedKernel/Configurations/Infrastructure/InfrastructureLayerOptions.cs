...
/// <summary>
///     Configuration options for the Infrastructure Layer services.
/// </summary>
public class InfrastructureLayerOptions : BaseOptions
{
    /// <summary>
    ///     Enables database services.
    /// </summary>
    ...
    /// <summary>
    ///     Enables message queue services.
    /// </summary>
    ...
    /// <summary>
    ///     Enables external API integration services.
    /// </summary>
    ...
    /// <summary>
    ///     Enables monitoring and logging services.
    /// </summary>
    ...
    /// <summary>
    ///     Validates the infrastructure layer options.
    /// </summary>
    ...
    /// <summary>
    ///     Creates default infrastructure layer options.
    /// </summary>
    public static InfrastructureLayerOptions CreateDefault()
    {
        return new InfrastructureLayerOptions
        {
            ...
            MessageQueue = MessageQueueOptions.CreateDefault(),
            ExternalApis = ExternalApiOptions.CreateDefault(),
            FileStorage = FileStorageOptions.CreateDefault(),
            Monitoring = MonitoringOptions.CreateDefault()
        };
    }
}
