...
public static class CorsOptionsBuilder
{
    ...
    public static CorsOptions Create() { return new CorsOptions { AllowedOrigins = Array.Empty<string>(), AllowedMethods = Array.Empty<string>(), AllowedHeaders = Array.Empty<string>() }; }
