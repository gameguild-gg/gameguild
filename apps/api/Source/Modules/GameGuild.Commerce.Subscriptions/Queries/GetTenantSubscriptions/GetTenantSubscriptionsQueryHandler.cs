...
/// </summary>
public sealed class GetTenantSubscriptionsQueryHandler(ISubscriptionRepository subscriptionRepository) : IQueryHandler<GetTenantSubscriptionsQuery, IEnumerable<Subscription>>
{
