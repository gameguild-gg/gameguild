...
public class KycService : IKycService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (Exception ex)
        {
            ...
            return Result<UserKycVerification>.Failure($"Failed to submit KYC verification: {ex.Message}");
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            {
                return Result<UserKycVerification>.Failure("Verification not found");
            }
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (verification == null)
            {
                return Result<string>.Failure("Verification not found");
            }
