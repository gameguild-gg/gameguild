...
public class FeatureFlagConfiguration : IEntityTypeConfiguration<FeatureFlag>
{
    public void Configure(EntityTypeBuilder<FeatureFlag> builder)
    {
        ...
        builder.Property(e => e.EnabledValue)
            .HasMaxLength(1000);
        ...
        builder.HasMany(e => e.UsageAnalytics)
        ...
        builder.HasIndex(e => e.IsGlobal)
            .HasDatabaseName("IX_FeatureFlags_IsGlobal");
    }
}
...
public class FeatureFlagTargetConfiguration : IEntityTypeConfiguration<FeatureFlagTarget>
{
    public void Configure(EntityTypeBuilder<FeatureFlagTarget> builder)
    {
        ...
        builder.Property(e => e.FeatureFlagId)
            .IsRequired();
        ...
        builder.Property(e => e.TargetIdentifier)
            .IsRequired()
            .HasMaxLength(255);
        ...
        builder.HasIndex(e => new { e.FeatureFlagId, e.TargetType, e.TargetIdentifier })
            .HasDatabaseName("IX_FeatureFlagTargets_FeatureFlagId_TargetType_TargetIdentifier");

        builder.HasIndex(e => e.TargetType)
            .HasDatabaseName("IX_FeatureFlagTargets_TargetType");
    }
}
...
public class FeatureFlagUsageConfiguration : IEntityTypeConfiguration<FeatureFlagUsage>
{
    public void Configure(EntityTypeBuilder<FeatureFlagUsage> builder)
    {
        ...
        builder.Property(e => e.ReturnedValue)
            .HasMaxLength(1000);
        ...
        builder.HasIndex(e => e.FeatureFlagId)
            .HasDatabaseName("IX_FeatureFlagUsage_FeatureFlagId");

        builder.HasIndex(e => e.UserId)
            .HasDatabaseName("IX_FeatureFlagUsage_UserId");

        builder.HasIndex(e => e.TenantId)
            .HasDatabaseName("IX_FeatureFlagUsage_TenantId");

        builder.HasIndex(e => e.CreatedAt)
            .HasDatabaseName("IX_FeatureFlagUsage_CreatedAt");

        builder.HasIndex(e => new { e.FeatureFlagId, e.CreatedAt })
            .HasDatabaseName("IX_FeatureFlagUsage_FeatureFlagId_CreatedAt");

        builder.HasIndex(e => e.WasEnabled)
            .HasDatabaseName("IX_FeatureFlagUsage_WasEnabled");
    }
}
