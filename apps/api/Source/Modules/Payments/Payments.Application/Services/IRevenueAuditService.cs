...
/// <summary>Service for managing revenue events and financial ledger</summary>
public interface IRevenueAuditService
{
    ...
    Task<List<RevenueEvent>> GetRevenueEventsByDateRangeAsync(
        DateTime startDate,
        DateTime endDate,
        int skip = 0,
        int take = 100,
    ...
    Task<List<FinancialLedgerEntry>> GetLedgerEntriesByAccountAsync(
        string account,
        int skip = 0,
        int take = 100,
        CancellationToken cancellationToken = default);
    ...
    Task<List<FinancialLedgerEntry>> GetUnreconciledEntriesAsync(
        int skip = 0,
        int take = 100,
        CancellationToken cancellationToken = default);
    ...
    Task<AuditTrail> RecordAuditTrailAsync(
        string entityType,
        Guid entityId,
        AuditAction action,
        Guid changedBy,
    ...
    Task<List<AuditTrail>> GetAuditTrailByEntityAsync(
        string entityType,
        Guid entityId,
        int skip = 0,
        int take = 100,
