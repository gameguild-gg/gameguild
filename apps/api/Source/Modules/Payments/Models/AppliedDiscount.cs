...
/// <summary>
/// Represents a discount that has been applied to a payment
/// </summary>
public class AppliedDiscount
{
    /// <summary>
    /// Unique identifier for this discount application
    /// </summary>
    public Guid Id { get; init; } = Guid.NewGuid();

    /// <summary>
    /// Discount code or identifier
    /// </summary>
    ...
    /// <summary>
    /// Minimum purchase amount for discount to apply
    /// </summary>
    ...
    /// <summary>
    /// Whether this discount was automatically applied
    /// </summary>
    public bool AutoApplied { get; init; }

    /// <summary>
    /// Source of the discount (coupon, loyalty program, etc.)
    /// </summary>
    ...
    /// </summary>
    public static AppliedDiscount Percentage(
        string code,
        string name,
        decimal percentage,
