...
/// <summary> DataLoader interface for efficiently loading User entities for Payments </summary>
public interface IPaymentUserDataLoader : IDataLoader<Guid, User?> { }

/// <summary> DataLoader implementation for efficiently loading User entities for Payments </summary>
public class PaymentUserDataLoader : BatchDataLoader<Guid, User?>, IPaymentUserDataLoader {
  private readonly IServiceProvider _serviceProvider;

  public PaymentUserDataLoader(IBatchScheduler batchScheduler, IServiceProvider serviceProvider, DataLoaderOptions? options = null) : base(batchScheduler, options ?? new DataLoaderOptions()) { _serviceProvider = serviceProvider; }
