...
namespace GameGuild.Tests.Modules.Fixtures
{
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(options =>
                {
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_testSecret)),
    ...
    public class TestUserService : IUserService
    {
        ...
        public TestUserService(TestDbContext dbContext)
        {
    ...
    public class TestUserProfileService : IUserProfileService
    {
        ...
        public TestUserProfileService(TestDbContext dbContext)
        {
            _dbContext = dbContext;
        }
