    ...
    public static WebApplicationFactory<Program> GetTestFactory(string? databaseName = null) {
      ...
      var factory = new WebApplicationFactory<Program>().WithWebHostBuilder(builder => {
          ...
          builder.ConfigureServices(services => {
              ...
              // Remove the JWT authentication filter since it's causing issues with tests
              ...
              // Register a mock tenant context service for tests
              services
                .AddSingleton<ITenantContextService, MockTenantContextService>();

              // Add controllers with a test filter that bypasses authentication
