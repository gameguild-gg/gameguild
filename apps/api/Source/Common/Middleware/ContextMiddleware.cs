...
public class ContextMiddleware {
  ...
  public async Task InvokeAsync(
    ...
    try {
      ...
      if (userContext.IsAuthenticated) {
        ...
        _logger.LogDebug(
          "Permissions context: IsSystemAdmin={IsSystemAdmin}, IsTenantAdmin={IsTenantAdmin}",
          permissionsContext.IsSystemAdmin,
          permissionsContext.IsTenantAdmin
        );
        ...
        _logger.LogDebug(
          "Localization context: Culture={Culture}, TimeZone={TimeZone}",
          localizationContext.CurrentCulture.Name,
          localizationContext.TimeZoneId
        );
  ...
  /// <summary>
  /// Validates the consistency and state of all context services
  /// </summary>
...
public static class ContextMiddlewareExtensions {
  ...
  public static IServiceCollection AddContextServices(this IServiceCollection services) {
    ...
    // Context services are now registered in ServiceCollectionExtensions.AddContextServices()
