...
public static class CaseTransformExtensions
{
    ...
    public static string ToKebabCase(this string input, CaseTransformOptions? options = null)
    {
        return CaseTransformerFactory.Kebab.Transform(input, options ?? CaseTransformOptions.Default);
    }
    ...
    public static string ToSnakeCase(this string input, CaseTransformOptions? options = null)
    {
        return CaseTransformerFactory.Snake.Transform(input, options ?? CaseTransformOptions.Default);
    }
    ...
    public static string ToSlugCase(this string input, CaseTransformOptions? options = null)
    {
        return CaseTransformerFactory.Slug.Transform(input, options ?? CaseTransformOptions.Default);
    }
    ...
    public static string ToCase(this string input, CaseType caseType, CaseTransformOptions? options = null)
    {
        return CaseTransformerFactory.Transform(input, caseType, options);
    }
    ...
    public static bool IsValidCase(this string input, CaseType caseType)
    {
        return CaseTransformerFactory.IsValidFormat(input, caseType);
    }
    ...
    {
        return CaseTransformerFactory.Kebab.IsValidFormat(input);
    }
    ...
    {
        return CaseTransformerFactory.Snake.IsValidFormat(input);
    }
    ...
    public static bool IsSlugCase(this string input)
    {
        return CaseTransformerFactory.Slug.IsValidFormat(input);
    }
    ...
    public static string ToKebabCase(this Type type, CaseTransformOptions? options = null)
    {
        return CaseTransformerFactory.Kebab.TransformType(type, options ?? CaseTransformOptions.Default);
    }
    ...
    public static string ToSnakeCase(this Type type, CaseTransformOptions? options = null)
    {
        return CaseTransformerFactory.Snake.TransformType(type, options ?? CaseTransformOptions.Default);
    }
    ...
    public static string ToSlugCase(this Type type, CaseTransformOptions? options = null)
    {
        return CaseTransformerFactory.Slug.TransformType(type, options ?? CaseTransformOptions.Default);
    }
}
