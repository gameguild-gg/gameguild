...
// using GameGuild.Abstractions.Infrastructure;
// using GameGuild.Common.Extensions;
// using GameGuild.Common.Infrastructure;
// using MediatR;
// using DomainEventProcessorService = GameGuild.Abstractions.Infrastructure.DomainEventProcessorService;
// using DomainEventPublisher = GameGuild.Abstractions.Infrastructure.DomainEventPublisher;
// using GlobalExceptionHandler = GameGuild.Abstractions.Infrastructure.GlobalExceptionHandler;
...
//         c.SwaggerDoc("v1", new() { Title = "GameGuild API", Version = "v1", Description = "A comprehensive API for GameGuild platform with CQRS architecture" });
//
...
//                                 .ToArray();
//
//     foreach (var endpointType in endpointTypes) { services.AddScoped(typeof(IEndpoint), endpointType); }
//
//     return services;
//   }
//
...
//     services.AddTransient(typeof(IPipelineBehavior<,>), typeof(GameGuild.Common.Behaviors.LoggingBehavior<,>));
