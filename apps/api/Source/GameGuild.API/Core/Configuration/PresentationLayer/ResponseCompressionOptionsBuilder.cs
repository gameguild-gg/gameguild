...
public static class ResponseCompressionOptionsBuilder
{
    ...
    public static ResponseCompressionOptions Create() { return new ResponseCompressionOptions { MimeTypes = new[ ] { "application/json", "text/plain" }, EnableCompression = true }; }
