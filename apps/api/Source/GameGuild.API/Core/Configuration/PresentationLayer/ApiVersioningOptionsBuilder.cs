...
using SharedApiVersioningOptions = GameGuild.SharedKernel.Configuration.ApiVersioningOptions;
...
public static class ApiVersioningOptionsBuilder
{
    ...
    internal static IApiVersionReader CreateReader(ApiVersionReadingStrategy strategy, SharedApiVersioningOptions options)
    {
