...
namespace GameGuild.API.Database.Migrations
{
    ...
    [Migration("20260210113401_AddContentPagesModule")]
    partial class AddContentPagesModule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameGuild.Identity.Tenants.TenantAuditLog", b =>
                {
                    ...
                    b.Property<Dictionary<string, object>>("AfterValues")
                        .HasColumnType("jsonb");

                    b.Property<Dictionary<string, object>>("BeforeValues")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("GameGuild.Identity.Users.UserMetadata", b =>
                {
                    ...
                    b.HasOne("GameGuild.Identity.Users.User", null)
                        .WithOne("Metadata")
                        .HasForeignKey("GameGuild.Identity.Users.UserMetadata", "UserId1");
            ...
            modelBuilder.Entity("GameGuild.Identity.Users.UserPreferences", b =>
                {
                    ...
                    b.HasOne("GameGuild.Identity.Users.User", null)
                        .WithOne("Preferences")
                        .HasForeignKey("GameGuild.Identity.Users.UserPreferences", "UserId1");
