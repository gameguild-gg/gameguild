...
namespace GameGuild.API.Database.Migrations
{
    ...
    partial class AddAssignmentDeliveryAndGradingContracts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameGuild.Learning.Assessments.AssessmentSubmission", b =>
                {
                    ...
                    b.ToTable("AssessmentSubmissions", null, t =>
                        {
                            t.HasCheckConstraint("CK_AssessmentSubmissions_PayloadConsistency", "((\"SubmittedModalities\" & 1) = 0 OR \"TextPayload\" IS NOT NULL) AND ((\"SubmittedModalities\" & 2) = 0 OR \"FilePayload\" IS NOT NULL) AND ((\"SubmittedModalities\" & 4) = 0 OR \"UrlPayload\" IS NOT NULL) AND ((\"SubmittedModalities\" & 8) = 0 OR \"CodePayload\" IS NOT NULL) AND ((\"SubmittedModalities\" & 16) = 0 OR \"MediaPayload\" IS NOT NULL) AND ((\"SubmittedModalities\" & 32) = 0 OR \"ProjectPayload\" IS NOT NULL) AND ((\"SubmittedModalities\" & 64) = 0 OR \"StructuredAnswerPayload\" IS NOT NULL)");
