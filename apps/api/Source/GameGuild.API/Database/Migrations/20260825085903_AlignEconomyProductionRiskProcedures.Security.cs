...
public partial class AlignEconomyProductionRiskProcedures
{
        ...
        bool tenantScoped)
    {
        ...
        oldColumns = NormalizePostgreSqlFunctionFragment(oldColumns);
        newColumns = NormalizePostgreSqlFunctionFragment(newColumns);
        oldValues = NormalizePostgreSqlFunctionFragment(oldValues);
        newValues = NormalizePostgreSqlFunctionFragment(newValues);
        oldLookup = NormalizePostgreSqlFunctionFragment(oldLookup);
        newLookup = NormalizePostgreSqlFunctionFragment(newLookup);
    ...
    private static string NormalizePostgreSqlFunctionFragment(string fragment) =>
        fragment.ReplaceLineEndings("\n");
