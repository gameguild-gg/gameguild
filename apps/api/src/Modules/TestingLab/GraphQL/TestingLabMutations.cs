...
public class TestingLabMutations
{
        ...
        UpdateTestingRequestDto input)
    {
        ...
        {
            throw new ArgumentException($"Testing request with ID {id} not found");
        }
    ...
    /// </summary>
    public async Task<bool> DeleteTestingRequest(
        [Service] ITestService testService,
        Guid id)
    {
        return await testService.DeleteTestingRequestAsync(id);
    }
        ...
        CreateTestingSessionDto input)
    {
        ...
        {
            throw new ArgumentException($"Testing session with ID {id} not found");
        }
    ...
    /// </summary>
    public async Task<bool> DeleteTestingSession(
        [Service] ITestService testService,
        Guid id)
    {
        return await testService.DeleteTestingSessionAsync(id);
    }
}
