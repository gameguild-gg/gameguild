...
public class TestingRequestType : ObjectType<TestingRequest>
{
    protected override void Configure(IObjectTypeDescriptor<TestingRequest> descriptor)
    {
        ...
        descriptor
            .Field(p => p.UpdatedAt)
            .Type<DateTimeType>()
            .Description("When the testing request was last updated.");

        // Core Properties
        descriptor
            .Field(p => p.ProjectVersionId)
            .Type<NonNullType<UuidType>>()
        ...
        descriptor
            ...
            .Description("The title of the testing request.");
        ...
        descriptor
            .Field(p => p.InstructionsType)
            .Type<NonNullType<EnumType<InstructionType>>>()
            .Description("Type of instructions provided (Text, Video, etc.)");

        descriptor
            .Field(p => p.InstructionsContent)
            .Type<StringType>()
            .Description("Text instructions for testing.");

        descriptor
            .Field(p => p.InstructionsUrl)
            .Type<StringType>()
            .Description("URL to external instructions.");

        descriptor
            .Field(p => p.InstructionsFileId)
            .Type<UuidType>()
            .Description("File ID for instruction documents.");

        descriptor
            .Field(p => p.MaxTesters)
            .Type<IntType>()
            .Description("Maximum number of testers allowed.");

        descriptor
            .Field(p => p.CurrentTesterCount)
        ...
        descriptor
            .Field(p => p.StartDate)
            .Type<NonNullType<DateTimeType>>()
            .Description("When testing should start.");

        descriptor
            .Field(p => p.EndDate)
            .Type<NonNullType<DateTimeType>>()
            .Description("When testing should end.");
...
public class TestingSessionType : ObjectType<TestingSession>
{
    protected override void Configure(IObjectTypeDescriptor<TestingSession> descriptor)
    {
        ...
        descriptor
            ...
            .Type<UuidType>()
            .Description("The location where testing will take place.");

        descriptor
            .Field(p => p.SessionName)
            .Type<NonNullType<StringType>>()
            .Description("Name of the testing session.");

        descriptor
            .Field(p => p.SessionDate)
            .Type<NonNullType<DateTimeType>>()
            .Description("Date of the testing session.");
        ...
        descriptor
            .Field(p => p.MaxTesters)
            .Type<IntType>()
            .Description("Maximum testers for this session.");
        ...
        descriptor
            .Field(p => p.ManagerUserId)
            .Type<UuidType>()
            .Description("User managing this session.");
...
public class TestingParticipantType : ObjectType<TestingParticipant>
{
    protected override void Configure(IObjectTypeDescriptor<TestingParticipant> descriptor)
    {
        ...
        descriptor
            .Field(p => p.InstructionsAcknowledged)
            .Type<NonNullType<BooleanType>>()
            .Description("Whether the participant has acknowledged instructions.");

        descriptor
            .Field(p => p.InstructionsAcknowledgedAt)
            .Type<DateTimeType>()
        ...
        descriptor
            ...
            .Type<DateTimeType>()
            .Description("When the participant completed testing.");
    }
}
...
public class TestingLocationType : ObjectType<TestingLocation>
{
    protected override void Configure(IObjectTypeDescriptor<TestingLocation> descriptor)
    {
        ...
        descriptor
            .Field(p => p.Name)
            .Type<NonNullType<StringType>>()
            .Description("Name of the testing location.");

        descriptor
            .Field(p => p.MaxTestersCapacity)
            .Type<IntType>()
            .Description("Maximum number of testers this location can accommodate.");

        descriptor
            .Field(p => p.MaxProjectsCapacity)
            .Type<IntType>()
