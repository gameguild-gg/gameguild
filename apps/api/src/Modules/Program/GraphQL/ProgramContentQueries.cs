...
public class ProgramContentQueries
{
    ...
    public async Task<IEnumerable<ProgramContentEntity>> GetContentByType(
        Guid programId,
        GameGuild.Common.Enums.ProgramContentType contentType,
        [Service] IProgramContentService programContentService)
    {
    ...
    /// </summary>
    [RequireResourcePermission<ProgramPermission, GameGuild.Modules.Program.Models.Program>(PermissionType.Read, "programId")]
    public async Task<int> GetContentCount(
        Guid programId,
        [Service] IProgramContentService programContentService)
    {
        return await programContentService.GetContentCountAsync(programId);
    }
    ...
    /// </summary>
    [RequireResourcePermission<ProgramPermission, GameGuild.Modules.Program.Models.Program>(PermissionType.Read, "programId")]
    public async Task<int> GetRequiredContentCount(
        Guid programId,
        [Service] IProgramContentService programContentService)
    {
        return await programContentService.GetRequiredContentCountAsync(programId);
    }
}
