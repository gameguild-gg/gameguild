...
public class ProgramContentType : ObjectType<ProgramContentEntity>
{
    protected override void Configure(IObjectTypeDescriptor<ProgramContentEntity> descriptor)
    {
        ...
        descriptor
            ...
            .Description("The title of the program content.");
        ...
        descriptor
            .Field(p => p.Body)
            .Type<StringType>()
            .Description("The main content body (JSON format).");
...
public class ProgramContentResolvers
{
        ...
        [Service] Data.ApplicationDbContext context)
    {
        return await context.Programs
            .FirstOrDefaultAsync(p => p.Id == content.ProgramId);
    }
        ...
        [Service] Data.ApplicationDbContext context)
    {
        ...
        return await context.ProgramContents
            .FirstOrDefaultAsync(pc => pc.Id == content.ParentId.Value);
    }
    ...
    {
        return await context.ProgramContents
            .Where(pc => pc.ParentId == content.Id)
