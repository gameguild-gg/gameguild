...
/// <summary> Base class for cached case transformers providing common caching functionality. </summary>
public abstract class CachedCaseTransformer : ICaseTransformer
{
    ...
    /// <summary> Gets or creates the shared memory cache instance. </summary>
    ...
    /// <summary> Gets the cache key prefix for this transformer type. </summary>
    protected abstract string CacheKeyPrefix { get; }

    /// <summary> Transforms a string according to the specific case strategy. </summary>
    /// <param name="input"> The input string to transform. </param>
    /// <returns> The transformed string. </returns>
    public string Transform(string input) { return Transform(input, CaseTransformOptions.Default); }

    /// <summary> Transforms a string with additional options. </summary>
    /// <param name="input"> The input string to transform. </param>
    ...
    /// <summary> Validates if a string is already in the correct format for this case strategy. </summary>
    ...
    /// <summary> Performs the actual transformation logic without caching. </summary>
    /// <param name="input"> The input string to transform. </param>
    ...
    /// <summary> Transforms multiple strings using the same options. </summary>
    ...
    /// <summary> Transforms a type name. </summary>
    ...
    /// <summary> Generates a cache key for the given input and options. </summary>
    /// <param name="input"> The input string. </param>
    /// <param name="options"> The transformation options. </param>
    /// <returns> A unique cache key. </returns>
    protected virtual string GenerateCacheKey(string input, CaseTransformOptions options)
    {
        return $"{CacheKeyPrefix}:{input}:{options.MaxLength}:{options.CustomSeparator}:{options.ForceLowerCase}:{options.TrimWhitespace}";
    }
    ...
    /// <summary> Disposes the shared cache. </summary>
