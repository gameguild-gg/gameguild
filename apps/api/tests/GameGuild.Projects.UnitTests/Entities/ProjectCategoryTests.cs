...
public class ProjectCategoryTests
{
    ...
    [Fact]
    public void ProjectCategory_Should_Support_Optional_Description()
    {
        // Arrange
        var description = "Category for game development projects";
        
        // Act
        var category = _testDataBuilder.CreateProjectCategory();
    ...
    [Fact]
    public void ProjectCategory_Should_Allow_Null_Description()
    {
        // Arrange & Act
        var category = new ProjectCategory
        {
