...
public class ProjectCollaboratorTests
{
    ...
    public void ProjectCollaborator_Creation_Should_Set_Default_Values()
    {
        ...
        collaborator.IsActive.Should().BeFalse();
    ...
    [Fact]
    public void ProjectCollaborator_Should_Support_Optional_Fields()
    {
        // Arrange & Act
        var collaborator = new ProjectCollaborator
        {
            ...
            Description = "Responsible for core game mechanics",
            Visibility = AccessLevel.Public,
            IsActive = true
        };

        // Assert
        collaborator.Title.Should().Be("Lead Developer");
        collaborator.Description.Should().Be("Responsible for core game mechanics");
        collaborator.Visibility.Should().Be(AccessLevel.Public);
    }
    ...
    public void ProjectCollaborator_Should_Allow_Null_Optional_Fields()
    {
        ...
        // Assert
        collaborator.Title.Should().BeNull();
        collaborator.Description.Should().BeNull();
        collaborator.Visibility.Should().BeNull();
    }
