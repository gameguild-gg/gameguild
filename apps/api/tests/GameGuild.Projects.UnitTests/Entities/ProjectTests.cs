...
public class ProjectTests
{
    ...
    public void Project_Creation_Should_Set_Default_Values()
    {
        ...
        project.Visibility.Should().Be(AccessLevel.Public);
    ...
    [InlineData(DevelopmentStatus.Maintenance)]
    [InlineData(DevelopmentStatus.Discontinued)]
    ...
    public void Project_Should_Support_All_Visibility_Levels(AccessLevel visibility)
    {
        // Arrange
        var project = _testDataBuilder.CreateProject();
