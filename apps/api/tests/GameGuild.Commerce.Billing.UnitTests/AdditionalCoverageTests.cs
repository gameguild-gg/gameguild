...
public class StripeBillingWebhookServiceAdditionalTests
{
    ...
    public async Task ProcessStripeWebhook_SubscriptionCreated_Should_Route_To_Lifecycle()
    {
        ...
        var result = await service.ProcessStripeWebhookAsync("evt_create", "customer.subscription.created", payload, "sig");
    ...
    public async Task ProcessStripeWebhook_Error_Should_MarkFailed_And_Return_Error()
    {
        ...
        var result = await service.ProcessStripeWebhookAsync("evt_err", "customer.subscription.updated", payload, "sig");
    ...
    public async Task ProcessStripeWebhook_WithMetadata_Should_ParseTenantAndPlan()
    {
        ...
        var result = await service.ProcessStripeWebhookAsync("evt_meta", "customer.subscription.created", payload, "sig");
    ...
    public async Task ProcessStripeWebhook_InvoiceWithAmountDue_Should_Parse()
    {
        ...
        var result = await service.ProcessStripeWebhookAsync("evt_amt", "invoice.payment_succeeded", payload, "sig");
    ...
    public async Task ProcessStripeWebhook_WithPriceAndProduct_Should_Parse()
    {
        ...
        var result = await service.ProcessStripeWebhookAsync("evt_price", "customer.subscription.created", payload, "sig");
    ...
    public async Task ProcessStripeWebhook_InvalidJson_Should_Handle_Gracefully()
    {
        ...
        var result = await service.ProcessStripeWebhookAsync("evt_bad", "unknown.event", "not json", "sig");
        result.Processed.Should().BeTrue(); // unhandled event type just logs
    }
}
...
public class StripeBillingWebhookServiceAdditionalTests2
{
    ...
    public async Task ProcessStripeWebhookAsync_WithDataObjectId_Should_Parse_SubscriptionId()
    {
        ...
        var result = await stripeService.ProcessStripeWebhookAsync("evt_rich", "invoice.created", json, "sig", CancellationToken.None);
