...
public class UpgradeSubscriptionPlanCommandTests
{
    [Fact]
    public void Command_ShouldHaveCorrectProperties_WithAllParameters()
    {
        ...
        var command = new UpgradeSubscriptionPlanCommand(subscriptionId, newPlanId, effectiveDate);
    ...
    public void Command_ShouldHaveDefaultNullEffectiveDate()
    {
        ...
        var subscriptionId = Guid.NewGuid();
        var newPlanId = Guid.NewGuid();
        var command = new UpgradeSubscriptionPlanCommand(subscriptionId, newPlanId);
    ...
    public void Command_ShouldSupportRecordEquality()
    {
        ...
        var command1 = new UpgradeSubscriptionPlanCommand(subscriptionId, newPlanId, effectiveDate);
        var command2 = new UpgradeSubscriptionPlanCommand(subscriptionId, newPlanId, effectiveDate);
    ...
    public void Command_ShouldNotBeEqualWithDifferentNewPlanIds()
    {
        // Arrange
        var subscriptionId = Guid.NewGuid();
        var command1 = new UpgradeSubscriptionPlanCommand(subscriptionId, Guid.NewGuid());
        var command2 = new UpgradeSubscriptionPlanCommand(subscriptionId, Guid.NewGuid());
