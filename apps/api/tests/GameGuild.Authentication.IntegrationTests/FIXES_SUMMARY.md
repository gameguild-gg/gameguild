# GameGuild.Authentication.IntegrationTests - Fix Summary
...
Location: `Tests/GameGuild.Authentication.IntegrationTests/TestHelpers/TestEntityFactory.cs`
...
- `Web3ChallengeRequest` exists in two places:
  - `GameGuild.Authentication.DTOs.Web3ChallengeRequest` (concrete)
  - `GameGuild.Authentication.Models.Requests.Web3ChallengeRequest` (abstract)
