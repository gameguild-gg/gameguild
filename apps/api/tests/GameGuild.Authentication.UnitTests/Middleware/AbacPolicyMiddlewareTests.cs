...
/// <summary>
/// Unit tests for the AbacPolicyMiddleware
/// </summary>
public class AbacPolicyMiddlewareTests
{
    private readonly Mock<RequestDelegate> _mockNext;
    private readonly Mock<ILogger<AbacPolicyMiddleware>> _mockLogger;
    private readonly AbacPolicyMiddleware _middleware;
    private readonly DefaultHttpContext _httpContext;

    public AbacPolicyMiddlewareTests()
    {
        _mockNext = new Mock<RequestDelegate>();
        _mockLogger = new Mock<ILogger<AbacPolicyMiddleware>>();
        _middleware = new AbacPolicyMiddleware(_mockNext.Object, _mockLogger.Object);
        _httpContext = new DefaultHttpContext();
    }

    [Fact]
    public async Task InvokeAsync_Should_Add_ABAC_Policy_Header()
    {
        // Arrange
        ...
        // Assert
        _httpContext.Response.Headers.Should().ContainKey("X-ABAC-Policies");
    ...
    public async Task InvokeAsync_Should_Add_Header_Before_Calling_Next()
    {
        ...
        _mockNext.Setup(x => x(It.IsAny<HttpContext>()))
            ...
            {
                headerAddedBeforeNext = ctx.Response.Headers.ContainsKey("X-ABAC-Policies");
            })
            .Returns(Task.CompletedTask);
    ...
    {
        // Act
        var middleware = new AbacPolicyMiddleware(_mockNext.Object, _mockLogger.Object);
