...
/// <summary>
/// Unit tests for the LocalizationContext service
/// </summary>
public class LocalizationContextTests
{
    private readonly Mock<ITenantContext> _mockTenantContext;
    private readonly Mock<ILogger<LocalizationContext>> _mockLogger;
    private readonly LocalizationContext _localizationContext;

    public LocalizationContextTests()
    {
        _mockTenantContext = new Mock<ITenantContext>();
        _mockLogger = new Mock<ILogger<LocalizationContext>>();
        _localizationContext = new LocalizationContext(_mockTenantContext.Object, _mockLogger.Object);
    }
    ...
    {
        // Act
        var context = new LocalizationContext(_mockTenantContext.Object, _mockLogger.Object);
    ...
    [Fact]
    public void Should_Accept_Dependencies_Through_Constructor()
    {
        // Arrange
        var tenantContext = new Mock<ITenantContext>();
        var logger = new Mock<ILogger<LocalizationContext>>();

        // Act
        var context = new LocalizationContext(tenantContext.Object, logger.Object);
