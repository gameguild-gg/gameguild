...
public class NotificationServiceTests
{
    ...
    public async Task Crud_Methods_Should_Delegate_To_Delivery_Service()
    {
        ...
        delivery.Setup(x => x.SendAsync(recipientId, NotificationType.System, "Title", "Message", NotificationChannel.Email, null, "https://example.test", NotificationPriority.High, null, null, null, null, It.IsAny<CancellationToken>())).ReturnsAsync(Result.Success(notification));
