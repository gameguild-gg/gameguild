...
public class BulkUnsuspendUsersCommandValidatorTests
{
    private readonly BulkUnsuspendUsersCommandValidator _validator = new();
    ...
    {
        // Arrange
        var command = new BulkUnsuspendUsersCommand(new List<Guid>());
