...
public class BulkArchiveNotificationsCommandHandlerTests
{
    private readonly Mock<IUserNotificationRepository> _notificationRepositoryMock;
    private readonly BulkArchiveNotificationsCommandHandler _handler;

    public BulkArchiveNotificationsCommandHandlerTests()
    {
        _notificationRepositoryMock = new Mock<IUserNotificationRepository>();
        _handler = new BulkArchiveNotificationsCommandHandler(_notificationRepositoryMock.Object);
    }

    [Fact]
    public async Task Handle_WithNotificationIds_ShouldArchiveAllNotifications()
    {
        // Arrange
        ...
        notifications.Should().OnlyContain(notification => notification.ArchivedAt.HasValue);
    ...
    {
        // Arrange
        var command = new BulkArchiveNotificationsCommand(Guid.NewGuid(), new List<Guid>());
