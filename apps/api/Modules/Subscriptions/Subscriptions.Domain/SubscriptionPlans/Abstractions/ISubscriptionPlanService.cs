...
public interface ISubscriptionPlanService
{
    ...
    /// </summary>
    Task<SubscriptionPlan> CreateAsync(
        string name,
        string slug,
    ...
    /// </summary>
    Task<SubscriptionPlan> UpdatePricingAsync(
        Guid planId,
        long monthlyPriceInCents,
    ...
    ///     Updates plan limits
    /// </summary>
    Task<SubscriptionPlan> UpdateLimitsAsync(
        Guid planId,
        int? maxUsers = null,
    ...
    /// </summary>
    Task<IEnumerable<SubscriptionPlan>> GetByPriceRangeAsync(
    ...
    /// </summary>
    Task<PlanValidationResult> ValidatePlanLimitsAsync(
        Guid planId,
        int userCount,
        long storageMb,
    ...
    /// </summary>
    Task<IEnumerable<SubscriptionPlan>> SuggestUpgradesAsync(
        Guid currentPlanId,
