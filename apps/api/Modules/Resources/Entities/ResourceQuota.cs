...
public class ResourceQuota : EntityBase
{
    ...
    /// </summary>
    public bool IsSoftLimitExceeded() { return CurrentUsage >= SoftLimit; }

    /// <summary>
    ///     Check if hard limit is exceeded
    /// </summary>
    public bool IsHardLimitExceeded() { return CurrentUsage >= HardLimit; }
    ...
    public bool ShouldReset()
    {
        ...
        double daysSinceReset = (now - LastReset.Value).TotalDays;
