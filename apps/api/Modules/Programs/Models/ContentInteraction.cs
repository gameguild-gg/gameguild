...
public class ContentInteraction : EntityBase {
  ...
  /// <summary> User's submission or response to the content Structure varies by content type: - Assignment: {files: [], text: "", submittedAt: ""} - Code: {code: "", language: "", testResults: []} - Discussion: {posts: [], lastParticipated: ""} </summary>
  [Column(TypeName = "jsonb")]
  public string? SubmissionData { get; set; }

  /// <summary> Completion percentage for this specific content (0-100) </summary>
  [Column(TypeName = "decimal(5,2)")]
  public decimal CompletionPercentage { get; set; }

  /// <summary> Time spent on this content in minutes </summary>
  public int? TimeSpentMinutes { get; set; }

  /// <summary> Date when user first accessed this content </summary>
  public DateTime? FirstAccessedAt { get; set; }

  /// <summary> Date when user last accessed this content </summary>
  public DateTime? LastAccessedAt { get; set; }

  /// <summary> Date when user completed this content </summary>
  public DateTime? CompletedAt { get; set; }

  /// <summary> Date when user submitted their work (for gradeable content) </summary>
