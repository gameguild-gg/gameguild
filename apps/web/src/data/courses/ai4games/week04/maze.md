...
![maze_image](https://console-minio.gameguild.gg/api/v1/buckets/gameguild/objects/download?prefix=ai4games%2Fmaze.png)

<iframe width="560" height="315" src="https://www.youtube.com/embed/sVcB8vUFlmU?si=jsNfMuN4V_u7jZ0h" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
![Maze generation](https://console-minio.gameguild.gg/api/v1/buckets/gameguild/objects/download?prefix=ai4games%2Fmaze.gif)

:::

## Random Number Generation

In order to be consistent with all languages, pass the automated tests, the random function used in the algorithm should follow the following sequence of 100 numbers:

``` c++
uint8_t randomNumbers[100] = {
...
Read the [Data Structure](./maze-datastructure) page to understand how the maze could be represented in memory.
