...
This is an open-ended research time. It would be best if you explored the mainstream and some exotic tools. Your job is to categorize and organize them in a way you will be able to explain them to others. 

You don't need to go deep like this https://docs.google.com/spreadsheets/d/1z1RV6w4HjPODFcao34h72Vw-9KxtQ9rv0ZM7folTUMU/edit?gid=434592433#gid=434592433Links to an external site. 

But you should list the top 10 ones you explored and enjoyed. You should be able to differentiate their purpose, where it shines, and where it doesn't.
