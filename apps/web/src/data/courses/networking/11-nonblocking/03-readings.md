...
| 5   | Boost.Asio, [`thread_pool`](https://www.boost.org/doc/libs/latest/doc/html/boost_asio/reference/thread_pool.html) + [`strand` reference](https://www.boost.org/doc/libs/latest/doc/html/boost_asio/reference/strand.html)                                                                                     | 15 min | `post/dispatch/defer`, pool lifecycle, and serialized execution strategy for shared state                                                              |
...
| 8   | C++ Reference, [`std::jthread` and cooperative cancellation](https://en.cppreference.com/w/cpp/thread/jthread) + Boost.Asio, [`co_spawn` reference](https://www.boost.org/doc/libs/latest/doc/html/boost_asio/reference/co_spawn.html)                                                                        | 15 min | Modern C++ thread manager building blocks: RAII thread ownership, stop tokens, and coroutine-based async flows                                         |
...
- [Boost.Asio C++11 Example: Fork Process Per Connection](https://www.boost.org/doc/libs/latest/doc/html/boost_asio/examples/cpp11_examples.html#boost_asio.examples.cpp11_examples.fork_process_per_connection) — process-level concurrency model reference
