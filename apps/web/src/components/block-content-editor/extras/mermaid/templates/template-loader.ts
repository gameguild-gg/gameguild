 ...
 */
export async function getTemplatesByCategory(categoryId: string): Promise<MermaidTemplate[]> {
 ...
 */
export async function searchTemplates(query: string): Promise<MermaidTemplate[]> {
  const allTemplates = await getAllTemplates()
