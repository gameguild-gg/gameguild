 ...
 */
export function getThemePair(themeBase: VegaThemeBase, mode: ThemeMode = "system"): ThemePair {
 ...
 */
export const THEME_MODE_DESCRIPTIONS: Record<ThemeMode, { label: string; description: string }> = {
  "system": {
    label: "System",
