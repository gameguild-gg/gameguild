import type { DividerStyle, DividerThickness, DividerSpacing, ColorPalette } from "@/components/block-content-editor/nodes/divider-node"
 ...
 */
export function getColorStyles(colorPalette: ColorPalette, style: DividerStyle): string {
 ...
 */
export function getPaletteColor(colorPalette: ColorPalette, customColor?: string): string {
