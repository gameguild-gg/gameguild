...
import { CaptionInput } from "@/components/block-content-editor/extras/caption-input"
import { ContentEditMenu, type EditMenuOption } from "@/components/block-content-editor/extras/content-edit-menu"
import { ImageSizeControl } from "@/components/block-content-editor/extras/image-size-control"
...
function SpotifyComponent({ data, nodeKey }: SpotifyComponentProps) {
  ...
  return (
    <div
      className="my-6 relative group spotify-wrapper"
