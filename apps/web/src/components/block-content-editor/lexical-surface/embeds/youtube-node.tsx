/**
 * YouTubeNode — `DecoratorBlockNode` rendering an embedded YouTube iframe.
 * Ported from `lexical-playground/src/nodes/YouTubeNode.tsx`.
 */
...
function $convertYoutubeElement(domNode: HTMLElement): DOMConversionOutput | null {
  ...
  if (videoID) return { node: $createYouTubeNode(videoID) }
  return null
}
...
export class YouTubeNode extends DecoratorBlockNode {
  ...
  exportJSON(): SerializedYouTubeNode {
    return { ...super.exportJSON(), videoID: this.__id }
  }
