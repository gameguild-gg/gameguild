...
function isCollapsibleBorderStyle(value: unknown): value is CollapsibleBorderStyle {
  return value === "solid"
}
...
export class CollapsibleContainerNode extends ElementNode {
  ...
  constructor(
    ...
    this.__borderAlwaysVisible =
      options.borderAlwaysVisible ?? DEFAULT_COLLAPSIBLE_STYLE.borderAlwaysVisible
    this.__borderStyle = options.borderStyle ?? DEFAULT_COLLAPSIBLE_STYLE.borderStyle
    this.__borderColor =
  ...
  exportDOM(): DOMExportOutput {
    ...
    if (this.__borderColor) {
      ...
      element.style.setProperty("--collapsible-border-color", this.__borderColor)
    }
    return { element }
  }
