  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        >
          {PAGE_SIZES.map((size) => (
            <OptionRow
              ...
              onClick={() =>
                setPageSettings({ ...pageSettings, size: size.id as PageSizeId })
              }
            >
              {size.label}
            </OptionRow>
        ...
        >
          {(Object.keys(PAGE_ORIENTATION_LABELS) as PageOrientation[]).map((o) => (
            <OptionRow
              key={o}
              active={pageSettings.orientation === o}
              onClick={() => setPageSettings({ ...pageSettings, orientation: o })}
            >
