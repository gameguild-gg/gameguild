    ...
    <div className="rounded-lg border overflow-hidden">
      ...
      <div className="bg-background font-mono text-sm relative" style={{ overflow: 'visible' }}>
        {activeFile ? (
          ...
          <div className="flex items-center justify-center p-4 text-muted-foreground" style={{ height: `${codeEditorHeight}px` }}>
      ...
      {/* Settings bar */}
      <div className={cn('p-3 flex items-center justify-between', isDarkTheme ? 'bg-gray-800 text-white' : 'bg-muted text-foreground')}>
