...
// const DEFAULT_FIRST_CODE_TEMPLATES: Record<ProgrammingLanguage, string> = {
//   javascript: "// Add your custom test code here\n// This will be prepended to the student's code\n",
//   typescript: "// Add your custom test code here\n// This will be prepended to the student's code\n",
//   python: "# Add your custom test code here\n# This will be prepended to the student's code\n",
//   lua: "-- Add your custom test code here\n-- This will be prepended to the student's code\n",
//   c: "// Add your custom test code here\n// This will be prepended to the student's code\n",
//   cpp: "// Add your custom test code here\n// This will be prepended to the student's code\n",
//   h: "// Add your custom test code here\n// This will be prepended to the student's code\n",
//   hpp: "// Add your custom test code here\n// This will be prepended to the student's code\n",
// }

// const DEFAULT_SECOND_CODE_TEMPLATES: Record<ProgrammingLanguage, string> = {
//   javascript: `// Default test validation code
...
// }`,
//   typescript: `// Default test validation code
...
//   console.log("Actual: " + JSON.stringify(actualReturn));
// }`,
//   python: `# Default test validation code
...
//   lua: `-- Default test validation code
...
// end`,
//   c: `// Default test validation code
...
//     printf("Actual: %d\\n", actual_return);
// }`,
//   cpp: `// Default test validation code
// // Replace with your expected value and actual return capture
// int expected_return = 0;
// int actual_return = 0;
...
//     printf("Actual: %d\\n", actual_return);
// }`,
//   h: `// Default test validation code
// // Replace with your expected value and actual return capture
// int expected_return = 0;
// int actual_return = 0;
...
//     printf("Actual: %d\\n", actual_return);
// }`,
//   hpp: `// Default test validation code
// // Replace with your expected value and actual return capture
// int expected_return = 0;
// int actual_return = 0;
...
// const FUNCTION_FIRST_CODE_TEMPLATES: Record<ProgrammingLanguage, string> = {
...
// const FUNCTION_SECOND_CODE_TEMPLATES: Record<ProgrammingLanguage, string> = {
        ...
        <div className="grid grid-cols-3 gap-6 py-6">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground text-center leading-relaxed">
              {hasCustomTest
                ? "Only one custom test allowed per file"
                : "Add custom code that runs before and after the student's code"}
            </p>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <p className="text-sm text-muted-foreground text-center leading-relaxed">
              {hasFunctionTest
                ? "Only one function test allowed per file"
                : "Test functions with assertion helpers and structured validation"}
            </p>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <p className="text-sm text-muted-foreground text-center leading-relaxed">
              {hasConsoleTest
                ? "Only one console test allowed per file"
                : "Test console interactions with custom validation logic"}
            </p>
          </button>
        </div>
        <DialogFooter>
      ...
      {isEditing && (
        <div className="p-4 border rounded bg-gray-50 dark:bg-gray-800 text-center">
          ...
          <p className="text-xs text-gray-500">
            Click the button above to create or update the {testType} test files in the main editor.
          </p>
...
export function Terminal({
  ...
  useEffect(() => {
    if (
      fileSelectedLanguage &&
      availableLanguages.includes(fileSelectedLanguage) &&
  ...
  const getCustomCode = (
    testCase: any,
    codeType: "customCodeFirst" | "customCodeSecond",
    ...
    if (index === 0) {
      return codeType === "customCodeFirst"
        ? DEFAULT_FIRST_CODE_TEMPLATES[language]
        : DEFAULT_SECOND_CODE_TEMPLATES[language]
    } else {
  ...
  return (
    <TooltipProvider>
      <div className="border-t">
        ...
        {/* Tab Header */}
        <div
          className={cn("flex border-b", isDarkTheme ? "border-gray-700 bg-gray-900" : "border-gray-200 bg-gray-50")}
        >
          <button
            className={cn(
        ...
        {activeTab === "terminal" && (
          <>
            <div
              className={cn("p-2 flex items-center", isDarkTheme ? "bg-black text-white" : "bg-gray-200 text-black")}
            >
              <TerminalIcon className="h-4 w-4 mr-2" />
            ...
            <div
              ref={terminalRef}
              className={cn(
                "h-40 overflow-y-auto p-2 font-mono text-xs",
            ...
            >
                  ...
                  {output.type === "output" && (
                    <span>
                      {Array.isArray(output.content)
                        ? output.content.map((line, i) => <div key={i}>{String(line)}</div>)
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  className={cn(
                    "bg-transparent border-none outline-none flex-grow text-xs font-mono",
                  ...
                  disabled={
                    isExecuting &&
                    !(window.__awaitingPromptInput || window.__awaitingConfirmInput || window.__awaitingAlertAck)
                  }
                  autoFocus
                />
              </div>
        ...
        {activeTab === "tests" && showTests && (
          <>
            ...
            <div
              className={cn("flex flex-col h-40", isDarkTheme ? "bg-black text-white" : "bg-white text-black")}
              style={{ height: `${terminalHeight}px` }}
            >
              {!testCases[activeFileId] || testCases[activeFileId].length === 0 ? (
                <div className="text-center text-gray-500 text-xs py-4">
                  No test cases defined. Click the + button to add a test case.
                </div>
              ) : (
                <>
                          ...
                          <div>
                            ...
                            {!testCase.args || !Array.isArray(testCase.args) || testCase.args.length === 0 ? (
                              <div className="text-xs text-gray-500 italic mb-2">
                                No arguments added. Click "Add Argument" to add input values.
                              </div>
                            ) : (
                          ...
                          <div className="mt-4 border-t pt-2">
                            ...
                            >
                              <div className="font-semibold">
                                {testResults[activeFileId][index].passed ? "✓ Test Passed" : "✗ Test Failed"}
                              </div>
                              {!testResults[activeFileId][index].passed && (
                                <>
                                  <div className="mt-1">
