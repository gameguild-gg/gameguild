...
export function QuizFeedback({ isCorrect, correctFeedback, incorrectFeedback, allowRetry, onRetry, showRetryButton }: QuizFeedbackProps) {
  return (
    <div
    ...
    >
      <div className="flex items-center gap-2 flex-1">
        ...
        <span className="font-medium">{isCorrect ? correctFeedback || "Excellent! That's correct!" : incorrectFeedback || 'Not quite right. Try again!'}</span>
      </div>
