...
function HeaderComponent({ data, nodeKey }: HeaderComponentProps) {
  ...
  const [style, setStyle] = useState<"default" | "underlined" | "bordered" | "gradient" | "accent">(
    data.style || "default",
  )
      ...
      <div className="rounded-lg border bg-card p-4 shadow-sm">
        ...
        <div className="space-y-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-48">
                  <DropdownMenuItem onClick={() => handleLevelChange(1)} className="flex items-center gap-2">
                    <span className="flex h-5 w-5 items-center justify-center rounded bg-red-100 text-xs font-bold text-red-700">
                      1
                    </span>
                    <div>
                  ...
                  <DropdownMenuItem onClick={() => handleLevelChange(2)} className="flex items-center gap-2">
                    <span className="flex h-5 w-5 items-center justify-center rounded bg-orange-100 text-xs font-bold text-orange-700">
                      2
                    </span>
                    <div>
                  ...
                  <DropdownMenuItem onClick={() => handleLevelChange(3)} className="flex items-center gap-2">
                    <span className="flex h-5 w-5 items-center justify-center rounded bg-yellow-100 text-xs font-bold text-yellow-700">
                      3
                    </span>
                    <div>
                  ...
                  <DropdownMenuItem onClick={() => handleLevelChange(6)} className="flex items-center gap-2">
                    <span className="flex h-5 w-5 items-center justify-center rounded bg-purple-100 text-xs font-bold text-purple-700">
                      6
                    </span>
                    <div>
          ...
          <div className="space-y-2">
            ...
            <div
              className={`relative rounded-lg border p-4 transition-colors focus-within:border-primary ${getStyleClass()} text-${alignment}`}
            >
              <input
                type="text"
                value={text}
              ...
              />
              {!text && (
                <div className="absolute right-2 top-2 text-xs text-muted-foreground/60">Preview as you type</div>
              )}
            </div>
          </div>
        </div>
