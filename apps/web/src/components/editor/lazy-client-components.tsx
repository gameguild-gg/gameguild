...
const LazyCodeStudioEditor = dynamic<CodeStudioEditorProps>(
  () => import("@/components/editor/extras/code-studio/code-studio-editor").then((mod) => mod.CodeStudioEditor),
  {
    ssr: false,
...
export const QuizSettingsDialog = dynamic(
  () => import("@/components/editor/extras/quiz/quiz-settings-dialog").then((mod) => ({ default: mod.QuizSettingsDialog })),
  {
    ssr: false,
...
export const ModeSelectionDialog = dynamic(
  () => import("@/components/editor/extras/code-studio/mode-selection-dialog").then((mod) => ({ default: mod.ModeSelectionDialog })),
  {
    ssr: false,
...
export const MarkdownEditor = dynamic(
  () => import("@/components/editor/extras/markdown/markdown-editor").then((mod) => ({ default: mod.MarkdownEditor })),
  {
    ssr: false,
...
export const MermaidEditor = dynamic(
  () => import("@/components/editor/extras/mermaid/mermaid-editor").then((mod) => ({ default: mod.MermaidEditor })),
  {
    ssr: false,
...
export const VegaLiteEditor = dynamic(
  () => import("@/components/editor/extras/vega-lite/vega-lite-editor").then((mod) => ({ default: mod.VegaLiteEditor })),
  {
    ssr: false,
...
export const DividerEditor = dynamic(
  () => import("@/components/editor/extras/divider/divider-editor").then((mod) => ({ default: mod.DividerEditor })),
  {
    ssr: false,
...
export const ButtonEditor = dynamic(
  () => import("@/components/editor/extras/button/button-editor").then((mod) => ({ default: mod.ButtonEditor })),
  {
    ssr: false,
...
export const AdmonitionEditor = dynamic(
  () => import("@/components/editor/extras/admonition/admonition-editor").then((mod) => ({ default: mod.AdmonitionEditor })),
  {
    ssr: false,
...
export const UnifiedMediaEditor = dynamic(
  () => import("@/components/editor/extras/media/unified-media-editor").then((mod) => ({ default: mod.UnifiedMediaEditor })),
  {
    ssr: false,
...
export const TableEditor = dynamic(
  () => import("@/components/editor/extras/table/table-editor").then((mod) => ({ default: mod.TableEditor })),
  {
    ssr: false,
...
export const HTMLEditor = dynamic(
  () => import("@/components/editor/extras/html/html-editor").then((mod) => ({ default: mod.HTMLEditor })),
  {
    ssr: false,
...
export const RichTextEditor = dynamic(
  () => import("@/components/editor/extras/rich-text/rich-text-editor").then((mod) => ({ default: mod.RichTextEditor })),
  {
    ssr: false,
