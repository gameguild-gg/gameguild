...
interface PanelNavigationControlsProps {
  currentIndex: number
  totalPanels: number
  onPrevious: () => void
  onNext: () => void
...
export function PanelNavigationControls({
  currentIndex,
  totalPanels,
  onPrevious,
  onNext,
  className,
}: PanelNavigationControlsProps) {
