...
const ORDERED_LIST_STYLES: OrderedListStyle[] = [{ icon: '1.', name: 'Numbers (default)', style: 'list-style-type: decimal;' }];
    ...
    <DropdownMenuSub>
      ...
      <DropdownMenuSubContent side="right" align="start" className="w-48">
        {ORDERED_LIST_STYLES.map((listStyle, index) => (
          <DropdownMenuItem key={index} onClick={() => handleOrderedListClick(listStyle.style)} onSelect={(e) => e.preventDefault()}>
