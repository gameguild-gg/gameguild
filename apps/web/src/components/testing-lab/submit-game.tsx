...
const PLATFORMS = [
  'PC/Windows', 'Mac', 'PlayStation 5', 'PlayStation 4', 'Xbox Series X/S',
  'Xbox One', 'Nintendo Switch', 'iOS', 'Android', 'Web Browser'
];
...
const TESTING_TYPES = [
  'Alpha Testing', 'Beta Testing', 'Gameplay Testing', 'UI/UX Testing',
  'Bug Testing', 'Performance Testing', 'Accessibility Testing', 'Multiplayer Testing'
];
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 border-slate-700 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="studioName" className="text-slate-200">Studio/Developer Name *</Label>
                  <Input
                    id="studioName"
              ...
              <div>
                <Label htmlFor="gameDescription" className="text-slate-200">Game Description *</Label>
                <Textarea
                  id="gameDescription"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="genre" className="text-slate-200">Primary Genre *</Label>
                  <select
                    id="genre"
                ...
                <div>
                  <Label htmlFor="buildVersion" className="text-slate-200">Build Version *</Label>
                  <Input
                    id="buildVersion"
          ...
          <Card className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 border-slate-700 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="testingType" className="text-slate-200">Testing Type *</Label>
                  <select
                    id="testingType"
                ...
                <div>
                  <Label htmlFor="expectedDuration" className="text-slate-200">Expected Session Duration *</Label>
                  <select
                    id="expectedDuration"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="maxTesters" className="text-slate-200">Maximum Testers *</Label>
                  <Input
                    id="maxTesters"
                    type="number"
                    min="1"
                ...
                <div>
                  <Label htmlFor="timeline" className="text-slate-200">Testing Timeline *</Label>
                  <select
                    id="timeline"
          ...
          <Card className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 border-slate-700 backdrop-blur-sm">
            ...
            <CardContent className="space-y-4">
              <div>
                <Label htmlFor="buildDownload" className="text-slate-200">Build Download Link *</Label>
                <Input
                  id="buildDownload"
                  type="url"
              ...
              <div>
                <Label htmlFor="specialRequirements" className="text-slate-200">Special Requirements</Label>
                <Textarea
              ...
              <div>
                <Label htmlFor="testingGoals" className="text-slate-200">Testing Goals *</Label>
                <Textarea
                  id="testingGoals"
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="terms" className="text-slate-200 text-sm leading-relaxed">
                    I agree to the <span className="text-purple-400 hover:underline cursor-pointer">Developer Terms of Service</span> and <span className="text-purple-400 hover:underline cursor-pointer">Testing Lab Guidelines</span>. I understand that my game will be reviewed before testing sessions are scheduled.
                  </Label>
                </div>
