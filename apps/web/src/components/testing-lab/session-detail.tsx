            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 border border-slate-600 rounded-lg p-4 text-center backdrop-blur-sm">
                  ...
                  <p className="text-white font-semibold">{session.currentTesters}/{session.maxTesters}</p>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-white">{session.currentTesters} / {session.maxTesters}</span>
                    </div>
