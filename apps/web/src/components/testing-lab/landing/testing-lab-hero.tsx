        ...
        <div className="relative z-10 p-8">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-16 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col items-center space-y-3">
              ...
              <p className="text-slate-400 text-center drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                Connect with other testers and developers in collaborative
                sessions
              </p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-3">
              ...
              <p className="text-slate-400 text-center drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                Give creators structured evidence they can apply to the next
                build
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div className="relative">
              ...
              <Button
                ...
                nativeButton={false} render={<Link href="/testing-lab" />}
              >
                Browse Events
              </Button>
            </div>
