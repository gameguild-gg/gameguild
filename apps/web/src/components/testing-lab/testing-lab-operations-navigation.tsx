...
const operations = [
  {
    href: '/dashboard/community/testing-lab/events',
    label: 'Events',
    Icon: CalendarDays,
  },
  {
    href: '/dashboard/community/testing-lab/projects',
    label: 'Projects',
    Icon: FolderKanban,
  },
  {
    href: '/dashboard/community/testing-lab/participants',
    label: 'Participants',
    Icon: Users,
  },
  {
    href: '/dashboard/community/testing-lab/analytics',
    label: 'Analytics',
    Icon: BarChart3,
  },
  {
