    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="border-white/10 bg-slate-900/85 text-white shadow-2xl shadow-sky-950/30 backdrop-blur">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">Welcome back to GameGuild</CardTitle>
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <FieldDescription className="text-center text-slate-300">
                  ...
                  <Link href="/sign-up" className="text-sky-200 underline-offset-4 hover:underline">Sign up</Link>
                </FieldDescription>
              </Field>
            </FieldGroup>
          </form>
