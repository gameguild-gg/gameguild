...
//   const { config = {}, onSave, onAutoSave, onValidate } = props;
//   const initialCourse = course || createEmptyCourse();
//
...
//   // };
//
//   // Minimal context value with stubs
//   const contextValue: CourseEditorContextValue = {
//     state,
//     loadCourse: async () => {},
//     loadCourseBySlug: async () => {},
//     createNewCourse: () => {},
//     saveCourse: async () => false,
//     publishCourse: async () => false,
//     resetCourse: () => {},
//     updateCourseField: () => {},
//     updateCourseContent: () => {},
//     updateCourseMetadata: () => {},
...
//     setError,
//     loadCourse,
//     resetCourse, // Use resetCourse instead of clearCourse
//     createNewCourse,
//     updateCourseField,
//     updateCourseContent,
//     updateCourseMetadata,
...
//     disableAutoSave,
//     setAutoSaveInterval,
//     // resetEditor, // Remove this as it doesn't exist in interface
//   } = useCourseEditor();
//
//   return {
//     setLoading,
//     setError,
//     loadCourse,
//     clearCourse: resetCourse, // Map clearCourse to resetCourse
//     createNewCourse,
//     updateCourseField,
//     updateCourseContent,
//     updateCourseMetadata,
...
//     disableAutoSave,
//     setAutoSaveInterval,
//     // resetEditor, // Remove as it doesn't exist in interface
//   };
// };
