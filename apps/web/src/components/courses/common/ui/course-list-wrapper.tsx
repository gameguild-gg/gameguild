...
export const CourseListWrapper = ({ courses }: CourseListWrapperProps): React.JSX.Element => {
  ...
  const navigateToCourse = (course: CourseCardCourse, suffix = '') => {
    ...
    router.push(`/dashboard/platform/learning/courses/${identifier}${suffix}` as Parameters<typeof router.push>[0]);
  };

  const handleCreateCourse = () => {
    router.push('/dashboard/platform/learning/courses/new' as Parameters<typeof router.push>[0]);
  };
