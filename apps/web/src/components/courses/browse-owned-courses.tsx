...
export function BrowseOwnedCoursesPage({ courses = [] }: BrowseOwnedCoursesPageProps) {
  ...
  const handleContinueCourse = (courseId: string) => {
    ...
    router.push(`/workspace/learning/courses/${courseId}/content${nextLessonPath}`);
  };

  const handleStartCourse = (courseId: string) => {
    router.push(`/workspace/learning/courses/${courseId}/content`);
  };

  const handleViewCertificate = (courseId: string) => {
    router.push(`/workspace/learning/courses/${courseId}/certificates`);
  };
                ...
                <div className="absolute top-2 right-2">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      ...
                      <DropdownMenuItem onClick={() => router.push(`/workspace/learning/courses/${course.id}/students`)}>View enrollment</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
