...
const SocialLink = ({ href, icon: Icon, label, hoverColor, iconHover }: SocialLinkData): React.JSX.Element => (
  <Link href={href} aria-label={label} className={`group p-3 bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-lg border border-slate-600/50 transition-all duration-300 hover:shadow-lg ${hoverColor}`}>
