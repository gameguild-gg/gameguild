      ...
      <div className="container mx-auto max-w-6xl px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <h2 className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-3">Join our newsletter</h2>
            <p className="text-slate-400 text-base lg:text-lg mb-4">Get the latest updates on courses, game jams, and community events delivered straight to your inbox.</p>
          </div>

          {/* Right Column - Form */}
          <div>
            <div className="flex flex-col sm:flex-row gap-3">
              <Input type="email" placeholder="Enter your email" className="flex-1 bg-white/5 backdrop-blur-sm text-white border-slate-600/50 placeholder:text-slate-500 h-12 focus:border-blue-400/50 focus:bg-white/10 transition-all" />
