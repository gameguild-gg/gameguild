...
function AudioComponent({ data, nodeKey }: AudioComponentProps) {
  ...
  const renderErrorMessage = () => (
    <div className="bg-red-50 dark:bg-red-900/20 text-red-800 dark:text-red-200 rounded-lg p-4 flex flex-col items-center justify-center min-h-[80px]" style={{ width: `${size}%` }}>
