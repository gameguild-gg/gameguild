      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href={toRoute('/')} className="flex items-center gap-2">
                    ...
                    <NavigationMenuContent>
                      <div className="grid w-[600px] gap-3 p-6 md:grid-cols-2">
                        {section.items.map((item) => (
                          <Link key={item.href} href={toRoute(item.href)} className="group grid grid-cols-[auto_1fr] gap-3 rounded-md p-3 hover:bg-accent transition-colors">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-80" align="end" forceMount>
                ...
                <DropdownMenuItem asChild>
                  <Link href={toRoute('/profile')} className="cursor-pointer">
                ...
                <DropdownMenuItem asChild>
                  <Link href={toRoute('/my-learning')} className="cursor-pointer">
                ...
                <DropdownMenuItem asChild>
                  <Link href={toRoute('/certificates')} className="cursor-pointer">
                ...
                <DropdownMenuItem asChild>
                  <Link href={toRoute('/bookmarks')} className="cursor-pointer">
                ...
                <DropdownMenuSub>
                  ...
                  <DropdownMenuSubContent>
                    <DropdownMenuItem asChild>
                      <Link href={toRoute('/settings/account')}>
                        <User className="mr-2 h-4 w-4" />
                        Account Settings
                      </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                      <Link href={toRoute('/settings/preferences')}>
                        <Settings className="mr-2 h-4 w-4" />
                        Preferences
                      </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild>
                      <Link href={toRoute('/settings/privacy')}>
                ...
                <DropdownMenuItem asChild>
                  <Link href={toRoute('/billing')} className="cursor-pointer">
                ...
                <DropdownMenuItem asChild>
                  <Link href={toRoute('/help')} className="cursor-pointer">
                  ...
                  <nav className="flex-1 space-y-4">
                    {navigationItems.map((section) => (
                      <div key={section.title}>
                        ...
                        <div className="space-y-1">
                          {section.items.map((item) => (
                            <Link key={item.href} href={toRoute(item.href)} className="flex items-center gap-3 p-2 rounded-md hover:bg-accent transition-colors">
                              <item.icon className="h-4 w-4 text-primary" />
                              <div>
