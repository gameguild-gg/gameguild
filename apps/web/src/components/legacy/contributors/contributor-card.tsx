    ...
    <div className="bg-white shadow-md rounded-lg overflow-hidden">
      <div className="p-4">
        <Link href={contributor.html_url || ''}>
          <Image src={contributor.avatar_url} alt={`${contributor.login}'s avatar`} width={100} height={100} className="w-24 h-24 rounded-full mx-auto mb-4" />
          <h2 className="text-xl font-semibold text-center mb-2">{contributor.login}</h2>
        </Link>
