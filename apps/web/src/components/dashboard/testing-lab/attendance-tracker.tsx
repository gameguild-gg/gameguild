                    ...
                    <TableCell className="text-slate-300">
                      {record.checkInTime && record.checkOutTime ? (
                        <div className="text-sm">
                          <div>In: {new Date(record.checkInTime).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}</div>
                          <div>Out: {new Date(record.checkOutTime).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}</div>
                        </div>
                      ) : (
