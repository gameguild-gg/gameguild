      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-lg max-w-3xl mx-auto">
            Whether you&apos;re a seasoned developer or just starting out, there are many ways to contribute to Game Guild. Every contribution helps make our platform better for the gaming community.
          </p>
        </div>
