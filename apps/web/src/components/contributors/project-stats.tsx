...
export function ProjectStats() {
  ...
  return (
    <section className="w-full mb-12">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-b border-slate-700">
        ...
        <div className="max-w-7xl mx-auto relative p-8 md:p-12">
          {/* Command line header */}
          <div className="mb-8">
            <div className="text-slate-400 text-sm font-mono mb-6">
              gh pulse --year 2022 --community-insights
            </div>
          </div>
          ...
          <div className="text-center relative z-10">
            ...
            <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
              Read the Octoverse report to get the human insights
            </p>
            <button className="bg-white text-black px-8 py-3 rounded-lg font-medium hover:bg-slate-100 transition-colors">
              Read Octoverse 2022 →
            </button>
          </div>
        </div>
