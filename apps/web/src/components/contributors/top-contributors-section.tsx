...
export const TopContributorsSection: React.FC<TopContributorsSectionProps> = ({ contributors, topCount = 3 }) => {
  ...
  return (
    <div className="mb-16 py-12">
      ...
      <div className="flex flex-col xl:flex-row items-center xl:items-end justify-center gap-6 xl:gap-8 mb-12 relative min-h-[320px]">
        {/* 1st Place - First on mobile, Center on desktop */}
        {topContributors[0] && (
          <div className="transform translate-y-0 z-10 xl:scale-110 xl:order-2">
        ...
        {topContributors[1] && (
          <div className="transform xl:translate-y-16 xl:order-1">
        ...
        {topContributors[2] && (
          <div className="transform xl:translate-y-16 xl:order-3">
