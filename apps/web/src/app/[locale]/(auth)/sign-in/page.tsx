        ...
        providers={
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              className="flex h-10 w-full items-center justify-center gap-2 rounded-md bg-[#5865F2] text-sm font-medium text-white shadow-xs transition hover:bg-[#4752C4] focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px"
            >
              <svg viewBox="0 0 24 24" fill="#FFFFFF" aria-hidden="true" className="size-5">
