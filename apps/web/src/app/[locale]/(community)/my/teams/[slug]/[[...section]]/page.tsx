...
export async function TeamWorkspacePage({
  ...
  const base = surface === 'admin' ? `/dashboard/community/teams/${team.id}` : `/my/teams/${team.slug}`;
  const projectRoot = surface === 'admin' ? '/dashboard/community/projects' : '/my/projects';
