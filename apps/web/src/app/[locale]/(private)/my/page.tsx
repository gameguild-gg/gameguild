    ...
    <div className="space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button variant="outline" render={<Link href="/my/teams/new" />}><Plus className="size-4" />Team</Button>
          <Button render={<Link href="/my/projects/new" />}><Plus className="size-4" />Project</Button>
        </div>
      </header>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex-row items-center justify-between space-y-0"><div><CardTitle>Recent Teams</CardTitle><CardDescription>Only active Team memberships are shown here.</CardDescription></div><Button size="sm" variant="ghost" render={<Link href="/my/teams" />}>All Teams</Button></CardHeader>
        ...
        <Card>
          <CardHeader className="flex-row items-center justify-between space-y-0"><div><CardTitle>Recent Projects</CardTitle><CardDescription>Personal access stays personal, even when you are an administrator.</CardDescription></div><Button size="sm" variant="ghost" render={<Link href="/my/projects" />}>All Projects</Button></CardHeader>
      ...
      <Card>
        ...
        <CardContent><Button variant="outline" render={<Link href="/my/work" />}>Open assigned work</Button></CardContent>
      </Card>
    </div>
  );
}
