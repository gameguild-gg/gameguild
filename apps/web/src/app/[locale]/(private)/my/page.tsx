    ...
    <div className="space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button nativeButton={false} variant="outline" render={<Link href="/my/teams/new" />}><Plus className="size-4" />Team</Button>
          <Button nativeButton={false} render={<Link href="/my/projects/new" />}><Plus className="size-4" />Project</Button>
        </div>
      </header>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex-row items-center justify-between space-y-0"><div><CardTitle>Recent Teams</CardTitle><CardDescription>Only active Team memberships are shown here.</CardDescription></div><Button nativeButton={false} size="sm" variant="ghost" render={<Link href="/my/teams" />}>All Teams</Button></CardHeader>
      ...
      <Card>
        ...
        <CardContent><Button nativeButton={false} variant="outline" render={<Link href="/my/work" />}>Open assigned work</Button></CardContent>
      </Card>
    </div>
  );
}
