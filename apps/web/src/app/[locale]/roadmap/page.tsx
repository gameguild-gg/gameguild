      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-xl max-w-4xl mx-auto leading-relaxed">
            Follow our journey from initial concept to the premier gaming community platform. 
            Each milestone represents months of hard work, community feedback, and innovative features.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-card rounded-lg border border-border p-8">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Help us build the future of gaming communities. Every contribution, whether code, 
              feedback, or ideas, helps shape our roadmap.
            </p>
