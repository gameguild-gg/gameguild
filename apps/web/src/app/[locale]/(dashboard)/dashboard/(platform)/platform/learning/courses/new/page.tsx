...
export default function CreateCoursePage({ params }: PageProps<'/[locale]/dashboard/platform/learning/courses/new'>) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      if (!updateResult.success) {
        ...
        setRecoveryHref(`/dashboard/platform/learning/courses/${courseRouteParam}`);
        setError(
      ...
      router.push(`/dashboard/platform/learning/courses/${courseRouteParam}`);
    });
  }
    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-6 p-6">
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/dashboard/platform/learning/courses">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-4 flex gap-3">
          ...
          <Button type="button" variant="ghost" asChild>
            <Link href="/dashboard/platform/learning/courses">Cancel</Link>
          </Button>
        </div>
      </form>
    </div>
