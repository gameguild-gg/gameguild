...
describe('SubmissionsList', () => {
  ...
  it('renders a row per submission with status badge + Grade link', () => {
    ...
    expect(gradeLinks[0]).toHaveAttribute(
      'href',
      '/dashboard/platform/learning/courses/course-1/assessments/assessment-1/submissions/sub-1/grade',
    );
    expect(gradeLinks[2]).toHaveAttribute(
      'href',
      '/dashboard/platform/learning/courses/course-1/assessments/assessment-1/submissions/sub-3/grade',
    );
  });
