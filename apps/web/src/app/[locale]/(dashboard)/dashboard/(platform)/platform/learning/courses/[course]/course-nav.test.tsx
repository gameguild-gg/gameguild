...
vi.mock('@/i18n/navigation', () => ({
  ...
  usePathname: () => '/en-US/dashboard/platform/learning/courses/ai-for-boss-encounters/listing',
...
describe('CourseNav', () => {
  ...
  it('links the preview action to the authenticated dashboard storefront preview', () => {
    ...
    expect(previewLink).toHaveAttribute('href', '/dashboard/platform/learning/courses/ai-for-boss-encounters/preview');
  ...
  it('keeps public sharing disabled when a course has no public slug', () => {
    ...
    expect(screen.getByRole('link', { name: /preview/i })).toHaveAttribute('href', '/dashboard/platform/learning/courses/untitled-draft/preview');
