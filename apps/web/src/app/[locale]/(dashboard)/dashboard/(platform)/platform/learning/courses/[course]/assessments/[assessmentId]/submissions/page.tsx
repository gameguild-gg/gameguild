 ...
 *
 * Route: /[locale]/dashboard/platform/learning/courses/[course]/assessments/[assessmentId]/submissions
 *
...
export default async function AssessmentSubmissionsPage({
  ...
  const backHref = `/dashboard/platform/learning/courses/${course}/assessments/${assessmentId}`;
