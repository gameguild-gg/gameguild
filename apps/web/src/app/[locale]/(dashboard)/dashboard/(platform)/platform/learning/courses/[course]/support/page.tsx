...
export default async function SupportPage({
  params,
}: PageProps<'/[locale]/dashboard/platform/learning/courses/[course]/support'>): Promise<never> {
  ...
  redirect(`/${locale}/dashboard/platform/learning/courses/${encodeURIComponent(courseRouteParam)}/support/tickets`);
}
