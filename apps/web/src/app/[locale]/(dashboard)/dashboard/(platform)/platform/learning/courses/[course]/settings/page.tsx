 ...
 */
export default async function Page({ params }: PageProps<'/[locale]/dashboard/platform/learning/courses/[course]/settings'>): Promise<never> {
  ...
  redirect(`/${locale}/dashboard/platform/learning/courses/${encodeURIComponent(courseRouteParam)}/settings/danger`);
}
