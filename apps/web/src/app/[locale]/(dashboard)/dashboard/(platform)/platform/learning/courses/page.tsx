...
export default async function Page({ params }: PageProps<'/[locale]/dashboard/platform/learning/courses'>): Promise<React.JSX.Element> {
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" asChild>
            <Link href="/dashboard/platform/learning" locale={locale}>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button asChild>
            <Link href="/dashboard/platform/learning/courses/new" locale={locale}>
        ...
        <Card className="border-destructive/30 bg-destructive/5">
          <CardContent className="flex flex-col gap-4 p-6 sm:flex-row sm:items-start sm:justify-between">
            ...
            <Button asChild variant="outline" className="shrink-0">
              <Link href="/dashboard/platform/learning/courses" locale={locale}>
