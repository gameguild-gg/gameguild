...
vi.mock("next/navigation", () => ({
  usePathname: () => "/en-US/dashboard/platform/learning/courses/course-1/content",
  useRouter: () => ({
...
describe("ContentTree course management", () => {
  ...
  it("navigates from visible lesson action icons to the content editor", async () => {
    ...
    expect(navigationMocks.push).toHaveBeenCalledWith(
      "/en-US/dashboard/platform/learning/courses/course-1/content/lesson-1",
    );
  });
  ...
  it("uses subitem edit and delete actions from nested content rows", async () => {
    ...
    expect(navigationMocks.push).toHaveBeenCalledWith(
      "/en-US/dashboard/platform/learning/courses/course-1/content/sublesson-1",
    );
