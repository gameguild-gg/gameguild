...
export default async function ListingPage({
  params,
}: PageProps<'/[locale]/dashboard/platform/learning/courses/[course]/listing'>): Promise<React.JSX.Element> {
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-lg border p-4">
                ...
                <Button asChild variant="outline" className="mt-4 w-full justify-start">
                  <Link href={buildPlatformCoursePath(courseRouteParam, 'listing/info')} locale={locale}>Open identity editor</Link>
                </Button>
              </div>
              <div className="rounded-lg border p-4">
                <div className="mb-2 flex items-center gap-2 text-sm font-medium">
                ...
                <Button asChild variant="outline" className="mt-4 w-full justify-start">
                  <Link href={buildPlatformCoursePath(courseRouteParam, 'listing/media')} locale={locale}>Open media editor</Link>
                </Button>
              </div>
              <div className="rounded-lg border p-4">
                <div className="mb-2 flex items-center gap-2 text-sm font-medium">
                ...
                <Button asChild variant="outline" className="mt-4 w-full justify-start">
                  <Link href={buildPlatformCoursePath(courseRouteParam, 'listing/projects')} locale={locale}>Open project editor</Link>
                </Button>
              </div>
              <div className="rounded-lg border p-4">
                <div className="mb-2 flex items-center gap-2 text-sm font-medium">
                ...
                <Button asChild variant="outline" className="mt-4 w-full justify-start">
                  <Link href={buildPlatformCoursePath(courseRouteParam, 'listing/access')} locale={locale}>Open access controls</Link>
                </Button>
              </div>
            </div>
