...
export function AssessmentEditor({
  ...
  function handleDelete() {
    ...
    startDeleteTransition(async () => {
      ...
      if (result.success) {
        router.push(
          `/dashboard/platform/learning/courses/${encodeURIComponent(courseId)}/assessments`,
        );
      } else {
        setError(result.error);
      }
          ...
          <Card>
            ...
            <CardContent>
              <Button
                ...
                onClick={() =>
                  router.push(
                    `/dashboard/platform/learning/courses/${encodeURIComponent(courseId)}/assessments/${assessment.id}/coding-definition`,
                  )
                }
              >
