...
export default async function TestingRequestDetailPage({ params }: { params: Promise<{ requestId: string }> }) {
  ...
  return (
    <main className="space-y-6 p-4 lg:p-6">
      <TestingLabPageHeader
        icon={ClipboardList}
        title={request.title}
        description={request.description ?? 'Testing request details and operational follow-up.'}
        actions={
          <>
