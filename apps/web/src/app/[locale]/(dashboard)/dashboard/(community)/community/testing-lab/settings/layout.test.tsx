...
vi.mock("@/i18n/navigation", () => ({
  usePathname: () => "/dashboard/community/testing-lab/settings/locations",
  Link: ({
    children,
    href,
    ...props
...
describe("TestingLabSettingsLayout", () => {
  it("groups general, location, and access settings without horizontal overflow", async () => {
    ...
    expect(screen.getByRole("link", { name: "General" })).toHaveAttribute(
      "href",
      "/dashboard/community/testing-lab/settings/general",
    );
    expect(screen.getByRole("link", { name: "Locations" })).toHaveAttribute(
      "href",
      "/dashboard/community/testing-lab/settings/locations",
    );
    expect(screen.getByRole("link", { name: "Access" })).toHaveAttribute(
      "href",
      "/dashboard/community/testing-lab/settings/access",
    );
  });
});
