...
describe("Testing Lab legacy routes", () => {
  ...
  it.each([
    [LegacyTestingRequestsPage, "/dashboard/community/testing-lab/projects"],
    [LegacyTestingPeoplePage, "/dashboard/community/testing-lab/participants"],
    [LegacyTestingReportsPage, "/dashboard/community/testing-lab/analytics"],
    [LegacyTestingLocationsPage, "/dashboard/community/testing-lab/settings/locations"],
    [LegacyTestingAccessPage, "/dashboard/community/testing-lab/settings/access"],
    [TestingLabSettingsPage, "/dashboard/community/testing-lab/settings/general"],
  ])(
  ...
  it("preserves the request identifier when redirecting a project detail", async () => {
    ...
    expect(mocks.redirect).toHaveBeenCalledWith({
      href: "/dashboard/community/testing-lab/projects/request-42",
      locale: "pt-BR",
    });
  });
});
