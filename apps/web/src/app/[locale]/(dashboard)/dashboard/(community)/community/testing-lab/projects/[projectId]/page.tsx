        ...
        <TestingLabPageHeader
          ...
          actions={
            <Button asChild variant="outline">
              <Link href="/dashboard/community/testing-lab/events">Browse testing events</Link>
            </Button>
          }
        />
        ...
        {detail.project ? (
          <>
            ...
            <TestingLabEmptyState
              ...
              action={
                <Button asChild>
                  <Link href="/dashboard/community/testing-lab/events">Choose a testing event</Link>
                </Button>
              }
            />
          </>
