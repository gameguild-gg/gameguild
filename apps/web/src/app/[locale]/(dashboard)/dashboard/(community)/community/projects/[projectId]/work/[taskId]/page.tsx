...
export default async function Page({ params }: PageProps<'/[locale]/dashboard/community/projects/[projectId]/work/[taskId]'>): Promise<React.JSX.Element> {
  ...
  if (!project) notFound();
  return <ProjectWorkspaceView slug={project.slug} project={project} surface="admin" section="work" taskId={route.taskId} />;
}
