...
function pageHref(page: number, q: string, status: string) {
  ...
  return `/dashboard/community/testing-lab/projects?${params}`;
}
                  ...
                  return (
                    <tr key={request.id} className="hover:bg-muted/25">
                      ...
                      <td className="max-w-80 px-4 py-3">
                        <Link href={`/dashboard/community/testing-lab/projects/${request.id}`} className="font-medium hover:underline">
                          {request.title}
                        </Link>
