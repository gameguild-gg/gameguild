          ...
          return (
            ...
            >
              <header className="flex flex-col gap-2 border-b px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <Link href={`/dashboard/learning/courses/${courseId}/classes/${cohort.id}/schedule`} className="font-medium hover:underline">{cohort.name}</Link>
                ...
                {cohortEntries.length === 0 ? (
                  ...
                  return (
                    <Link
                      ...
                      href={`/dashboard/learning/courses/${courseId}/classes/${cohort.id}/schedule#item-${entry.itemId ?? itemIndex}`}
