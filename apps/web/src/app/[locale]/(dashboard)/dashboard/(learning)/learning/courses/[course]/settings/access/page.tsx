    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure how students can enroll in this course.</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            />
            <p className="text-muted-foreground text-xs">Optional. After this date, new enrollments are blocked.</p>
          </div>
      ...
      <div className="flex gap-3">
        <Button type="submit" disabled={isPending}>
          {isPending ? (
            ...
            <>
              <Save className="mr-2 size-4" /> Save Access Settings
            </>
          )}
        </Button>
      </div>
