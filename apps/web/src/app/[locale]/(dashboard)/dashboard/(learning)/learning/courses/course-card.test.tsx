...
describe('CourseCard actions', () => {
  it('exposes accessible edit and preview links from the grid card menu', async () => {
    ...
    expect(editLink).toHaveAttribute('href', '/dashboard/learning/courses/combat-design-foundations-by-ada-lovelace');
    expect(editLink).toHaveAttribute('data-locale', 'en-US');
    expect(previewLink).toHaveAttribute('href', '/dashboard/learning/courses/combat-design-foundations-by-ada-lovelace/preview');
