...
vi.mock('@/i18n/navigation', () => ({
  ...
  usePathname: () => '/dashboard/learning/courses/advanced-game-ai-by-gameguild/classes/evening/schedule',
  useRouter: () => ({ push }),
}));
...
describe('CohortWorkspaceNav', () => {
  it('switches classes without losing the course route', async () => {
    ...
    expect(push).toHaveBeenCalledWith('/dashboard/learning/courses/advanced-game-ai-by-gameguild/classes/morning/schedule');
  });
