...
export function CohortWorkspaceNav({ courseRoute, courseTitle, cohort, cohorts, children }: CohortWorkspaceNavProps) {
  ...
  const basePath = `/dashboard/learning/courses/${courseRoute}/classes/${cohort.id}`;
          ...
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                <Link href={`/dashboard/learning/courses/${courseRoute}/classes`} className="hover:text-foreground hover:underline">{courseTitle}</Link>
            ...
            <DropdownMenuContent align="end" className="w-72">
              {cohorts.map((item) => (
                <DropdownMenuItem
                  ...
                  onSelect={() => router.push(`/dashboard/learning/courses/${courseRoute}/classes/${item.id}/schedule`)}
                >
