...
export default function Page(paramsProps: PropsWithLocaleSlugParams) {
  ...
  const { slug, locale } = params;const [project, setProject] = useState<Project | null>(null);
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Button 
                  className="w-full" 
                  variant="outline"
                  onClick={() => router.push(`/dashboard/projects/${slug}/edit`)}
                >
              ...
              <CardContent className="space-y-3">
                ...
                <div className="text-sm">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs ${
                    ...
                    project.status === 'UnderReview' ? 'bg-yellow-100 text-yellow-800' :
                ...
                <div className="text-sm">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs ${
                    project.visibility === 'Public' ? 'bg-blue-100 text-blue-800' :
