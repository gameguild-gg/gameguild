    ...
    <div className="space-y-6">
        ...
        <article className="rounded-md border p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2 border-t pt-4">
            <Button asChild size="sm" variant="outline">
              <Link href={`/console/community/testing-lab/events/${eventId}/applications`}>
                Review applications <ArrowRight className="ml-2 size-4" />
              </Link>
            </Button>
            <Button asChild size="sm" variant="outline">
              <Link href={`/console/community/testing-lab/events/${eventId}/schedule`}>
      ...
      <section className="rounded-md border p-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button asChild size="sm" variant="outline">
            <Link href={`/console/community/testing-lab/events/${eventId}/learning`}>
