...
export default async function ListingPage({
  params,
}: PageProps<'/[locale]/console/learning/courses/[course]/listing'>): Promise<React.JSX.Element> {
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-lg border p-4">
                ...
                <Button variant="outline" className="mt-4 w-full justify-start" render={<Link href={buildDashboardCoursePath(courseRouteParam, 'listing/info', 'console')} locale={locale} />}>Open identity editor</Button>
              </div>
              <div className="rounded-lg border p-4">
                <div className="mb-2 flex items-center gap-2 text-sm font-medium">
                ...
                <Button variant="outline" className="mt-4 w-full justify-start" render={<Link href={buildDashboardCoursePath(courseRouteParam, 'listing/media', 'console')} locale={locale} />}>Open media editor</Button>
              </div>
              <div className="rounded-lg border p-4">
                <div className="mb-2 flex items-center gap-2 text-sm font-medium">
                ...
                <Button variant="outline" className="mt-4 w-full justify-start" render={<Link href={buildDashboardCoursePath(courseRouteParam, 'listing/projects', 'console')} locale={locale} />}>Open project editor</Button>
              </div>
              <div className="rounded-lg border p-4">
                <div className="mb-2 flex items-center gap-2 text-sm font-medium">
                ...
                <Button variant="outline" className="mt-4 w-full justify-start" render={<Link href={buildDashboardCoursePath(courseRouteParam, 'listing/access', 'console')} locale={locale} />}>Open access controls</Button>
              </div>
            </div>
