...
export default function CreateCoursePage({ params }: PageProps<'/[locale]/workspace/learning/courses/new'>) {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6 p-6">
      <div className="flex items-center gap-4">
        <Button nativeButton={false} variant="ghost" size="icon" render={<Link href="/workspace/learning/courses" />}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-4 flex gap-3">
          ...
          <Button nativeButton={false} type="button" variant="ghost" render={<Link href="/workspace/learning/courses" />}>
            Cancel
          </Button>
        </div>
      </form>
