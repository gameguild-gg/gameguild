  ...
  return (
    <Card>
      ...
      <CardContent className="flex flex-col gap-4">
        ...
        <Button variant="outline" size="sm" className="justify-between" render={<Link href={`/workspace/learning/courses/${item.courseSlug || item.courseId}/content/${item.slug || item.id}`} />}>
          Edit resource
    ...
    <div className="flex flex-col gap-6 p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" render={<Link href="/workspace/learning" />}>
        ...
        <Button render={<Link href="/workspace/learning/courses" />}>
      ...
      {resourceItems.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <Button className="mt-5" render={<Link href="/workspace/learning/courses/new" />}>Create course</Button>
          </CardContent>
        </Card>
      ) : (
