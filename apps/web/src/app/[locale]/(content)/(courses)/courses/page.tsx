      ...
      <section className="relative py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Learn from the Industry&apos;s Best</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">Follow our comprehensive learning tracks that guide you from beginner to expert in your chosen field.</p>
          </div>
            ...
            <Card className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 backdrop-blur-sm border-slate-700/50 shadow-lg hover:shadow-xl hover:shadow-white/10 transition-all">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-400 mb-6">Our learning tracks provide a structured approach to mastering game development, with carefully sequenced courses, hands-on projects, and milestone assessments to track your progress.</p>
                </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 backdrop-blur-sm border-slate-700/50 shadow-lg hover:shadow-xl hover:shadow-white/10 transition-all hover:scale-105">
              <CardContent className="p-8">
                ...
                <p className="text-slate-400 mb-6">&quot;The art and design courses helped me develop a professional portfolio. Within 6 months of completing the program, I landed my dream job as a 3D artist.&quot;</p>
                <div className="flex items-center">
            ...
            <Card className="bg-gradient-to-br from-slate-900/50 to-slate-800/50 backdrop-blur-sm border-slate-700/50 shadow-lg hover:shadow-xl hover:shadow-white/10 transition-all hover:scale-105">
              <CardContent className="p-8">
                ...
                <p className="text-slate-400 mb-6">&quot;The game design courses taught me how to think like a designer. The community and networking opportunities were just as valuable as the coursework.&quot;</p>
                <div className="flex items-center">
