...
describe('Legacy course content route', () => {
  ...
  it('preserves the locale and encodes the legacy course segment', async () => {
    ...
    ).rejects.toThrow('redirect:/pt-BR/learn/courses/game%20design/content');
  });
});
