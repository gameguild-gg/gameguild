  ...
  if (!experience.event) {
    ...
    return (
      <main className="px-4 py-16">
        <div className="mx-auto max-w-4xl rounded-md border border-destructive/30 bg-destructive/10 p-6">
    ...
    <main>
      <section className="border-b border-border">
        <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <Link href="/testing-lab" className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground">
