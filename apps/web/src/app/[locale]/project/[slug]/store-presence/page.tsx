...
export default function StorePresencePage() {
        ...
        <Card className="dark-card">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="tagline" defaultValue={project.tagline || ""} placeholder="A short, catchy description" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="genre" defaultValue={project.genre || ""} placeholder="e.g., Action, Adventure, RPG" />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="border-2 border-dashed border-border rounded-lg p-6 text-center">
                <UploadCloud className="mx-auto h-12 w-12 text-muted-foreground" />
                <p className="mt-2 text-sm text-muted-foreground">
                  Upload screenshots showing your game in action
                </p>
              </div>
            </div>
          </CardContent>
