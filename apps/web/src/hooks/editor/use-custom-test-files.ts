import type { CodeFile, ProgrammingLanguage } from '@/components/editor/ui/source-code/types';types';
import {
  DEFAULT_FIRST_CODE_TEMPLATES,
  FUNCTION_FIRST_CODE_TEMPLATES,
  getExtensionForSelectedLanguage,
} from '@/components/editor/ui/source-code/templates/code-templates';lates';
