...
export type UserAction =
  | { type: 'SET_USERS'; payload: UserResponseDto[] }
  | { type: 'SET_FILTERED_USERS'; payload: UserResponseDto[] }
  | { type: 'ADD_USER'; payload: UserResponseDto }
  | { type: 'UPDATE_USER'; payload: UserResponseDto }
  | { type: 'DELETE_USER'; payload: string }
  | { type: 'DELETE_USERS'; payload: string[] }
  | { type: 'BULK_UPDATE_USERS'; payload: { ids: string[]; updates: Partial<UserResponseDto> } }
  ...
  | { type: 'SET_BULK_OPERATION_PROGRESS'; payload: { total: number; completed: number; failed: number } | undefined }
  | { type: 'SET_BULK_PROGRESS'; payload: { total: number; completed: number; failed: number } | undefined }
...
function applyFilters(users: UserResponseDto[], filters: UserFilters): UserResponseDto[] {
  let filtered = [...users];
