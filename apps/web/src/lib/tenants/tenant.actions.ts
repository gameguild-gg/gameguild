...
/**
 * Get all tenants with authentication and caching
 */
export async function getTenantsData(page: number = 1, limit: number = 20, search?: string): Promise<TenantData> {
  try {
