...
export interface WorkspaceProject { id: string; title: string; slug: string; description?: string | null; shortDescription?: string | null; websiteUrl?: string | null; repositoryUrl?: string | null; downloadUrl?: string | null; status: string | number; visibility: string | number; createdById?: string | null; }
