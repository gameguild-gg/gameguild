...
describe('workspace form date serialization', () => {
  ...
  it('sends the UTC date selected by the Team invitation picker', async () => {
    ...
    formData.set('returnPath', '/dashboard/teams/team-1/invitations');
  ...
  it('normalizes optional task and milestone dates before calling the API', async () => {
    ...
    task.set('returnPath', '/dashboard/projects/project-1/work');
    ...
    milestone.set('returnPath', '/dashboard/projects/project-1/work');
  ...
  it('normalizes allocation and agreement date ranges before calling the API', async () => {
    ...
    allocation.set('returnPath', '/dashboard/projects/project-1/people');
    ...
    agreement.set('returnPath', '/dashboard/projects/project-1/access');
  ...
  it('normalizes counterproposal date ranges before calling the API', async () => {
    ...
    formData.set('returnPath', '/dashboard/projects/project-1/access');
  ...
  it('restores an archived Project through the lifecycle action', async () => {
    ...
    formData.set('returnPath', '/dashboard/projects/project-1/settings');
