...
/**
 * Enumeration of AccessLevel values
 *
 * **AccessLevel Enum Values:**
 *
 * - **0**: `Private` - No description available
 * - **1**: `Public` - No description available
 * - **2**: `Restricted` - No description available
 * - **5**: `Unlisted` - No description available
 * - **6**: `Protected` - No description available
 */
...
/**
 * Enumeration of AttendanceStatus values
 *
 * **AttendanceStatus Enum Values:**
 *
 * - **0**: `Registered` - No description available
 * - **1**: `CheckedIn` - No description available
 * - **2**: `Completed` - No description available
 * - **3**: `NoShow` - No description available
 */
...
/**
 * Enumeration of CertificateStatus values
 *
 * **CertificateStatus Enum Values:**
 *
 * - **0**: `Active` - Certificate is valid and can be verified
 * - **1**: `Expired` - Certificate has reached its expiration date
 * - **2**: `Revoked` - Certificate has been manually invalidated
 * - **3**: `Pending` - Certificate is in the process of being issued
 */
...
/**
 * Enumeration of CertificateTagRelationshipType values
 *
 * **CertificateTagRelationshipType Enum Values:**
 *
 * - **0**: `Required` - Tag is required for this certificate
 * - **1**: `Optional` - Tag is optional but recommended for this certificate
 * - **2**: `Demonstrates` - Tag indicates skill mastery demonstrated by this certificate
 */
...
/**
 * Enumeration of CertificateType values
 *
 * **CertificateType Enum Values:**
 *
 * - **0**: `ProgramCompletion` - Standard certificate for completing a single program
 * - **1**: `ProductBundleCompletion` - Certificate for completing all programs in a product bundle/specialization
 * - **2**: `LearningPathway` - Certificate for achieving specific skill combinations across multiple programs/products
 * - **3**: `SkillMastery` - Certificate recognizing mastery of specific skills
 * - **4**: `EventParticipation` - Certificate for attending workshops, conferences, or events
 * - **5**: `AssessmentPassed` - Certificate from passing standardized tests or evaluations
 * - **6**: `ProjectCompletion` - Certificate for successfully completing projects
 * - **7**: `Specialization` - Certificate for completing a series of related programs
 * - **8**: `Professional` - Industry-recognized professional certification
 * - **9**: `Achievement` - Certificate for specific accomplishments or milestones
 * - **10**: `Instructor` - Certification to teach specific subjects
 * - **11**: `TimeInvestment` - Certificate proving time spent learning a topic
 * - **12**: `PeerRecognition` - Certificate based on peer validation or community contribution
 */
...
/**
 * Enumeration of ContentStatus values
 *
 * **ContentStatus Enum Values:**
 *
 * - **0**: `Draft` - No description available
 * - **1**: `UnderReview` - No description available
 * - **2**: `Published` - No description available
 * - **3**: `Archived` - No description available
 */
...
/**
 * Enumeration of DevelopmentStatus values
 *
 * **DevelopmentStatus Enum Values:**
 *
 * - **0**: `Planning` - No description available
 * - **1**: `InDevelopment` - No description available
 * - **2**: `Alpha` - No description available
 * - **3**: `Beta` - No description available
 * - **4**: `Released` - No description available
 * - **5**: `Completed` - No description available
 * - **6**: `OnHold` - No description available
 * - **7**: `Cancelled` - No description available
 * - **8**: `Archived` - No description available
 */
...
/**
 * Enumeration of EnrollmentStatus values
 *
 * **EnrollmentStatus Enum Values:**
 *
 * - **0**: `Open` - No description available
 * - **1**: `Active` - No description available
 * - **2**: `Paused` - No description available
 * - **3**: `Cancelled` - No description available
 * - **4**: `Expired` - No description available
 * - **5**: `Completed` - No description available
 */
...
/**
 * Enumeration of FeedbackQuality values
 *
 * **FeedbackQuality Enum Values:**
 *
 * - **1**: `Positive` - No description available
 * - **2**: `Negative` - No description available
 * - **3**: `Neutral` - No description available
 */
...
/**
 * Enumeration of GradingMethod values
 *
 * **GradingMethod Enum Values:**
 *
 * - **0**: `Instructor` - Graded manually by an instructor or teaching assistant
 * - **1**: `Peer` - Peer review-based grading by other students
 * - **2**: `Ai` - Automated grading using AI algorithms
 * - **3**: `AutomatedTests` - Graded automatically using predefined test cases
 */
...
/**
 * Enumeration of InstructionType values
 *
 * **InstructionType Enum Values:**
 *
 * - **0**: `Text` - No description available
 * - **1**: `Url` - No description available
 * - **2**: `File` - No description available
 */
...
/**
 * Enumeration of InvitationStatus values
 *
 * **InvitationStatus Enum Values:**
 *
 * - **0**: `Pending` - No description available
 * - **1**: `Accepted` - No description available
 * - **2**: `Declined` - No description available
 * - **3**: `Expired` - No description available
 * - **4**: `Cancelled` - No description available
 */
...
/**
 * Enumeration of JamStatus values
 *
 * **JamStatus Enum Values:**
 *
 * - **0**: `Upcoming` - No description available
 * - **1**: `Active` - No description available
 * - **2**: `Voting` - No description available
 * - **3**: `Completed` - No description available
 * - **4**: `Cancelled` - No description available
 */
...
/**
 * Enumeration of LocalizationStatus values
 *
 * **LocalizationStatus Enum Values:**
 *
 * - **0**: `Draft` - No description available
 * - **1**: `Published` - No description available
 * - **2**: `NeedsReview` - No description available
 * - **3**: `Archived` - No description available
 * - **4**: `MachineTranslated` - No description available
 */
...
/**
 * Enumeration of LocationStatus values
 *
 * **LocationStatus Enum Values:**
 *
 * - **0**: `Active` - No description available
 * - **1**: `Maintenance` - No description available
 * - **2**: `Inactive` - No description available
 */
...
/**
 * Enumeration of MemberStatus values
 *
 * **MemberStatus Enum Values:**
 *
 * - **0**: `Pending` - No description available
 * - **1**: `Active` - No description available
 * - **2**: `Removed` - No description available
 */
...
/**
 * Enumeration of ModuleAction values
 *
 * **ModuleAction Enum Values:**
 *
 * - **0**: `None` - No description available
 * - **1**: `Create` - No description available
 * - **2**: `Read` - No description available
 * - **3**: `Edit` - No description available
 * - **4**: `Delete` - No description available
 * - **5**: `Manage` - No description available
 * - **6**: `Administer` - No description available
 * - **7**: `Execute` - No description available
 * - **8**: `Review` - No description available
 * - **9**: `Approve` - No description available
 * - **10**: `Publish` - No description available
 * - **11**: `Archive` - No description available
 * - **12**: `Restore` - No description available
 * - **20**: `CreateSession` - No description available
 * - **21**: `DeleteSession` - No description available
 * - **22**: `ManageTesters` - No description available
 * - **23**: `ViewReports` - No description available
 * - **24**: `ExportData` - No description available
 * - **30**: `ManageCollaborators` - No description available
 * - **31**: `SetPermissions` - No description available
 * - **32**: `ManageReleases` - No description available
 * - **40**: `ManageUsers` - No description available
 * - **41**: `ManageRoles` - No description available
 * - **42**: `ViewAuditLogs` - No description available
 * - **43**: `SystemConfiguration` - No description available
 */
export enum ModuleAction {
  ...
  /**
   * ManageCollaborators
   * 30: ManageCollaborators
   */
  MANAGE_COLLABORATORS = 30,
  /**
   * SetPermissions
   * 31: SetPermissions
   */
...
/**
 * Enumeration of ModuleType values
 *
 * **ModuleType Enum Values:**
 *
 * - **0**: `None` - No description available
 * - **1**: `TestingLab` - No description available
 * - **2**: `Projects` - No description available
 * - **3**: `Programs` - No description available
 * - **4**: `Courses` - No description available
 * - **5**: `Analytics` - No description available
 * - **6**: `UserManagement` - No description available
 * - **7**: `TenantManagement` - No description available
 * - **8**: `ContentManagement` - No description available
 * - **9**: `ApiManagement` - No description available
 * - **10**: `SystemAdministration` - No description available
 */
...
/**
 * Enumeration of PaymentGateway values
 *
 * **PaymentGateway Enum Values:**
 *
 * - **0**: `Stripe` - No description available
 * - **1**: `PayPal` - No description available
 * - **2**: `Square` - No description available
 * - **3**: `Authorize` - No description available
 * - **4**: `Braintree` - No description available
 * - **99**: `Mock` - No description available
 */
...
/**
 * Enumeration of PaymentMethod values
 *
 * **PaymentMethod Enum Values:**
 *
 * - **0**: `CreditCard` - No description available
 * - **1**: `DebitCard` - No description available
 * - **2**: `PayPal` - No description available
 * - **3**: `BankTransfer` - No description available
 * - **4**: `Cryptocurrency` - No description available
 * - **5**: `DigitalWallet` - No description available
 * - **6**: `GiftCard` - No description available
 * - **7**: `Credits` - No description available
 */
...
/**
 * Enumeration of PaymentMethodStatus values
 *
 * **PaymentMethodStatus Enum Values:**
 *
 * - **0**: `Active` - Payment method is valid and can be used
 * - **1**: `Inactive` - Payment method temporarily disabled
 * - **2**: `Expired` - Payment method has expired (e.g., expired card)
 * - **3**: `Removed` - Payment method has been deleted by the user
 */
...
/**
 * Enumeration of PaymentMethodType values
 *
 * **PaymentMethodType Enum Values:**
 *
 * - **0**: `CreditCard` - Credit card payment method
 * - **1**: `DebitCard` - Debit card payment method
 * - **2**: `CryptoWallet` - Cryptocurrency wallet for blockchain payments
 * - **3**: `WalletBalance` - Platform internal wallet balance
 * - **4**: `BankTransfer` - Direct bank transfer or wire payment
 */
...
/**
 * Enumeration of PaymentStatus values
 *
 * **PaymentStatus Enum Values:**
 *
 * - **0**: `Pending` - No description available
 * - **1**: `Processing` - No description available
 * - **2**: `Completed` - No description available
 * - **3**: `Failed` - No description available
 * - **4**: `Cancelled` - No description available
 * - **5**: `Refunded` - No description available
 * - **6**: `PartiallyRefunded` - No description available
 */
...
/**
 * Enumeration of PermissionSource values
 *
 * **PermissionSource Enum Values:**
 *
 * - **0**: `None` - No description available
 * - **1**: `GlobalDefault` - No description available
 * - **2**: `TenantDefault` - No description available
 * - **3**: `ContentTypeDefault` - No description available
 * - **4**: `TenantUser` - No description available
 * - **5**: `ContentTypeUser` - No description available
 * - **6**: `ResourceDefault` - No description available
 * - **7**: `ResourceUser` - No description available
 * - **8**: `SystemOverride` - No description available
 */
export enum PermissionSource {
  ...
  /**
   * ContentTypeDefault
   * 3: ContentTypeDefault
   */
  CONTENT_TYPE_DEFAULT = 3,
  /**
   * TenantUser
   * 4: TenantUser
   */
...
/**
 * Enumeration of PermissionType values
 *
 * **PermissionType Enum Values:**
 *
 * - **1**: `Read` - No description available
 * - **2**: `Comment` - No description available
 * - **3**: `Reply` - No description available
 * - **4**: `Vote` - No description available
 * - **5**: `Share` - No description available
 * - **6**: `Report` - No description available
 * - **7**: `Follow` - No description available
 * - **8**: `Bookmark` - No description available
 * - **9**: `React` - No description available
 * - **10**: `Subscribe` - No description available
 * - **11**: `Mention` - No description available
 * - **12**: `Tag` - No description available
 * - **13**: `Categorize` - No description available
 * - **14**: `Collection` - No description available
 * - **15**: `Series` - No description available
 * - **16**: `CrossReference` - No description available
 * - **17**: `Translate` - No description available
 * - **18**: `Version` - No description available
 * - **19**: `Template` - No description available
 * - **20**: `Create` - No description available
 * - **21**: `Draft` - No description available
 * - **22**: `Submit` - No description available
 * - **23**: `Withdraw` - No description available
 * - **24**: `Archive` - No description available
 * - **25**: `Restore` - No description available
 * - **26**: `Delete` - No description available
 * - **26**: `SoftDelete` - No description available
 * - **27**: `HardDelete` - No description available
 * - **28**: `Backup` - No description available
 * - **29**: `Migrate` - No description available
 * - **30**: `Clone` - No description available
 * - **31**: `Edit` - No description available
 * - **32**: `Proofread` - No description available
 * - **33**: `FactCheck` - No description available
 * - **34**: `StyleGuide` - No description available
 * - **35**: `Plagiarism` - No description available
 * - **36**: `Seo` - No description available
 * - **37**: `Accessibility` - No description available
 * - **38**: `Legal` - No description available
 * - **39**: `Brand` - No description available
 * - **40**: `Guidelines` - No description available
 * - **41**: `Review` - No description available
 * - **42**: `Approve` - No description available
 * - **43**: `Reject` - No description available
 * - **44**: `Hide` - No description available
 * - **45**: `Quarantine` - No description available
 * - **46**: `Flag` - No description available
 * - **47**: `Warning` - No description available
 * - **48**: `Suspend` - No description available
 * - **49**: `Ban` - No description available
 * - **50**: `Escalate` - No description available
 * - **51**: `Monetize` - No description available
 * - **52**: `Paywall` - No description available
 * - **53**: `Subscription` - No description available
 * - **54**: `Advertisement` - No description available
 * - **55**: `Sponsorship` - No description available
 * - **56**: `Affiliate` - No description available
 * - **57**: `Commission` - No description available
 * - **58**: `License` - No description available
 * - **59**: `Pricing` - No description available
 * - **60**: `Revenue` - No description available
 * - **61**: `Feature` - No description available
 * - **62**: `Pin` - No description available
 * - **63**: `Trending` - No description available
 * - **64**: `Recommend` - No description available
 * - **65**: `Spotlight` - No description available
 * - **66**: `Banner` - No description available
 * - **67**: `Carousel` - No description available
 * - **68**: `Widget` - No description available
 * - **69**: `Email` - No description available
 * - **70**: `Push` - No description available
 * - **71**: `Sms` - No description available
 * - **72**: `Publish` - No description available
 * - **73**: `Unpublish` - No description available
 * - **74**: `Schedule` - No description available
 * - **75**: `Reschedule` - No description available
 * - **76**: `Distribute` - No description available
 * - **77**: `Syndicate` - No description available
 * - **78**: `Rss` - No description available
 * - **79**: `Newsletter` - No description available
 * - **80**: `SocialMedia` - No description available
 * - **81**: `Api` - No description available
 * - **82**: `Score` - No description available
 * - **83**: `Rate` - No description available
 * - **84**: `Benchmark` - No description available
 * - **85**: `Metrics` - No description available
 * - **86**: `Analytics` - No description available
 * - **87**: `Performance` - No description available
 * - **88**: `Feedback` - No description available
 * - **89**: `Audit` - No description available
 * - **90**: `Standards` - No description available
 * - **91**: `Improvement` - No description available
 */
...
/**
 * Enumeration of ProductAccessStatus values
 *
 * **ProductAccessStatus Enum Values:**
 *
 * - **0**: `Active` - User has full access to the product
 * - **1**: `Expired` - Access period has ended
 * - **2**: `Revoked` - Access manually removed by admin
 * - **3**: `Suspended` - Temporary hold on access that may be restored
 */
...
/**
 * Enumeration of ProductAcquisitionType values
 *
 * **ProductAcquisitionType Enum Values:**
 *
 * - **0**: `Purchase` - Product acquired through direct payment
 * - **1**: `Subscription` - Product access via recurring subscription
 * - **2**: `Free` - Product provided at no cost
 * - **3**: `Gift` - Product received as a gift from another user
 */
...
/**
 * Enumeration of ProductType values
 *
 * **ProductType Enum Values:**
 *
 * - **0**: `Program` - Educational content organized into lessons
 * - **1**: `LearningPathway` - Curated sequence of programs and skill requirements for specific learning outcomes
 * - **2**: `Bundle` - Collection of multiple products
 * - **3**: `Subscription` - Recurring access to content
 * - **4**: `Workshop` - Live interactive sessions
 * - **5**: `Mentorship` - One-on-one coaching
 * - **6**: `Ebook` - Digital publications
 * - **7**: `ResourcePack` - Downloadable assets
 * - **8**: `Community` - Access to forums/communities
 * - **9**: `Certification` - Industry credentials
 * - **10**: `Other` - Future product categories
 */
...
/**
 * Enumeration of ProgramCategory values
 *
 * **ProgramCategory Enum Values:**
 *
 * - **0**: `Programming` - Programming and software development
 * - **1**: `DataScience` - Data science and analytics
 * - **2**: `WebDevelopment` - Web development and design
 * - **3**: `MobileDevelopment` - Mobile app development
 * - **4**: `GameDevelopment` - Game development
 * - **5**: `AI` - Artificial intelligence and machine learning
 * - **6**: `Cybersecurity` - Cybersecurity and information security
 * - **7**: `DevOps` - DevOps and system administration
 * - **8**: `Database` - Database design and management
 * - **9**: `Business` - Business and entrepreneurship
 * - **10**: `Design` - Design and user experience
 * - **11**: `Marketing` - Marketing and digital marketing
 * - **12**: `ProjectManagement` - Project management
 * - **13**: `PersonalDevelopment` - Personal development and soft skills
 * - **14**: `CreativeArts` - Creative arts and media
 * - **15**: `Science` - Science and mathematics
 * - **16**: `Language` - Language learning
 * - **17**: `Other` - Other categories
 */
...
/**
 * Enumeration of ProgramContentType values
 *
 * **ProgramContentType Enum Values:**
 *
 * - **0**: `Page` - Instructional content page
 * - **1**: `Assignment` - General assignment where students submit work for evaluation
 * - **2**: `Questionnaire` - A sequence of questions with expected answers, similar to a quiz or test
 * - **3**: `Discussion` - Discussion forum for collaborative learning and sharing ideas
 * - **4**: `Code` - Programming assignment requiring code submission
 * - **5**: `Challenge` - Competition-style activity with rankings or achievements
 * - **6**: `Reflection` - Student reflections on learning or experiences
 * - **7**: `Survey` - Data collection activity without grading
 */
...
/**
 * Enumeration of ProgramDifficulty values
 *
 * **ProgramDifficulty Enum Values:**
 *
 * - **0**: `Beginner` - Suitable for complete beginners
 * - **1**: `Intermediate` - Requires basic understanding of the subject
 * - **2**: `Advanced` - Requires significant prior knowledge and experience
 * - **3**: `Expert` - Requires expert-level knowledge
 */
...
/**
 * Enumeration of ProgressStatus values
 *
 * **ProgressStatus Enum Values:**
 *
 * - **0**: `NotStarted` - User has not started this content yet
 * - **1**: `InProgress` - User has started but not completed this content
 * - **2**: `Completed` - User has successfully completed this content
 * - **2**: `Submitted` - User has submitted their work for evaluation, alias for Completed
 * - **3**: `Skipped` - User has opted to skip this optional content
 */
...
/**
 * Enumeration of ProjectType values
 *
 * **ProjectType Enum Values:**
 *
 * - **0**: `Game` - No description available
 * - **1**: `Tool` - No description available
 * - **2**: `Art` - No description available
 * - **3**: `Music` - No description available
 * - **4**: `Educational` - No description available
 * - **5**: `Plugin` - No description available
 * - **6**: `Template` - No description available
 * - **7**: `Library` - No description available
 * - **99**: `Other` - No description available
 */
...
/**
 * Enumeration of PromoCodeType values
 *
 * **PromoCodeType Enum Values:**
 *
 * - **0**: `PercentageOff` - Applies a percentage discount to the total price
 * - **1**: `FixedAmountOff` - Deducts a specific amount from the total price
 * - **2**: `BuyOneGetOne` - Purchase one product and receive another free
 * - **3**: `FirstMonthFree` - No charge for the first month of a subscription
 */
...
/**
 * Enumeration of RefundStatus values
 *
 * **RefundStatus Enum Values:**
 *
 * - **0**: `Pending` - No description available
 * - **1**: `Processing` - No description available
 * - **2**: `Succeeded` - No description available
 * - **3**: `Failed` - No description available
 * - **4**: `Cancelled` - No description available
 */
...
/**
 * Enumeration of RegistrationType values
 *
 * **RegistrationType Enum Values:**
 *
 * - **0**: `ProjectMember` - No description available
 * - **1**: `Tester` - No description available
 */
...
/**
 * Enumeration of SessionStatus values
 *
 * **SessionStatus Enum Values:**
 *
 * - **0**: `Scheduled` - No description available
 * - **1**: `Active` - No description available
 * - **2**: `Completed` - No description available
 * - **3**: `Cancelled` - No description available
 */
...
/**
 * Enumeration of SkillProficiencyLevel values
 *
 * **SkillProficiencyLevel Enum Values:**
 *
 * - **0**: `Awareness` - Basic awareness and understanding of concepts
 * - **1**: `Novice` - Can perform basic tasks with guidance
 * - **2**: `Beginner` - Can perform routine tasks independently
 * - **3**: `Intermediate` - Can handle most tasks and some complex scenarios
 * - **4**: `Advanced` - Can handle complex tasks and mentor others
 * - **5**: `Expert` - Deep expertise, can innovate and teach
 * - **6**: `Master` - Recognized authority, can define best practices
 */
...
/**
 * Enumeration of SortDirection values
 *
 * **SortDirection Enum Values:**
 *
 * - **0**: `Ascending` - No description available
 * - **1**: `Descending` - No description available
 */
...
/**
 * Enumeration of SubscriptionBillingInterval values
 *
 * **SubscriptionBillingInterval Enum Values:**
 *
 * - **0**: `Day` - Billing occurs daily
 * - **1**: `Week` - Billing occurs weekly
 * - **2**: `Month` - Billing occurs monthly
 * - **3**: `Year` - Billing occurs yearly
 */
...
/**
 * Enumeration of SubscriptionStatus values
 *
 * **SubscriptionStatus Enum Values:**
 *
 * - **0**: `Active` - Subscription is currently valid and paid up
 * - **1**: `Trialing` - In free trial period before regular billing begins
 * - **2**: `PastDue` - Payment failed but subscription still active, pending retry
 * - **3**: `Canceled` - User has canceled the subscription
 * - **4**: `Incomplete` - Initial payment failed, subscription not fully activated
 * - **5**: `IncompleteExpired` - Initial payment failed and the trial period expired
 * - **6**: `Unpaid` - Payment failed after retries, subscription suspended
 */
...
/**
 * Enumeration of TagType values
 *
 * **TagType Enum Values:**
 *
 * - **0**: `Skill` - Tag represents a learnable or teachable skill
 * - **1**: `Topic` - General subject matter or area of knowledge
 * - **2**: `Technology` - Specific technology, software, framework, or tool
 * - **3**: `Difficulty` - Indicates content difficulty level
 * - **4**: `Category` - High-level grouping of content
 * - **5**: `Industry` - Specific industry or sector
 * - **6**: `Certification` - Professional or industry certification
 */
export enum TagType {
  /**
   * Skill
...
/**
 * Enumeration of TeamRole values
 *
 * **TeamRole Enum Values:**
 *
 * - **0**: `Owner` - No description available
 * - **1**: `Editor` - No description available
 * - **2**: `Member` - No description available
 */
...
/**
 * Enumeration of TenantSortField values
 *
 * **TenantSortField Enum Values:**
 *
 * - **0**: `Name` - No description available
 * - **1**: `Description` - No description available
 * - **2**: `IsActive` - No description available
 * - **3**: `Slug` - No description available
 * - **4**: `CreatedAt` - No description available
 * - **5**: `UpdatedAt` - No description available
 */
...
/**
 * Enumeration of TestingContext values
 *
 * **TestingContext Enum Values:**
 *
 * - **0**: `Online` - No description available
 * - **1**: `InPerson` - No description available
 */
export enum TestingContext {
  /**
   * Online
   * 0: Online
   */
...
/**
 * Enumeration of TestingRequestStatus values
 *
 * **TestingRequestStatus Enum Values:**
 *
 * - **0**: `Draft` - No description available
 * - **1**: `Open` - No description available
 * - **2**: `InProgress` - No description available
 * - **3**: `Completed` - No description available
 * - **4**: `Cancelled` - No description available
 */
...
/**
 * Enumeration of TransactionStatus values
 *
 * **TransactionStatus Enum Values:**
 *
 * - **0**: `Pending` - Transaction has been initiated but not completed
 * - **1**: `Processing` - Transaction is being processed by payment provider
 * - **2**: `Completed` - Transaction has been successfully completed
 * - **3**: `Failed` - Transaction failed to process
 * - **4**: `Refunded` - Transaction was completed but has been refunded
 * - **5**: `Cancelled` - Transaction was cancelled before processing
 */
...
/**
 * Enumeration of TransactionType values
 *
 * **TransactionType Enum Values:**
 *
 * - **0**: `Purchase` - Payment for acquiring a product
 * - **1**: `Refund` - Return of funds to the customer
 * - **2**: `Withdrawal` - Removal of funds from the platform
 * - **3**: `Deposit` - Addition of funds to the platform
 * - **4**: `Transfer` - Movement of funds between wallets
 * - **5**: `Fee` - Platform or processing fees
 * - **6**: `Adjustment` - Manual correction to balance
 */
...
/**
 * Enumeration of UserSortField values
 *
 * **UserSortField Enum Values:**
 *
 * - **0**: `Name` - No description available
 * - **1**: `Email` - No description available
 * - **2**: `CreatedAt` - No description available
 * - **3**: `UpdatedAt` - No description available
 * - **4**: `Balance` - No description available
 * - **5**: `AvailableBalance` - No description available
 */
...
/**
 * Enumeration of VerificationMethod values
 *
 * **VerificationMethod Enum Values:**
 *
 * - **0**: `Code` - Certificate can be verified using a unique code
 * - **1**: `Blockchain` - Certificate is verified through blockchain anchoring
 * - **2**: `Both` - Certificate uses both code and blockchain verification
 */
 ...
 *
 * - **0**: `Draft` - Content only visible to creators and editors, not published to users
 * - **1**: `Published` - Content is live and available to all users with access
 * - **2**: `Archived` - Content no longer actively shown but preserved for reference
 */
