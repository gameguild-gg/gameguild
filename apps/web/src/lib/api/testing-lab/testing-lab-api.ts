...
export const testingLabApi = {
    ...
    async getMyTestingRequests(): Promise<any[]> {
        console.warn('Testing Lab API disabled: getMyTestingRequests called with stub');
        return [];
    },

    async getAvailableTestingRequests(): Promise<any[]> {
        console.warn('Testing Lab API disabled: getAvailableTestingRequests called with stub');
        return [];
    },

    async getTestingSessions(): Promise<any[]> {
        console.warn('Testing Lab API disabled: getTestingSessions called with stub');
        return [];
    },
};
