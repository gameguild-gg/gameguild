...
describe('learner workspace record adapter', () => {
        ...
        await expect(getMyLearnerRecords()).resolves.toEqual([
            expect.objectContaining({
                ...
                context: expect.objectContaining({
                    ...
                    submissions: [expect.objectContaining({ assessmentId: 'assessment-1' })],
    ...
    it('keeps certificate and project helpers authenticated', async () => {
        ...
        await expect(getMyCertificates()).resolves.toEqual([{ id: 'certificate-1' }]);
        await expect(getMyProjects('user-1')).resolves.toEqual([{ id: 'project-1' }]);
