...
import { getLearnerDashboard, getMyLearningCourses, mapLearnerCourseSummary } from './courses';
...
describe('learner course aggregate adapter', () => {
    ...
    it('loads enrolled courses with one dashboard request', async () => {
        ...
        await expect(getMyLearningCourses()).resolves.toEqual([expect.objectContaining({ id: 'course-1', slug: 'game-production' })]);
