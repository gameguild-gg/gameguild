 ...
 */
export async function getUserTestingActivity(
  userId: string,
  params?: {
    skip?: number;
    take?: number;
 ...
 */
export async function getCurrentUserTestingRequests(params?: { skip?: number; take?: number; status?: string; fromDate?: string; toDate?: string }) {
  await configureAuthenticatedClient();
 ...
 */
export async function getAvailableTestingForUser(params?: { skip?: number; take?: number; category?: string; difficulty?: string; estimatedDuration?: number }) {
  await configureAuthenticatedClient();
 ...
 */
export async function addUserToSessionWaitlist(
  sessionId: string,
  userData?: {
    userId?: string;
    priority?: number;
 ...
 */
export async function getTestingRequestParticipantsEnhanced(
  requestId: string,
  params?: {
    skip?: number;
    take?: number;
 ...
 */
export async function getUserTestingStats(
  userId: string,
  params?: {
    fromDate?: string;
    toDate?: string;
