...
import { postTestingFeedback, postTestingFeedbackByFeedbackIdQuality, postTestingFeedbackByFeedbackIdReport } from '@/lib/api/generated/sdk.gen';
import type { RateFeedbackQualityDto, SubmitFeedbackDto } from '@/lib/api/generated/types.gen';
 ...
 */
export async function completeTestingSession(sessionData: { testingRequestId: string; sessionId?: string; feedbackResponses: string; overallRating?: number; wouldRecommend?: boolean; additionalNotes?: string }) {
  await configureAuthenticatedClient();
 ...
 */
export async function submitQuickTestingFeedback(quickFeedbackData: { testingRequestId: string; sessionId?: string; overallRating: number; quickNotes?: string; wouldRecommend?: boolean }) {
  await configureAuthenticatedClient();
