...
describe('Testing Lab event actions', () => {
  ...
  it('archives and restores an event through the generated client', async () => {
    ...
    expect(archived).toMatchObject({ success: true, data: true, message: 'Testing event archived.' });
    expect(restored).toMatchObject({ success: true, data: true, message: 'Testing event restored.' });
