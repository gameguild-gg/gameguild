...
public class ProjectService(ApplicationDbContext context) : IProjectService
{
    ...
    public async Task<Models.Project> CreateProjectAsync(Models.Project project)
    {
        ...
        if (project.Visibility == default)
            project.Visibility = AccessLevel.Private;
...
*/
    ...
    {
        return await context.ProjectFollowers
    ...
    {
        return await context.ProjectFeedbacks
            .Include(pf => pf.User)
    ...
    {
        return await context.ProjectJamSubmissions
            .Include(pjs => pjs.Jam)
