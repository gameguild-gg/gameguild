...
public class ProjectType : ObjectType<Models.Project>
{
    protected override void Configure(IObjectTypeDescriptor<Models.Project> descriptor)
    {
        ...
        descriptor
            .Field(p => p.WebsiteUrl)
            .Type<StringType>()
            .Description("Project website URL.");

        descriptor
            .Field(p => p.RepositoryUrl)
            .Type<StringType>()
            .Description("Source code repository URL.");

        descriptor
            .Field(p => p.SocialLinks)
            .Type<StringType>()
        ...
        descriptor
            .Field(p => p.Category)
            .Type<NonNullType<ObjectType<ProjectCategory>>>()
        ...
        descriptor
            ...
            .Resolve(async context =>
            {
                ...
                return await permissionService.HasResourcePermissionAsync<ProjectPermission, Models.Project>(
                    userId, tenantId, project.Id, PermissionType.Edit);
            });
        ...
        descriptor
            ...
            .Resolve(async context =>
            {
                ...
                return await permissionService.HasResourcePermissionAsync<ProjectPermission, Models.Project>(
                    userId, tenantId, project.Id, PermissionType.Delete);
            });
    }
}
