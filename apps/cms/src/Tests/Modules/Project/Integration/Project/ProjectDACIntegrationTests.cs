...
public class ProjectDACIntegrationTests : IDisposable
{
    ...
    public async Task ProjectPermission_ResourceLevel_ShouldGrantAccessToSpecificProject()
    {
        ...
        {
            Id = projectId, Title = "Test Project", Description = "Test project for DAC", CreatedById = userId
        };
    ...
    public async Task ProjectPermission_SpecificPermissionTypes_ShouldCheckCorrectly(PermissionType permissionType)
    {
        ...
        switch (permissionType)
        {
            case PermissionType.Read:
                Assert.True(dbPermission.CanDownload);
            ...
            case PermissionType.Delete:
                Assert.True(dbPermission.CanDelete);

                break;
            case PermissionType.Publish:
                Assert.True(dbPermission.CanPublish);

                break;
            case PermissionType.Share:
                Assert.True(dbPermission.CanManageCollaborators);
        ...
        PermissionType permissionType)
    {
        ...
        if (await permissionService.HasContentTypePermissionAsync(
                userId,
                tenantId,
                "Project",
                permissionType
